...
class DateFormatsSeeder extends Seeder
{
    public function run()
    {
        ...
        $formats = [
            ...
            ['id' => 11, 'format' => 'd.m.Y',  'format_moment' => 'DD.MM.YYYY', 'format_dart' => 'dd.MM.yyyy'],
        ...
        $formats = [
            ...
            ['id' => 11, 'format' => 'd.m.Y g:i a', 'format_moment' => 'DD.MM.YYYY h:mm:ss a', 'format_dart' => 'dd.MM.yyyy h:mm a'],
