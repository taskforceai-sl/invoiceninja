...
',
    ...
    'confirmation_subject' => 'Потвърждаване на Red Invoice профил',
    ...
    'email_from' => 'Екипът на Red Invoice',
    ...
    'pro_plan_feature3' => 'Персонализиран URL - "YourBrand.Red Invoice.com"',
    'pro_plan_feature4' => 'Премахване на "Created by Red Invoice"',
    ...
    'overdue' => 'Просрочие',
    'white_label_text' => 'Купете ЕДНОГОДИШЕН лиценз White label за $:price, за да премахнете брандирането на Red Invoice от фактурите и клиентския портал.',
    ...
    'pro_plan_remove_logo' => ':link за премахване на логото на Red Invoice чрез активиране на План Pro',
    ...
    'pro_plan_year_description' => 'Включване за една година в план Red Invoice Pro.',
    'pro_plan_month_description' => 'Включване за един месец в план Red Invoice Pro.',
    'enterprise_plan_product' => 'Enterprise Plan',
    'enterprise_plan_year_description' => 'Включване за една година в план Red Invoice Enterprise.',
    'enterprise_plan_month_description' => 'Включване за един месец в план  Red Invoice Enterprise.',
    ...
    'export_help' => 'Използвайте JSON ако планирате да импортирате данни в Red Invoice.<br/>Файлът съдържа клиенти, продукти, фактури, оферти и плащания.',
    ...
    'wepay_account_description' => 'Портал за плащане за Red Invoice',
    ...
    'update_invoiceninja_title' => 'Актуализиране на Red Invoice',
    'update_invoiceninja_warning' => 'Преди да стартирате актуализация на Red Invoice направете архив на своята база данни и фалове!',
    'update_invoiceninja_available' => 'Налична е нова версия на Red Invoice.',
    'update_invoiceninja_unavailable' => 'Няма по-нова версия на Red Invoice.',
    ...
    'white_label_license_error' => 'Неуспешно валидиране на лиценза, или е изтекъл, или има прекомерни опити за активиране.  Изпратете имейл на contact@invoice.theredsun.org за повече информация.',
    ...
    'local_part_help' => 'Персонализирайте локалната част от Вашия имейл адрес за поддръжка, напр. YOUR_NAME@support.invoice.theredsun.org',
    ...
    'migrate_to_next_version' => 'Минете към следващата версия на Red Invoice',
    'migrate_intro_text' => 'Работим върху следващата версия на Red Invoice. Щракнете върху бутона по-долу, за да започнете миграцията. ',
    'start_the_migration' => 'Започнете миграцията',
    'migration' => 'Миграция',
    'welcome_to_the_new_version' => 'Добре дошли в новата версия на Red Invoice',
    ...
    'migration_went_wrong' => 'Упс, нещо не е наред! Моля, уверете се, че сте инсталирали Red Invoice v5 инстанция преди да стартирате миграцията.',
    ...
    'expense_mailbox_help' => 'Входящият имейл адрес, който приема документи Разход . т.е. Разход @invoice.theredsun.org',
    ...
    'einvoice_something_went_wrong' => 'Опа! Нещо се обърка. контакт с нас на контакт @invoice.theredsun.org за повече информация.',
