...
<li>"Προκαταβολή πληρωμής για το :QUARTER+1" >> "Προκαταβολή πληρωμής για το Τρίμηνο 2"</li>
    ...
    'email_from' => 'Η Ομάδα του Red Invoice',
    ...
    'pro_plan_feature3' => 'Προσαρμοσμένες διευθύνσεις URL - "YourBrand.Red Invoice.com"',
    'pro_plan_feature4' => 'Αφαίρεση του "Created by Red Invoice"',
    ...
    'pro_plan_remove_logo' => ':link για να αφαιρέσετε το λογότυπο Red Invoice και να συμμετέχετε στο Επαγγελματικό Πλάνο',
    ...
    'pro_plan_year_description' => 'Ένα έτος εγγραφή στο Επαγγελματικό Πλάνο του Red Invoice.',
    'pro_plan_month_description' => 'Ένας μήνας εγγραφή στο Επαγγελματικό Πλάνο του Red Invoice.',
    'enterprise_plan_product' => 'Πλάνο Enterprise',
    'enterprise_plan_year_description' => 'Ένα έτος εγγραφή στο Εταιρικό Πλάνο του Red Invoice.',
    'enterprise_plan_month_description' => 'Ένας μήνας εγγραφή στο Εταιρικό Πλάνο του Red Invoice.',
    ...
    'export_help' => 'Χρησιμοποιήστε JSON εάν σχεδιάζετε να εισάγετε δεδομένα στο Red Invoice.<br/>Το αρχείο περιλαμβάνει πελάτες, προϊόντα, τιμολόγια, προσφορές και πληρωμές.',
    ...
    'wepay_account_description' => 'Πύλη Πληρωμών (Gateway) για το Red Invoice',
    ...
    'update_invoiceninja_title' => 'Ενημέρωση Red Invoice',
    'update_invoiceninja_warning' => 'Πριν αρχίσετε την αναβάθμιση του Red Invoice, δημιουργήστε ένα αντίγραφο ασφαλείας της βάσης δεδομένων και των αρχείων!',
    'update_invoiceninja_available' => 'Υπάρχει διαθέσιμη νεότερη έκδοση του Red Invoice.',
    'update_invoiceninja_unavailable' => 'Δεν υπάρχει νεότερη έκδοση του Red Invoice διαθέσιμη.',
    ...
    'white_label_license_error' => 'Απέτυχε η επικύρωση της άδειας, είτε έληξε είτε υπερβολικές ενεργοποιήσεις. Στείλτε email contact@invoice.theredsun.org για περισσότερες πληροφορίες.',
    ...
    'local_part_help' => 'Προσαρμόστε το τοπικό τμήμα από τα εισερχόμενα αιτήματα υποστήριξης πχ. YOUR_NAME@support.invoice.theredsun.org',
    ...
    'migrate_to_next_version' => 'Μεταφερθείτε στην επόμενη έκδοση του Red Invoice',
    'migrate_intro_text' => 'Εργαζόμαστε για την επόμενη έκδοση του Red Invoice. Πατήστε το κουμπί παρακάτω για να ξεκινήσετε τη μεταφορά.',
    'start_the_migration' => 'Ξεκινήστε τη μεταφορά',
    'migration' => 'Μεταφορά',
    'welcome_to_the_new_version' => 'Καλωσήρθατε στην επόμενη έκδοση του Red Invoice ',
    ...
    'migration_went_wrong' => 'Ουπς, κάτι πήγε λάθος! Σιγουρευτείτε ότι εγκαταστήσατε σωστά μία έκδοση του Red Invoice v5, πριν ξεκινήσετε τη μεταφορά.',
    ...
    'welcome_to_invoice_ninja' => 'Καλωσήρθατε στο Red Invoice ',
    'optin' => 'Συμμετοχή',
    'optout' => 'Μη Συμμετοχή',
    ...
    'application_settings_label' => 'Ας αποθηκεύσουμε βασικές πληροφορίες για το Red Invoice σας!',
    ...
    'migration_api_secret_notice' => 'Μπορείτε να βρείτε το API_SECRET στο αρχείο .env ή στο Red Invoice v5. Εάν λείπει η ιδιότητα, αφήστε το πεδίο κενό.',
    ...
    'migration_already_completed_desc' => 'Φαίνεται ότι έχετε ήδη μετεγκαταστήσει <b>:company _name</b> στην έκδοση V5 του Red Invoice. Σε περίπτωση που θέλετε να ξεκινήσετε από την αρχή, μπορείτε να αναγκάσετε τη μετεγκατάσταση για να διαγράψετε τα υπάρχοντα δεδομένα.',
    ...
    'new_login_description' => 'Πρόσφατα συνδεθήκατε στον λογαριασμό σας στο Red Invoice από νέα τοποθεσία ή συσκευή:<br><br> <b>IP:</b> :ip<br> <b>Ώρα:</b> :time<br> <b>Email:</b> :email',
    ...
    'nordigen_requisition_body' => 'Η πρόσβαση στις ροές τραπεζικών λογαριασμών έχει λήξει όπως ορίζεται στη Συμφωνία Τελικού Χρήστη.<br><br> Συνδεθείτε στο Red Invoice και ελέγξτε ξανά την ταυτότητα με τις τράπεζές σας για να συνεχίσετε να λαμβάνετε συναλλαγές.',
    ...
    'expense_mailbox_help' => 'Η εισερχόμενη διεύθυνση email που δέχεται έγγραφα εξόδων. δηλ. cost@invoice.theredsun.org',
    ...
    'peppol_token_description' => 'Το Token χρησιμοποιείται ως ένα άλλο βήμα για να βεβαιωθείτε ότι τα τιμολόγια αποστέλλονται με ασφάλεια. Σε αντίθεση με τις άδειες λευκής ετικέτας, το διακριτικό μπορεί να περιστραφεί ανά πάσα στιγμή χωρίς να χρειάζεται να περιμένετε στην υποστήριξη Red Invoice.',
    ...
    'einvoice_something_went_wrong' => 'Ωχ! Κάτι πήγε στραβά. Επικοινωνήστε μαζί μας στο contact@invoice.theredsun.org για περισσότερες πληροφορίες.',
    ...
    'enable_public_notifications_help' => 'Ενεργοποιήστε τις ειδοποιήσεις σε πραγματικό χρόνο από το Red Invoice.',
    'navigate' => 'Διαπλέω',
