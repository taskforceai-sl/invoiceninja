...
$lang = array(
    ...
    'add_contact' => '新增聯絡人',
    'create_new_client' => '創建新客戶',
    'edit_client_details' => '編輯客戶詳細信息',
    'enable' => '使能夠',
    'learn_more' => '了解更多',
    'manage_rates' => '管理費率',
    'note_to_client' => '客戶須知',
    ...
    'rate' => '速度',
    'settings' => '設定',
    'enable_invoice_tax' => '啟用指定<b>發票稅</b>',
    'enable_line_item_tax' => '啟用指定<b>訂單項目稅</b>',
    'dashboard' => '儀表板',
    'dashboard_totals_in_all_currencies_help' => '注意：新增一個名為「 :name 」的:link以使用單一基礎貨幣顯示總額。',
    'clients' => '客戶',
    'invoices' => '發票',
    'payments' => '付款',
    'credits' => '信用',
    ...
    'recurring_help' => '<p>每週、每兩個月、每月、每季或每年自動向客戶發送相同的發票。</p>
<p>使用:MONTH 、 :QUARTER或:YEAR取得動態日期。基本數學也同樣有效，例如:MONTH -1。</p>
<p>動態發票變數的範例：</p>
<ul>
<li> “ :MONTH健身房會員資格” &gt;&gt; “7 月份健身房會員資格”</li>
<li> “ :YEAR +1 年度訂閱”&gt;&gt;“2015 年度訂閱”</li>
<li> “ :QUARTER +1 的預付款” &gt;&gt; “第二季的預付款”</li>
</ul>',
    ...
    'app_title' => '免費線上開立發票',
    'app_description' => 'Red Invoice 是一款免費、開放式程式碼的解決方案，適用於發票和計費客戶。透過 Red Invoice，您可以從任何可以存取網路的裝置輕鬆建立和發送精美的發票。您的客戶可以列印您的發票、將其下載為 pdf 文件，甚至可以在系統內在線上向您付款。',
    'rows' => 'rows',
    'www' => 'www',
    'logo' => '標誌',
    'subdomain' => '子網域',
    ...
    'pro_plan_feature3' => '自訂 URLs - "YourBrand.Red Invoice.com"',
    'pro_plan_feature4' => '移除 "Created by Red Invoice" 字樣',
    ...
    'overdue' => '逾期未付',
    'white_label_text' => '購買一年的白牌授權 $:price，從發票和客戶端中移除 Red Invoice 品牌。',
    ...
    'pro_plan_remove_logo' => ':link 來加入專業版，以移除 Red Invoice 標誌',
    ...
    'pro_plan_year_description' => '訂用 Red Invoice 專業版一年方案。',
    'pro_plan_month_description' => '訂用 Red Invoice 專業版一個月方案。',
    'enterprise_plan_product' => '企業方案',
    'enterprise_plan_year_description' => '訂用 Red Invoice 企業版一年方案。',
    'enterprise_plan_month_description' => '訂用 Red Invoice 企業版一個月方案。',
...
一旦您收到這兩筆款項，請回到這個付款方式頁面，並點擊帳號旁邊的「完成驗證」。',
    ...
    'export_help' => '若您計畫匯入資料到 Red Invoice ，請使用JSON。<br/>該檔案包含關於用戶、產品、發票、報價單與付款的資料。',
    ...
    'wepay_account_description' => '於 Red Invoice 使用的付款閘道',
    ...
    'warning' => '警告',
    'self-update' => '更新',
    'update_invoiceninja_title' => '更新 Red Invoice',
    'update_invoiceninja_warning' => '在開始更新 Red Invoice 之前，先備份您的資料庫與檔案!',
    'update_invoiceninja_available' => '有新版的 Red Invoice 可用。',
    'update_invoiceninja_unavailable' => 'Red Invoice 無更新的版本。',
    ...
    'enterprise_upgrade_feature2' => '將第 3 方文件附加到發票和費用中',
    'much_more' => '還有更多!',
    ...
    'white_label_license_error' => '無法驗證許可證，可能已過期或啟用次數過多。發送電子郵件至 contact@invoice.theredsun.org 以了解更多資訊。',
    'plan_price' => '方案價格',
    ...
    'invoices_are_attached' => '您的發票 PDF 已附上。',
    ...
    'expense_mailbox_taken' => '入站郵箱已被使用',
    'expense_mailbox_invalid' => '入站郵箱與所需架構不匹配',
    'client_login' => '用戶登入',
    ...
    'scheduled_report_attached' => '已附上您的預定:type報告。',
    ...
    'add_image' => '新增圖片',
    'select_image' => '選擇圖片',
    'upgrade_to_upload_images' => '升級到企業套餐以上傳文件和圖像',
    'delete_image' => '刪除圖片',
    ...
    'local_part_help' => '自訂入站支援電子郵件的本地部分, 即。YOUR_NAME@support.invoice.theredsun.org',
    'from_name_help' => '寄件者的姓名是顯示的可識別寄件者, 而不是電子郵件地址 (即支援中心)',
    'local_part_placeholder' => '您的姓名',
    'from_name_placeholder' => '支援中心',
    'attachments' => '附件',
    'client_upload' => '用戶上傳',
    'enable_client_upload_help' => '允許客戶上傳文件/附件',
    ...
    'ticket_number_start_help' => '票號必須大於目前票號',
    'new_ticket_template_id' => '新票',
    'new_ticket_autoresponder_help' => '建立新工單時，選擇範本將向客戶/聯絡人發送自動回覆',
    'update_ticket_template_id' => '更新票證',
    'update_ticket_autoresponder_help' => '選擇範本將在票證更新時向客戶/聯絡人發送自動回复',
    'close_ticket_template_id' => '封閉式門票',
    'close_ticket_autoresponder_help' => '選擇範本將在票證關閉時向客戶/聯絡人發送自動回复',
    ...
    'migrate_to_next_version' => '遷移Red Invoice到下一個版本',
    'migrate_intro_text' => '我們正在準備下一個Red Invoice的版本。請點擊下載按扭開始遷移。',
    'start_the_migration' => '開始遷移',
    'migration' => '遷移',
    'welcome_to_the_new_version' => '歡迎使用新版本的Red Invoice',
    ...
    'is_approved' => '被批准',
    'migration_went_wrong' => '哎呀！出事了！在開始遷移之前，請確保您已設定 Red Invoice v5 實例。',
    ...
    'application_settings_label' => '讓我們儲存有關您的 Red Invoice 的基本資訊！',
    ...
    'notification_invoice_custom_sent_subject' => '自訂提醒已發送至:client',
    ...
    'api_secret' => 'API機密',
    'migration_api_secret_notice' => '您可以在 .env 檔案或 Red Invoice v5 中找到 API_SECRET。如果缺少屬性，請將欄位留空。',
    ...
    'migration_already_completed_desc' => '看起來您已經將<b>:company _name</b>遷移到 Red Invoice 的 V5 版本了。如果您想重新開始，可以強制遷移以擦除現有資料。',
    ...
    'new_login_description' => '您最近從新位置或裝置登入了您的 Red Invoice 帳戶：<br><br> <b>IP:</b> :ip<br><b>時間:</b> :time<br><b>電子郵件：</b> :email',
    ...
    'stripe_connect_migration_desc' => 'Red Invoice v5 使用 Stripe Connect 將您的 Stripe 帳戶連結到 Red Invoice。這為您的帳戶提供了額外的安全保障。現在您的資料已遷移，您需要授權 Stripe 在 v5 中接受付款。<br><br>為此，請導覽至設定 &gt; 線上付款 &gt; 設定網關。按一下 Stripe Connect，然後在「設定」下按一下「設定網關」。這將帶您到 Stripe 授權 Red Invoice，返回後您的帳戶將成功連結！',
    ...
    'download_report_description' => '請參閱附件檢查您的報告。',
    'left' => '左邊',
    'right' => '正確的',
    'center' => '中心',
    'page_numbering' => '頁碼',
    ...
    'nordigen_requisition_body' => '根據最終使用者協議中的規定，對銀行帳戶來源的存取權限已過期。<br><br>請登入 Red Invoice 並重新向您的銀行進行身份驗證以繼續接收交易。',
    'participant' => '參加者',
    ...
    'assign_group' => '分配群組',
    'paypal_advanced_cards' => '高級卡支付',
    'local_domain_help' => 'EHLO 域（可選）',
    ...
    'task_round_to_nearest_help' => '任務舍入的時間間隔。',
    'bulk_updated' => '數據更新成功',
    'bulk_update' => '大量更新',
    'calculate' => '計算',
    'sum' => '和',
    ...
    'btcpay_refund_subject' => '透過 BTCPay 退還您的發票',
    'btcpay_refund_body' => '為您準備的退款已發放。要透過 BTCPay 領取，請點擊此連結：',
    'currency_mauritanian_ouguiya' => '茅利塔尼亞烏吉亞',
    'currency_bhutan_ngultrum' => '不丹努爾特魯姆',
    'end_of_month' => '月底',
    'merge_e_invoice_to_pdf' => '合併電子發票和 PDF',
    'task_assigned_subject' => '新任務分配 [任務:task ] [ :date ]',
    'task_assigned_body' => '您已被指派任務:task<br><br>描述： ：描述<br><br>客戶端： :client',
    'activity_141' => '使用者:user輸入註解: :notes',
    'quote_reminder_subject' => '提醒：從:company引用:quote',
    'quote_reminder_message' => ':amount的報價:number提醒',
    'quote_reminder1' => '首次報價提醒',
    'before_valid_until_date' => '在有效截止日期之前',
    'after_valid_until_date' => '有效期限結束後',
    'after_quote_date' => '報價日期後',
    'remind_quote' => '提醒報價',
    'end_of_month' => '月底',
    'tax_currency_mismatch' => '稅幣與發票幣種不同',
    'edocument_import_already_exists' => '發票已在:date上匯入',
    ...
    'auto_expand_product_table_notes' => '自動展開產品表註釋',
    'auto_expand_product_table_notes_help' => '自動擴展產品表中的註解部分以顯示更多行。',
    'institution_number' => '機構編號',
    'transit_number' => '轉運號碼',
    'personal' => '個人的',
    'address_information' => '地址資訊',
    'enter_the_information_for_the_bank_account' => '輸入銀行帳戶資訊',
    'account_holder_information' => '帳戶持有人資訊',
    'enter_information_for_the_account_holder' => '輸入帳戶持有人的信息',
    'customer_type' => '客戶類型',
    'process_date' => '處理日期',
    'forever_free' => '永遠免費',
    'comments_only' => '僅供評論',
    ...
    'country_Melilla' => '梅利利亞',
    'country_Ceuta' => '休達',
    'country_Canary Islands' => '加那利群島',
    'lang_Vietnamese' => '越南語',
    ...
    'expense_mailbox' => '入站電子郵件地址',
    'expense_mailbox_help' => '接受費用文件的入站電子郵件地址。 IE。expense@invoice.theredsun.org',
    'expense_mailbox_active' => '費用信箱',
    'expense_mailbox_active_help' => '允許處理文件，例如費用報告收據',
    'inbound_mailbox_allow_company_users' => '允許公司寄件人',
    'inbound_mailbox_allow_company_users_help' => '允許公司內的使用者發送費用憑證。',
    'inbound_mailbox_allow_vendors' => '允許供應商寄件人',
    'inbound_mailbox_allow_vendors_help' => '允許公司供應商發送費用文件',
    'inbound_mailbox_allow_clients' => '允許客戶端寄件人',
    'inbound_mailbox_allow_clients_help' => '允許客戶發送費用文件',
    'inbound_mailbox_whitelist' => '入站寄件者允許列表',
    'inbound_mailbox_whitelist_help' => '應允許發送電子郵件進行處理的以逗號分隔的電子郵件清單',
    'inbound_mailbox_blacklist' => '入站寄件者禁止列表',
    'inbound_mailbox_blacklist_help' => '以逗號分隔的電子郵件列表，不允許發送電子郵件進行處理',
    'inbound_mailbox_allow_unknown' => '允許所有寄件者',
    'inbound_mailbox_allow_unknown_help' => '允許任何人發送費用電子郵件進行處理',
    'quick_actions' => '快速行動',
    'end_all_sessions_help' => '登出所有使用者並要求所有活動使用者重新進行身份驗證。',
    'updated_records' => '更新記錄',
    'vat_not_registered' => '賣家未註冊增值稅',
    'small_company_info' => '根據 UStG § 19 未揭露銷售稅',
    'peppol_onboarding' => '您似乎是第一次使用 PEPPOL。',
    'get_started' => '開始使用',
    'configure_peppol' => '配置 PEPPOL',
    'step' => '步',
    ...
    'peppol_disconnect_short' => '斷開與 PEPPOL 的連線。',
    'peppol_disconnect_long' => '斷開連線後，您的增值稅號將從 PEPPOL 網路中撤回。您將無法傳送或接收電子文檔。',
    'log_duration_words' => '時間日誌持續時間（以單字為單位）',
    'log_duration' => '時間日誌持續時間',
    ...
    'peppol_token_description' => '令牌用作確保發票安全發送的另一個步驟。與白標許可證不同，令牌可以隨時輪換，無需等待 Red Invoice 支援。',
    ...
    'bic_swift' => 'BIC/Swift 代碼',
    'bic_swift_help' => '銀行識別符',
    'payer_bank_account' => '付款人銀行帳號',
    'payer_bank_account_help' => '付款人的銀行帳號',
    'bsb_sort' => 'BSB / 排序代碼',
    'bsb_sort_help' => '銀行分行代碼',
    'card_type' => '卡片類型',
    'card_type_help' => 'IE。維薩卡、美國運通卡',
    'card_number_help' => '僅最後 4 位數字',
    'card_holder' => '持卡人姓名',
    'tokenize' => '標記化',
    'tokenize_help' => '將支付方式標記化以供將來使用。',
    'credit_card_stripe_help' => '使用 Stripe 接受信用卡付款。',
    'bank_transfer_stripe_help' => 'ACH 直接扣款。美元付款，可即時驗證。',
    'alipay_stripe_help' => '支付寶允許中國用戶使用手機錢包安全支付。',
    'sofort_stripe_help' => 'Sofort 是一種流行的歐洲支付方式，可實現即時銀行轉賬，主要在德國和奧地利使用。',
    'apple_pay_stripe_help' => 'Apple/Google Pay 適用於使用 Apple/Android 裝置的用戶，並使用已儲存的卡片資訊輕鬆結帳。',
    'sepa_stripe_help' => 'SEPA 直接扣款（單一歐元支付區）。',
    'bancontact_stripe_help' => 'Bancontact 是比利時廣泛使用的付款方式。',
    'ideal_stripe_help' => 'iDEAL 是荷蘭最受歡迎的付款方式。',
    'giropay_stripe_help' => 'Giropay 是一種德國支付方式，可促進安全、即時的線上銀行轉帳。',
    'przelewy24_stripe_help' => 'Przelewy24 是波蘭常見的付款方式。',
    'direct_debit_stripe_help' => '使用 Stripes 虛擬銀行帳戶進行 Stripe 銀行轉賬，適用於日本、英國、美國、歐洲和墨西哥。確保在 Stripe 中啟用此功能！',
    'eps_stripe_help' => 'EPS 是奧地利的線上支付系統。',
    'acss_stripe_help' => 'ACSS（自動清算結算系統）加拿大銀行帳戶直接扣款。',
    'becs_stripe_help' => '適用於澳洲銀行帳戶的 BECS 直接扣款。',
    'klarna_stripe_help' => 'Klarna 現在購買，稍後分期付款或按設定的時間表付款。',
    'bacs_stripe_help' => '英國銀行帳戶的 BACS 直接扣記，通常用於訂閱計費。',
    'fpx_stripe_help' => 'FPX 是馬來西亞流行的線上支付方式。',
    'payment_means' => '付款方式',
    'act_as_sender' => '發送電子發票',
    'act_as_receiver' => '接收電子發票',
    'saved_einvoice_details' => '已儲存的電子發票設定',
    'add_license_to_env' => '我們需要您的許可證金鑰以便將來與我們的服務進行通訊。確保 LICENSE_KEY 作為環境變數。',
    'white_label_license_not_present' => '未找到許可證。確保將 LICENSE_KEY 設定為環境變數。',
    'white_label_license_not_found' => '未找到白標許可證。',
    'details_update_info' => '我們將使用您提供的資訊更新您的公司詳細資訊。',
    'sales_above_threshold' => '銷售額超過門檻',
    'client_address_required' => '電子發票需要完整的客戶地址',
    'connected' => '已連接',
    'email_count_quotes' => '電子郵件:count報價',
    'activity_146' => ':client的電子發票:invoice已成功交付！ ：筆記',
    'activity_147' => ':client的電子發票:invoice交付失敗。 :notes',
    'peppol_routing_problem' => '路由問題。未找到收件人/目的地。',
    'peppol_sending_failed' => '技術交付問題。無法重試',
    'peppol_cleared_for_sending' => '由稅務機關清算，發送給接收者',
    'account_holder' => '帳戶名稱',
    'account_holder_help' => '帳戶名稱',
    'activity_148' => '從:vendor收到的電子費用:expense',
    'additional_tax_identifiers' => '附加稅務識別符',
    'additional_tax_identifiers_help' => '如果您在其他地區註冊了增值稅，您可以在此處新增這些地區的增值稅號。',
    'configure' => '配置',
    ...
    'delete_identifier_description' => '刪除此標識符會將其從系統中刪除。在繼續之前請確保這是所需的操作。',
    'einvoice_something_went_wrong' => '哎呀！出了點問題。如需了解更多信息，請透過 contact@invoice.theredsun.org 與我們聯繫。',
    'download_ready' => '您的下載現已準備就緒！ [ :message ]',
    'notification_quote_reminder1_sent_subject' => '報價:invoice的提醒 1 已發送至:client',
    'custom_reminder_sent' => '自訂提醒已發送至:client',
