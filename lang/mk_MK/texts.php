...
<li> "Задржано плаќање за :QUARTER+1" >> "Задржано плаќање за К2" </li>
    ...
    'email_from' => 'Тимот на Red Invoice',
    ...
    'pro_plan_feature3' => 'Прилагодени URL - "YourBrand.Red Invoice.com"',
    'pro_plan_feature4' => 'Отстрани "Креирано со Red Invoice"',
 ...
 <li> Денес е петок, датумот на достасување е првиот петок потоа. Датумот на достасување би бил наредниот петок, не денес. 
    ...
    'overdue' => 'Задоцнето',
    'white_label_text' => 'Купете ЕДНОГОДИШЕН ПЛАН за брендирана лиценца за $:price за да го отстраните брендирањето на Red Invoice од клиентскиот портал.',
    ...
    'pro_plan_remove_logo' => ':link за отстранување на Red Invoice логото со приклучување на Pro планот',
    ...
    'pro_plan_year_description' => 'Една година запишување на Red Invoice Pro планот.',
    'pro_plan_month_description' => 'Еден месец запишување на Red Invoice Pro планот.',
    'enterprise_plan_product' => 'План за претпријатие',
    'enterprise_plan_year_description' => 'Една година запишување на Red Invoice Pro планот за претпријатие.',
    'enterprise_plan_month_description' => 'Еден месец запишување на Red Invoice Pro планот за претпријатие.',
...
Откако ќе ги добиете износите, вратете се на оваа страница за начин на плаќање и кликнете "Заврши Верификација" до сметката.',
    ...
    'export_help' => 'Користи JSON ако планираш да ги внесеш информациите во Red Invoice. <br/> Датотеката содржи клиенти, продукти, фактури, понуди и плаќања.',
    ...
    'wepay_account_description' => 'Платен портал за Red Invoice',
    ...
    'update_invoiceninja_title' => 'Ажурирај Red Invoice',
    'update_invoiceninja_warning' => 'Пред за започнете со ажурирање на Red Invoice креирајте бекап на вашата датабаза и датотеки.',
    'update_invoiceninja_available' => 'Достапна е нова верзија на Red Invoice.',
    'update_invoiceninja_unavailable' => 'Нема достапна нова верзија на Red Invoice.',
