...
$lang = array(
    ...
    'clone_invoice' => 'Duplicar para Fatura',
...
<li>"Subscrição anual de :YEAR+1" >> "Subscrição anual de 2025"</li>
<li>"Pagamento de retentor para :QUARTER+1" >> "Pagamento de retentor para 3T"</li>
    ...
    'cloned_invoice' => 'Fatura duplicada com sucesso',
    ...
    'invoice_message' => 'Para visualizar a sua Fatura de :amount, clique no endereço.',
    ...
    'email_from' => 'Equipa Red Invoice',
    'invoice_link_message' => 'Para visualizar a Fatura do seu cliente clique no endereço:',
    'notification_invoice_paid_subject' => 'Fatura:invoice foi paga por :client',
    'notification_invoice_sent_subject' => 'Fatura :invoice foi enviada para :client',
    ...
    'update_products_help' => 'Ao atualizar uma Fatura o <b>produto também será atualizado</b>',
    ...
    'specify_colors_label' => 'Selecione as cores para a sua Fatura',
    ...
    'invoice_number_prefix' => 'Prefixo da Numeração nas Faturas',
    ...
    'invalid_counter' => 'Para evitar conflitos defina prefixos de numeração para Fatura e Orçamentos',
    'mark_sent' => 'Marcar Como Enviada',
    'more_designs' => 'Mais Modelos',
    'more_designs_title' => 'Modelos Adicionais para Faturas',
    'more_designs_cloud_header' => 'Adquira o Plano Profissional para mais modelos de Faturas',
    'more_designs_cloud_text' => '',
    'more_designs_self_host_text' => '',
    'buy' => 'Comprar',
    'bought_designs' => 'Novos Modelos de Faturas Adicionados',
    'sent' => 'Enviado',
    'vat_number' => 'NIF',
    ...
    'last_invoice_sent' => 'Última Fatura enviada a :date',
    ...
    'pro_plan_feature3' => 'URLs personalizadas - "OSeuNome.Red Invoice.com"',
    'pro_plan_feature4' => 'Remover "Created by Red Invoice"',
    ...
    'pro_plan_feature8' => 'Opção para anexar PDFs aos e-mails do cliente',
    'resume' => 'Retomar',
    ...
    'reminder_subject' => 'Aviso: Fatura :invoice de :account',
    'reset' => 'Repor',
    'invoice_not_found' => 'A Fatura não está disponível',
    ...
    'disable' => 'Desativar',
    'invoice_quote_number' => 'Número das Faturas e dos Orçamentos',
    ...
    'notification_invoice_bounced_subject' => 'A Fatura :invoice não foi entregue',
    'notification_quote_bounced' => 'Não foi possível entregar o Orçamento :invoice para :contact .<br><br> :error',
    ...
    'default_invoice_terms' => 'Definir condições padrão das Faturas',
    'default_invoice_footer' => 'Definir roda-pé padrão das Faturas',
    ...
    'delete_recurring_invoice' => 'Eliminar Fatura Recorrente',
    ...
    'invoice_file' => 'Ficheiro de Fatura',
    ...
    'notes' => 'Observações',
    'invoice_will_create' => 'A Fatura será criada',
    ...
    'website_help' => 'Mostrar a Fatura num iFrame no seu próprio site',
    'invoice_number_help' => 'Especifique um prefixo ou use um padrão personalizado para definir dinamicamente o número da Fatura.',
    ...
    'invoice_link' => 'Endereço da Fatura',
    ...
    'recurring_due_date_help' => '<p>Definir automaticamente a data de vencimento da Fatura.</p>
        <p>Faturas em um ciclo mensal ou anual com vencimento anterior ou na data em que são criadas serão faturadas para o próximo mês. Faturas com vencimento no dia 29 ou 30 nos meses que não tem esse dia serão faturadas no último dia do mês..</p>
        <p>Faturas em um clclo mensal com vencimento no dia da semana em que foi criada serão nota de faturadas para a próxima semana.</p>
        <p>Exemplo:</p>
        <ul>
          ...
          <li>Hoje é Sexta-Feira, vencimento na primeira sexta-feira. O vencimento será na próxima sexta-feira, não hoje.</li>
        </ul>',
    'due' => 'Vencimento',
    ...
    'invoice_message_button' => 'Para visualizar a sua Fatura de :amount, clique no botão abaixo.',
    ...
    'auto_convert_quote_help' => 'Converta automaticamente um Orçamento em uma Fatura quando aprovada.',
    'validate' => 'Validado',
    'info' => 'Informação',
    ...
    'overdue' => 'Vencido',
    'white_label_text' => 'Comprar UM ANO da licença de marca branca por $:price para remover a marca do Red Invoice das Faturas e do portal do cliente.',
    ...
    'more_designs_self_host_header' => 'Obtenha mais 6 modelos de Fatura por apenas $:price',
    ...
    'pro_plan_remove_logo' => ':link para remover a logo do Red Invoice adquirindo o plano profissional',
    ...
    'email_error_inactive_invoice' => 'Não é possível enviar e-mails de Faturas inativas',
    ...
    'invoiced_amount' => 'Total da Fatura',
    'invoice_item_fields' => 'Campos de produtos da Fatura',
    ...
    'enable_portal_password_help' => 'Permite definir uma senha para cada contacto. Se uma senha for definida, o contacto deverá introduzir a senha antes de visualizar a Fatura.',
    'send_portal_password' => 'Gerar Automaticamente',
    'send_portal_password_help' => 'Se não definir uma senha, será gerada uma automaticamente e enviada com a primeira Fatura.',
    ...
    'cost' => 'Custo',
    'create_invoice_for_sample' => 'Nota: crie a primeira Fatura para ver uma pré-visualização aqui.',
    ...
    'user_view_all' => 'Ver todos os clientes, faturas, etc.',
    ...
    'invoice_embed_documents' => 'Incorporar Imagens/Documentos',
    'invoice_embed_documents_help' => 'Incluir imagens/PDFs anexados na fatura.',
    ...
    'pro_plan_year_description' => 'Subscrição de um ano no plano Red Invoice Profissional.',
    'pro_plan_month_description' => 'Um mês de subscrição no plano Red Invoice Profissional.',
    'enterprise_plan_product' => 'Plano Empresa',
    'enterprise_plan_year_description' => 'Um ano de subscrição no plano Red Invoice Empresa.',
    'enterprise_plan_month_description' => 'Um mês de subscrição no plano Red Invoice Empresa.',
    ...
    'enterprise_plan_features' => 'O Plano Enterprise adiciona suporte para vários usuários e anexos de arquivo, :link para ver a lista completa de recursos.',
...
Quando tiver os valores dos depósitos, volte a esta página e conclua a verificação da sua conta.',
    ...
    'notification_invoice_payment_failed' => 'O pagamento feito pelo Cliente :client para a Fatura :invoice falhou. O pagamento foi marcado como "falhado" e foram adicionados :amount ao saldo do cliente.',
    ...
    'warn_start_date_changed_not_sent' => 'A próxima Fatura será criada na próxima data de início',
    ...
    'export_help' => 'Utilize JSON se planear importar os dados para o Red Invoice.<br/>O ficheiro incluí clientes, produtos, faturas, orçamentos e pagamentos.',
    ...
    'auto_bill_notification' => 'Esta Fatura será paga automaticamente a :due_data através do seu :payment_method.',
    ...
    'auto_bill_notification_placeholder' => 'Esta Fatura será paga automaticamente no seu cartão de crédito na data de vencimento.',
    ...
    'warn_change_auto_bill' => 'Devido às regras NACHA, alterações a esta Fatura podem evitar pagamentos automáticos ACH.',
    ...
    'auto_bill_email_message' => 'Esta Fatura será paga automaticamente na data de vencimento através do método de pagamento.',
    'bitcoin' => 'Bitcoin',
    ...
    'fields' => 'Campos',
    'dwolla' => 'Dwolla',
    'buy_now_buttons_warning' => 'Nota: o cliente e a fatura serão criados mesmo que a transacção não seja concluída.',
    ...
    'wepay_account_description' => 'Portal de pagamento para o Red Invoice',
 ...
 €0.25) por pagamento realizado.',
    ...
    'bot_emailed_invoice' => 'A sua Fatura foi enviada.',
    ...
    'update_invoiceninja_title' => 'Atualizar Red Invoice',
    'update_invoiceninja_warning' => 'Antes de começar a atualizar o Red Invoice crie uma cópia de segurança da sua base de dados e ficheiros!',
    'update_invoiceninja_available' => 'Uma nova versão do Red Invoice está disponível.',
    'update_invoiceninja_unavailable' => 'Não existe uma versão mais recente do Red Invoice.',
    ...
    'min' => 'Min',
    'max' => 'Max',
    'limits_not_met' => 'Esta Fatura não cumpre os limites para este tipo de pagamento.',
    ...
    'blank' => 'Vazio',
    'invoice_save_error' => 'Houve um erro ao guardar a Fatura',
    ...
    'enterprise_upgrade_feature2' => 'Anexe arquivos de terceiros às faturas e despesas',
    ...
    'show_accept_invoice_terms_help' => 'Requer que o cliente confirme que aceita os termos da fatura.',
    ...
    'realtime_preview_help' => 'Atualização em tempo real da visualização do PDF na página da Fatura ao editá-la. <br/>Desative esta funcionalidade para melhorar o desempenho ao editar as Faturas.',
    ...
    'invoice_not_emailed' => 'Esta Fatura não foi enviada.',
    ...
    'custom_product_fields_help' => 'Adicionar um campo quando criar um produto ou fatura e mostrar esse campo e valor no PDF.',
    ...
    'discount_sample' => 'O desconto para :amount Fatura deve ser :total.',
    'no_fees' => 'Sem Taxas',
    ...
    'gateway' => 'Portal',
    'gateway_fee_change_warning' => 'Se tiver Faturas não pagas terá que atualizar as taxas manualmente.',
    ...
    'reset_counter_help' => 'Repor automaticamente os contadores das Faturas e dos Orçamentos.',
    'auto_bill_failed' => 'Faturação automática para a Fatura:invoice_number falhou',
    ...
    'white_label_license_error' => 'Falha ao validar a licença, expirada ou ativações excessivas. Envie um e-mail para contact@invoice.theredsun.org para obter mais informações.',
    ...
    'invoices_are_attached' => 'Os PDFs da sua fatura estão anexados.',
...
debitar da sua conta de acordo com essas instruções. Está elegível a um reembolso desse mesmo débito sob os termos e condições acordados entre si e o banco. O reembolso deve ser pedido nas 8 (oito) semanas seguintes a partir da data do débito.',
    ...
    'expense_mailbox_taken' => 'A caixa de correio de entrada já está em uso',
    'expense_mailbox_invalid' => 'A caixa de correio de entrada não corresponde ao esquema necessário',
    ...
    'scheduled_report_attached' => 'Seu relatório :type agendado está anexado.',
    ...
    'subscription_event_9' => 'Fatura Eliminada',
    ...
    'inclusive_taxes_notice' => 'Esta configuração não pode ser modificada após a criação da Fatura.',
    'inclusive_taxes_warning' => 'Aviso: Faturas existentes terão que ser guardadas novamente',
    ...
    'signature_on_pdf_help' => 'Mostrar a assinatura do cliente no PDF da fatura/orçamento.',
    ...
    'upgrade_to_upload_images' => 'Atualize para o Plano Enterprise para fazer upload de arquivos e imagens',
    ...
    'auto_email_invoice_help' => 'Enviar Faturas Recorrentes por e-mail automaticamente quando criadas.',
    ...
    'auto_archive_quote_help' => 'Arquive orçamentos automaticamente quando convertidos em fatura.',
    ...
    'invoice_workflow' => 'Fluxo de Faturas',
    ...
    'local_part_help' => 'Personalizar a parte local do seu e-mail da caixa de entrada. Ex: SEU_NOME@support.invoice.theredsun.org',
    ...
    'enable_client_upload_help' => 'Permitir que os clientes carreguem documentos/anexos',
    ...
    'ticket_number_start_help' => 'O número do tíquete deve ser maior que o número do tíquete atual',
    'new_ticket_template_id' => 'Novo bilhete',
    'new_ticket_autoresponder_help' => 'Selecionar um modelo enviará uma resposta automática a um cliente/contato quando um novo tíquete for criado',
    'update_ticket_template_id' => 'Bilhete atualizado',
    'update_ticket_autoresponder_help' => 'Selecionar um modelo enviará uma resposta automática a um cliente/contato quando um tíquete for atualizado',
    'close_ticket_template_id' => 'Ticket fechado',
    'close_ticket_autoresponder_help' => 'Selecionar um modelo enviará uma resposta automática a um cliente/contato quando um tíquete for fechado',
    ...
    'attach_ubl' => 'Anexar UBL/Fatura Eletrônica',
    ...
    'migrate_to_next_version' => 'Migrar para a próxima versão do Red Invoice',
    'migrate_intro_text' => 'Estamos a trabalhar na nova versão do Red Invoice. Clique no botão abaixo para iniciar a migração.',
    'start_the_migration' => 'Começar migração',
    'migration' => 'Migração',
    'welcome_to_the_new_version' => 'Bem-vindo à nova versão do Red Invoice',
    ...
    'marked_invoices_as_sent' => 'Excelente! As Faturas foram marcadas como enviadas com sucesso',
    ...
    'custom_message_unpaid_invoice' => 'Mensagem Personalizada de Fatura Por Pagar',
    ...
    'lock_sent_invoices' => 'Bloquear Faturas Enviadas',
    ...
    'migration_went_wrong' => 'Ups, alguma coisa não correu bem! Certifique-se de configurar uma instância do Red Invoice v5 antes de iniciar a migração.',
    ...
    'welcome_to_invoice_ninja' => 'Bem-vindo ao Red Invoice',
    'optin' => 'Autorizar',
    'optout' => 'Desautorizar',
    ...
    'invoice_task_timelog_help' => 'Adicionar detalhes de hora aos produtos na Fatura',
    ...
    'activity_63' => ':user enviou o primeiro lembrete da fatura :invoice para :contact',
    'activity_64' => ':user enviou o segundo lembrete da fatura :invoice para :contact',
    'activity_65' => ':user enviou o terceiro lembrete da fatura :invoice para :contact',
    'activity_66' => ':user enviou lembrete final da fatura :invoice para :contact',
    ...
    'archived_recurring_invoices' => ':value Faturas Recorrentes arquivadas com sucesso',
    'deleted_recurring_invoices' => ':value Faturas Recorrentes apagadas com sucesso',
    'restored_recurring_invoices' => ':value Faturas Recorrentes restauradas com sucesso',
    ...
    'notification_payment_paid' => 'Um pagamento de :amount foi feito pelo cliente :clientpara a Fatura :invoice',
    'notification_partial_payment_paid' => 'Um pagamento parcial de :amount foi feito pelo cliente :clientpara a Fatura :invoice',
    'notification_bot' => 'Bot de Notificações',
    'invoice_number_placeholder' => 'Fatura # :invoice',
    ...
    'invoice_still_unpaid' => 'Esta Fatura ainda não foi paga. Clique neste botão para completar o pagamento',
    'list_of_recurring_invoices' => 'Lista de Faturas Recorrentes',
    'details_of_recurring_invoice' => 'Aqui estão alguns detalhes sobre a Fatura Recorrente',
    'cancellation' => 'Cancelamento',
    'about_cancellation' => 'Caso queira interromper a faturação recorrente, clique para solicitar o cancelamento.',
    ...
    'to_pay_invoices' => 'Para pagar Faturas, é necessário',
    ...
    'credit_payment' => 'Nota de crédito aplicada à Fatura :invoice_number',
    ...
    'pay_with' => 'Pagar com',
    'n/a' => 'Não Aplicável',
    'by_clicking_next_you_accept_terms' => 'Ao clicar em &quot;Avançar&quot;, você aceita os termos.',
    ...
    'notification_invoice_custom_sent_subject' => 'Lembrete personalizado foi enviado para :client',
    ...
    'no_payable_invoices_selected' => 'Não foram selecionadas Faturas que possam ser pagas. Certifique-se que não está a tentar pagar uma Fatura de rascunho ou de total zero.',
    ...
    'credits_applied_validation' => 'O total dos créditos aplicados não pode ser SUPERIOR ao total das Faturas',
    'credit_number_taken' => 'Número de nota de crédito já em uso',
    'credit_not_found' => 'Nota de crédito não encontrada',
    'invoices_dont_match_client' => 'As Faturas selecionadas não pertencem a um único cliente.',
    'duplicate_credits_submitted' => 'Duplicar notas de crédito submetidas',
    'duplicate_invoices_submitted' => 'Duplicar Faturas submetidas.',
    ...
    'recurring_invoice_number_taken' => 'Número de Fatura Recorrente :number já utilizado',
    ...
    'invoice_cannot_be_marked_paid' => 'Fatura não pode ser marcada como paga',
    ...
    'payment_message_extended' => 'Obrigado pelo seu pagamento de :amount para o documento :invoice',
    'online_payments_minimum_note' => 'Observação: os pagamentos on-line são aceitos somente se o valor for maior que US$ 1 ou moeda equivalente.',
    ...
    'migration_api_secret_notice' => 'Você pode encontrar API_SECRET no arquivo .env ou Red Invoice v5. Se a propriedade estiver ausente, deixe o campo em branco.',
    ...
    'activate_company_help' => 'Ativar e-mails, faturas recorrentes e notificações',
    ...
    'invoice_task_datelog_help' => 'Adicionar detalhes da data na linha dos items da Fatura',
    'promo_code' => 'Código Promocional',
    'recurring_invoice_issued_to' => 'Fatura Recorrente enviada para',
    ...
    'shared_invoice_credit_counter' => 'Compartilhar contador de Fatura/Crédito',
    ...
    'amount_greater_than_balance_v5' => 'A quantia é superior ao saldo da Fatura. Não pode pagar uma Fatura com valor superior ao saldo desta.',
    'click_to_continue' => 'Clique para continuar',
    'notification_invoice_created_body' => 'A seguinte Fatura :invoice foi criada para o cliente :client com o valor de  :amount.',
    'notification_invoice_created_subject' => 'Fatura :invoice foi criada para :client',
    ...
    'migration_already_completed_desc' => 'Parece que já houve uma migração da :company_name para a versão V5 do Red Invoice. Caso queria redefinir tudo e recomeçar, pode forçar a migração para limpar os dados existentes.',
    ...
    'new_login_description' => 'Você entrou recentemente na sua conta Red Invoice de uma nova localização ou dispositivo:<br><br><b>IP:</b> :ip<br><b>Hora:</b> :time<br><b>E-mail:</b> :email',
    ...
    'quotes_with_status_sent_can_be_approved' => 'Somente orçamentos com status &quot;Enviado&quot; podem ser aprovados. Orçamentos expirados não podem ser aprovados.',
    ...
    'stripe_connect_migration_desc' => 'O Red Invoice v5 usa o Stripe Connect para vincular sua conta Stripe ao Red Invoice. Isso fornece uma camada adicional de segurança para sua conta. Agora que seus dados foram migrados, você precisará Autorizar o Stripe para aceitar pagamentos na v5.<br><br> Para fazer isso, navegue até Configurações &gt; Pagamentos online &gt; Configurar gateways. Clique em Stripe Connect e, em Configurações, clique em Configurar Gateway. Isso levará você ao Stripe para autorizar o Red Invoice e, ao retornar, sua conta será vinculada com sucesso!',
...
O envio de E-mails foi suspenso. Será retomado às 23:00 UTC.',
    ...
    'start_free_trial_message' => 'Comece seu teste GRATUITO de 14 dias do Plano Pro',
    ...
    'download_report_description' => 'Veja o arquivo em anexo para verificar seu relatório.',
    'left' => 'Esquerda',
    'right' => 'Certo',
    'center' => 'Centro',
    ...
    'client_statement_body' => 'Sua declaração de :start _data a :end _data está anexada.',
    ...
    'run_template' => 'Modelo de execução',
    ...
    'nordigen_handler_error_heading_eua_failure' => 'Falha EUA',
    'nordigen_handler_error_contents_eua_failure' => 'Ocorreu um erro durante a criação do Contrato do Usuário Final:',
    ...
    'nordigen_requisition_body' => 'O acesso aos feeds de contas bancárias expirou conforme definido no Contrato do usuário final.<br><br> Faça login no Red Invoice e autentique-se novamente com seus bancos para continuar recebendo transações.',
    ...
    'paypal_advanced_cards' => 'Pagamentos com cartão avançado',
    'local_domain_help' => 'Domínio EHLO (opcional)',
    'port_help' => 'ou seja, 25.587.465',
    'host_help' => 'ou seja, smtp.gmail.com',
    'always_show_required_fields' => 'Sempre mostrar campos obrigatórios do formulário',
    'always_show_required_fields_help' => 'Exibe os campos obrigatórios do formulário sempre no checkout',
    'advanced_cards' => 'Cartões avançados',
    'activity_140' => 'Declaração enviada para :client',
    'invoice_net_amount' => 'Total Líquido ',
    'round_to_minutes' => 'Arredondar para minutos',
    '1_second' => '1 segundo',
    '1_minute' => '1 minuto',
    '5_minutes' => '5 minutos',
    ...
    '1_hour' => '1 hora',
    '1_day' => '1 dia',
    'round_tasks' => 'Direção de arredondamento de tarefas',
    'round_tasks_help' => 'Arredonde os tempos das tarefas para cima ou para baixo.',
    'direction' => 'Direção',
    'round_up' => 'Arredondar para cima',
    'round_down' => 'Arredondar para baixo',
    'task_round_to_nearest' => 'Arredondar para o mais próximo',
    'task_round_to_nearest_help' => 'O intervalo para arredondar a tarefa.',
    'bulk_updated' => 'Dados atualizados com sucesso',
    ...
    'btcpay_refund_subject' => 'Reembolso da sua fatura via BTCPay',
    'btcpay_refund_body' => 'Um reembolso destinado a você foi emitido. Para reivindicá-lo via BTCPay, clique neste link:',
    'currency_mauritanian_ouguiya' => 'Ouguiya mauritano',
    'currency_bhutan_ngultrum' => 'Butão Ngultrum',
    'end_of_month' => 'Fim do mês',
    'merge_e_invoice_to_pdf' => 'Fundir E-Fatura e PDF',
    'task_assigned_subject' => 'Nova atribuição de tarefa [Tarefa :task ] [ :date ]',
    'task_assigned_body' => 'Você recebeu a tarefa :task<br><br> Descrição: :description<br><br> Cliente: :client',
    'activity_141' => 'O usuário :user inseriu a nota: :notes',
    'quote_reminder_subject' => 'Lembrete: Citação :quote de :company',
    'quote_reminder_message' => 'Lembrete para cotação :number para :amount',
    'quote_reminder1' => 'Lembrete da primeira citação',
    'before_valid_until_date' => 'Antes da data de validade',
    'after_valid_until_date' => 'Após a data de validade',
    'after_quote_date' => 'Após a data da cotação',
    'remind_quote' => 'Lembrar Citação',
    'end_of_month' => 'Fim do mês',
    'tax_currency_mismatch' => 'A moeda do imposto é diferente da moeda da fatura',
    'edocument_import_already_exists' => 'A fatura já foi importada em :date',
    'before_valid_until' => 'Antes do válido até',
    'after_valid_until' => 'Após o válido até',
    'task_assigned_notification' => 'Notificação de tarefa atribuída',
    'task_assigned_notification_help' => 'Enviar um e-mail quando uma tarefa for atribuída',
    'invoices_locked_end_of_month' => 'As Faturas são bloqueadas no final do mês',
    'referral_url' => 'URL de referência',
    'add_comment' => 'Adicionar comentário',
    'added_comment' => 'Comentário salvo com sucesso',
    'tickets' => 'Ingressos',
    'assigned_group' => 'Grupo atribuído com sucesso',
    'merge_to_pdf' => 'Mesclar para PDF',
    'latest_requires_php_version' => 'Nota: a versão mais recente requer PHP :version',
    'auto_expand_product_table_notes' => 'Expandir automaticamente as notas da tabela de produtos',
    'auto_expand_product_table_notes_help' => 'Expande automaticamente a seção de notas dentro da tabela de produtos para exibir mais linhas.',
    'institution_number' => 'Número da Instituição',
    'transit_number' => 'Número de trânsito',
    'personal' => 'Pessoal',
    'address_information' => 'Informações de endereço',
    'enter_the_information_for_the_bank_account' => 'Insira as informações da conta bancária',
    'account_holder_information' => 'Informações do Titular da Conta',
    'enter_information_for_the_account_holder' => 'Insira as informações do titular da conta',
    'customer_type' => 'Tipo de cliente',
    'process_date' => 'Data do processo',
    'forever_free' => 'Para sempre livre',
    'comments_only' => 'Somente comentários',
    'payment_balance_on_file' => 'Saldo de pagamento em arquivo',
    'ubl_email_attachment_help' => 'Para mais configurações de fatura eletrônica, navegue: aqui',
    'stop_task_to_add_task_entry' => 'Você precisa interromper a tarefa antes de adicionar um novo item.',
    'xml_file' => 'Arquivo XML',
    'one_page_checkout' => 'Checkout de uma página',
    'one_page_checkout_help' => 'Habilitar o novo fluxo de pagamento de página única',
    'applies_to' => 'Aplica-se a',
    'accept_purchase_order' => 'Aceitar Ordem de Compra',
    'round_to_seconds' => 'Arredondar para segundos',
    'activity_142' => 'Citação :quote lembrete 1 enviado',
    'activity_143' => 'A fatura automática foi emitida com sucesso para a fatura :invoice',
    'activity_144' => 'Falha na fatura automática para a fatura :invoice . :notes',
    'activity_145' => 'E-Fatura :invoice para :client foi enviada. :notes',
    'payment_failed' => 'Pagamento falhou',
    'ssl_host_override' => 'Substituição de host SSL',
    'upload_logo_short' => 'Carregar logotipo',
    'country_Melilla' => 'Melilha',
    'country_Ceuta' => 'Ceuta',
    'country_Canary Islands' => 'Ilhas Canárias',
    'lang_Vietnamese' => 'vietnamita',
    'invoice_status_changed' => 'Observe que o status da sua fatura foi atualizado. Recomendamos atualizar a página para visualizar a versão mais atual.',
    'no_unread_notifications' => 'Você está atualizado! Nenhuma nova notificação.',
    'how_to_import_data' => 'Como importar dados',
    'download_example_file' => 'Baixar arquivo de exemplo',
    'expense_mailbox' => 'Endereço de e-mail de entrada',
    'expense_mailbox_help' => 'O endereço de e-mail de entrada que aceita documentos de despesas, ou seja, despesa@invoice.theredsun.org',
    'expense_mailbox_active' => 'Caixa de correio de despesas',
    'expense_mailbox_active_help' => 'Permite o processamento de documentos como recibos para relatórios de despesas',
    'inbound_mailbox_allow_company_users' => 'Permitir remetentes da empresa',
    'inbound_mailbox_allow_company_users_help' => 'Permite que usuários da empresa enviem documentos de despesas.',
    'inbound_mailbox_allow_vendors' => 'Permitir remetentes de fornecedores',
    'inbound_mailbox_allow_vendors_help' => 'Permite que os fornecedores da empresa enviem documentos de despesas',
    'inbound_mailbox_allow_clients' => 'Permitir remetentes de clientes',
    'inbound_mailbox_allow_clients_help' => 'Permite que os clientes enviem documentos de despesas',
    'inbound_mailbox_whitelist' => 'Lista de permissão de remetentes de entrada',
    'inbound_mailbox_whitelist_help' => 'Lista separada por vírgulas de e-mails que devem ter permissão para enviar e-mails para processamento',
    'inbound_mailbox_blacklist' => 'Lista de remetentes banidos',
    'inbound_mailbox_blacklist_help' => 'Lista separada por vírgulas de e-mails que não têm permissão para enviar e-mails para processamento',
    'inbound_mailbox_allow_unknown' => 'Permitir todos os remetentes',
    'inbound_mailbox_allow_unknown_help' => 'Permitir que qualquer pessoa envie um e-mail de despesas para processamento',
    'quick_actions' => 'Ações rápidas',
    'end_all_sessions_help' => 'Desconecta todos os usuários e exige que todos os usuários ativos se autentiquem novamente.',
    'updated_records' => 'Registros atualizados',
    'vat_not_registered' => 'Vendedor não registrado para fins de IVA',
    'small_company_info' => 'Nenhuma divulgação do imposto sobre vendas de acordo com § 19 UStG',
    'peppol_onboarding' => 'Parece que é sua primeira vez usando PEPPOL.',
    'get_started' => 'Começar',
    ...
    'peppol_disconnect_short' => 'Desconecte-se do PEPPOL.',
    'peppol_disconnect_long' => 'Seu número de IVA será retirado da rede PEPPOL após a desconexão. Você não poderá enviar ou receber edocumentos.',
    'log_duration_words' => 'Duração do registro de tempo em palavras',
    'log_duration' => 'Duração do registro de tempo',
    'merged_vendors' => 'Fornecedores mesclados com sucesso',
    ...
    'search_placeholder' => 'Encontre faturas, clientes e muito mais',
    'invalid_vat_number' => "O número de IVA não é válido para o país selecionado. O formato deve ser Código do país seguido apenas por número, ou seja, DE123456789",
    'acts_as_sender' => 'Enviar faturas eletrônicas',
    'acts_as_receiver' => 'Receber faturas eletrônicas',
    'peppol_token_generated' => 'Token PEPPOL gerado com sucesso.',
    'peppol_token_description' => 'O token é usado como outra etapa para garantir que as faturas sejam enviadas com segurança. Ao contrário das licenças white-label, o token pode ser rotacionado a qualquer momento sem precisar esperar pelo suporte do Red Invoice.',
    'peppol_token_warning' => 'Você precisa gerar um token para continuar.',
    'generate_token' => 'Gerar Token',
    'total_credits_amount' => 'Quantidade de créditos',
    'sales_above_threshold' => 'Vendas acima do limite',
    'changing_vat_and_id_number_note' => 'Você não pode alterar seu número de IVA ou número de identificação depois que o PEPPOL estiver configurado.',
    'iban_help' => 'O número IBAN completo',
    'bic_swift' => 'Código BIC/Swift',
    'bic_swift_help' => 'O identificador do banco',
    'payer_bank_account' => 'Número da conta bancária do pagador',
    'payer_bank_account_help' => 'O número da conta bancária do pagador',
    'bsb_sort' => 'BSB / Código de classificação',
    'bsb_sort_help' => 'Código da agência bancária',
    'card_type' => 'Tipo de cartão',
    'card_type_help' => 'ou seja, VISA, AMEX',
    'card_number_help' => 'apenas os últimos 4 dígitos',
    'card_holder' => 'Nome do Titular',
    'tokenize' => 'Tokenizar',
    'tokenize_help' => 'Tokenize o método de pagamento para uso futuro.',
    'credit_card_stripe_help' => 'Aceite pagamentos com cartão de crédito usando Stripe.',
    'bank_transfer_stripe_help' => 'Débito direto ACH. Pagamentos em USD, verificação instantânea disponível.',
    'alipay_stripe_help' => 'O Alipay permite que usuários na China paguem com segurança usando suas carteiras móveis.',
    'sofort_stripe_help' => 'Sofort é um método de pagamento europeu popular que permite transferências bancárias em tempo real, usado principalmente na Alemanha e na Áustria.',
    'apple_pay_stripe_help' => 'Apple/Google Pay para usuários com dispositivos Apple/Android, usando informações de cartão salvas para facilitar a compra.',
    'sepa_stripe_help' => 'Débito Direto SEPA (Área Única de Pagamentos em Euros).',
    'bancontact_stripe_help' => 'Bancontact é um método de pagamento amplamente utilizado na Bélgica.',
    'ideal_stripe_help' => 'iDEAL é o método de pagamento mais popular na Holanda.',
    'giropay_stripe_help' => 'Giropay é um método de pagamento alemão que facilita transferências bancárias on-line seguras e imediatas.',
    'przelewy24_stripe_help' => 'Przelewy24 é um método de pagamento comum na Polônia.',
    'direct_debit_stripe_help' => 'Transferências do Stripe Bank usando contas bancárias virtuais do Stripe, disponíveis no Japão, Reino Unido, EUA, Europa e México. Certifique-se de que isso esteja habilitado no Stripe!',
    'eps_stripe_help' => 'EPS é um sistema de pagamento online austríaco.',
    'acss_stripe_help' => 'ACSS (Automated Clearing Settlement System) Débito direto para contas bancárias canadenses.',
    'becs_stripe_help' => 'Débito direto BECS para contas bancárias australianas.',
    'klarna_stripe_help' => 'Klarna compre agora e pague depois em parcelas ou em um cronograma definido.',
    'bacs_stripe_help' => 'Débito direto BACS para contas bancárias do Reino Unido, comumente usado para cobrança de assinaturas.',
    'fpx_stripe_help' => 'FPX é um método de pagamento online popular na Malásia.',
    'payment_means' => 'Meios de pagamento',
    'act_as_sender' => 'Enviar fatura eletrônica',
    'act_as_receiver' => 'Receber fatura eletrônica',
    'saved_einvoice_details' => 'Configurações de fatura eletrônica salvas',
    'add_license_to_env' => 'Precisaremos da sua chave de licença para comunicação futura com nossos serviços. Certifique-se de usar LICENSE_KEY como variável de ambiente.',
    'white_label_license_not_present' => 'Licença não encontrada. Certifique-se de definir LICENSE_KEY como variável de ambiente.',
    'white_label_license_not_found' => 'Licença de marca branca não encontrada.',
    'details_update_info' => 'Atualizaremos os detalhes da sua empresa com as informações fornecidas.',
    'sales_above_threshold' => 'Vendas acima do limite',
    'client_address_required' => 'O endereço completo do cliente é necessário para faturamento eletrônico',
    'connected' => 'Conectado',
    'email_count_quotes' => 'E-mail :count citações',
    'activity_146' => 'E-Invoice :invoice para :client entregue com sucesso! :notes',
    'activity_147' => 'E-Fatura :invoice para :client falhou na entrega. :notes',
    'peppol_routing_problem' => 'Problema de roteamento. Nenhum destinatário/destino encontrado.',
    'peppol_sending_failed' => 'Problema técnico de entrega. Não é possível tentar novamente',
    'peppol_cleared_for_sending' => 'Liberado pela autoridade fiscal, envio ao destinatário',
    'account_holder' => 'Nome da conta',
    'account_holder_help' => 'O nome da conta',
    'activity_148' => 'E-Despesa :expense recebido de :vendor',
    'additional_tax_identifiers' => 'Identificadores fiscais adicionais',
    'additional_tax_identifiers_help' => 'Se você estiver registrado para IVA em outras regiões, poderá adicionar seus números de IVA para essas regiões aqui.',
    'configure' => 'Configurar',
    'new_identifier' => 'Novo Número de IVA',
    'notification_credits_low' => 'Aviso! Seu saldo de crédito está baixo.',
    'notification_credits_low_text' => 'Adicione créditos à sua conta para evitar interrupção dos serviços.',
    'notification_no_credits' => 'Aviso! Seu saldo de créditos está vazio.',
    'notification_no_credits_text' => 'Adicione créditos à sua conta para evitar interrupção dos serviços.',
    'saved_comment' => 'Comentário salvo',
    'acts_as_must_be_true' => 'É necessário selecionar &quot;Enviar fatura eletrônica&quot; ou &quot;Receber fatura eletrônica&quot; (ou ambos).',
    'delete_identifier' => 'Excluir identificador',
    'delete_identifier_description' => 'Excluir esse identificador o removerá do sistema. Certifique-se de que essa é a ação desejada antes de prosseguir.',
    'einvoice_something_went_wrong' => 'Oops! Algo deu errado. Entre em contato conosco em contact@invoice.theredsun.org para mais informações.',
    'download_ready' => 'Seu download já está pronto! [ :message ]',
    'notification_quote_reminder1_sent_subject' => 'O lembrete 1 para a cotação :invoice foi enviado para :client',
    'custom_reminder_sent' => 'Lembrete personalizado foi enviado para :client',
    'use_system_fonts' => 'Usar fontes do sistema',
    'use_system_fonts_help' => 'Substitua as fontes padrão pelas do navegador da web',
    'active_tasks' => 'Tarefas ativas',
    'enable_notifications' => 'Habilitar notificações',
    'enable_public_notifications' => 'Habilitar notificações públicas',
    'enable_public_notifications_help' => 'Ative notificações em tempo real do Red Invoice.',
    'navigate' => 'Navegar',
    'calculate_taxes_warning' => 'Esta ação habilitará impostos de item de linha e desabilitará impostos totais. Quaisquer faturas abertas podem ser recalculadas com as novas configurações!',
    'activity_149' => ':user enviou por e-mail o crédito :credit para :client para :contact',
    'email_history_empty' => 'Nenhum histórico de e-mail encontrado, este recurso só está disponível ao enviar com Postmark/Mailgun.',
    'e_invoicing' => 'Faturação Eletrônica',
    'einvoice_token_not_found' => 'Token de faturamento eletrônico não encontrado. Acesse Configurações &gt; Fatura eletrônica e gere novamente o token.',
    'regenerate' => 'Regenerado',
    'subscription_unavailable' => 'Este item não está mais disponível',
    'currency_samoan_tala' => 'Tala samoano',
    'confirm_duplicate_gateway' => 'Tem certeza de que deseja criar outra conexão?',
    'clients_limit' => 'Você atingiu seu limite de clientes. Por favor, atualize seu plano.',
