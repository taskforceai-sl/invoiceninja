...
<li>"เงินประกันสำหรับ :QUARTER+1" >> " ดำเนินการชำระเงินในไตรมาศที่ 2"</li>
    ...
    'pro_plan_feature3' => 'URL ที่กำหนดได้เอง - "YourBrand.Red Invoice.com"',
    'pro_plan_feature4' => 'เอา  "Created by Red Invoice" ออก',
...
<li>วันนี้เป็นวันศุกร์วันครบกำหนดคือวันศุกร์ที่ 1 หลังจาก วันครบกำหนดจะเป็นวันศุกร์ถัดไปไม่ใช่วันนี้
    ...
    'pro_plan_remove_logo' => ':link ลบโลโก้ Red Invoice โดยการเข้าร่วม Pro Plan',
    ...
    'pro_plan_year_description' => 'การลงทะเบียนหนึ่งปีสำหรับ   Red Invoice Pro Plan',
    'pro_plan_month_description' => 'ลงทะเบียนหนึ่งเดือนสำหรับ Red Invoice Pro Plan.',
    'enterprise_plan_product' => 'Enterprise Plan',
    'enterprise_plan_year_description' => 'ลงทะเบียนหนึ่งปีสำหรับ Red Invoice Enterprise Plan.',
    'enterprise_plan_month_description' => 'ลงทะเบียนหนึ่งเดือนสำหรับ Red Invoice Enterprise Plan.',
    ...
    'export_help' => 'ใช้ JSON ถ้าคุณวางแผนที่จะนำเข้าข้อมูลลงใน Red Invoice. <br/> ไฟล์ประกอบด้วยลูกค้า, สินค้า, ใบแจ้งหนี้, ใบเสนอราคา และการชำระเงิน.',
    ...
    'wepay_account_description' => 'เกตเวย์การชำระเงินสำหรับ Red Invoice',
    ...
    'update_invoiceninja_title' => 'อัปเดท Red Invoice',
    'update_invoiceninja_warning' => 'ก่อนที่จะเริ่มต้นการอัพเกรด Red Invoice กรุณาสำรองฐานข้อมูลและไฟล์ของคุณ!',
    'update_invoiceninja_available' => 'มีเวอร์ชันใหม่ของ Red Invoice ให้ใช้งาน',
    'update_invoiceninja_unavailable' => 'ไม่มีเวอร์ชันใหม่ของ Red Invoice available.',
