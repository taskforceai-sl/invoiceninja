...
$lang = array(
    ...
    'app_description' => 'Red Invoice je brezplačna rešitev z odprto kodo za izdajanje računov in zaračunavanje strankam. Z Red Invoice lahko preprosto ustvarite in pošljete čudovite račune iz katere koli naprave, ki ima dostop do spleta. Vaše stranke lahko natisnejo vaše račune, jih prenesejo kot datoteke pdf in vam celo plačajo prek spleta znotraj sistema.',
    'rows' => 'vrstic',
    'www' => 'www',
    'logo' => 'Logotip',
    'subdomain' => 'Poddomena',
    ...
    'pro_plan_feature3' => 'URL po meri - "VasePodjetje.Red Invoice.com"',
    'pro_plan_feature4' => 'Odstrani "Narejeno z uporabo programa Red Invoice"',
    ...
    'overdue' => 'Zapadlo',
    'white_label_text' => 'Za odstranitev Red Invoice znamke z računa in portala za stranke, zakupi enoletno "white Label" licenco v znesku $:price.',
    ...
    'pro_plan_remove_logo' => ':link za odstranitev logotipa Red Invoice z vstopom v Pro Plan',
    ...
    'pro_plan_year_description' => 'Letna članarina v Red Invoice Pro paket.',
    'pro_plan_month_description' => 'Mesečna članarina v Red Invoice Pro paket.',
    'enterprise_plan_product' => 'Paket za podjetja',
    'enterprise_plan_year_description' => 'Letna članarina v Red Invoice Podjetniški paket.',
    'enterprise_plan_month_description' => 'Mesečna članarina v Red Invoice Podjetniški paket.',
...
Ko imate zneske, se vrnite na to stran plačilnega sredstva in kliknite na "Complete Verification".',
    ...
    'export_help' => 'Uporabite JSON če nameravate uvoziti podatke v Red Invoice. <br/> Datoteka vsebuje stranke, izdelke, račune, predračune in plačila.',
    ...
    'wepay_account_description' => 'Plačilni prehod za Red Invoice',
    ...
    'update_invoiceninja_title' => 'Posodobi Red Invoice',
    ...
    'white_label_license_error' => 'Licence ni bilo mogoče potrditi, bodisi je potekla ali pa je bilo aktivacij preveč. Za več informacij pišite na contact@invoice.theredsun.org.',
    ...
    'local_part_help' => 'Prilagodite lokalni del dohodne e-pošte za podporo, tj. VAŠE_IME@support.invoice.theredsun.org',
    ...
    'migrate_to_next_version' => 'Preselite se na naslednjo različico Red Invoice',
    'migrate_intro_text' => 'Delali smo na naslednji različici Red Invoice. Za začetek selitve kliknite spodnji gumb.',
    'start_the_migration' => 'Začni prenos',
    'migration' => 'Prenos',
    'welcome_to_the_new_version' => 'Dobrodošli v novi različici Red Invoice',
    ...
    'is_approved' => 'Odobren',
    'migration_went_wrong' => 'Ups, nekaj je šlo narobe! Pred začetkom selitve se prepričajte, da ste nastavili primerek Red Invoice v5.',
    ...
    'welcome_to_invoice_ninja' => 'Dobrodošli v Red Invoice',
    'optin' => 'Opt-In',
    'optout' => 'Odjava',
    ...
    'migration_api_secret_notice' => 'API_SECRET najdete v datoteki .env ali Red Invoice v5. Če lastnost manjka, pustite polje prazno.',
    ...
    'migration_already_completed_desc' => 'Videti je, da ste <b>:company _name</b> že preselili v različico Red Invoice V5. Če želite začeti znova, lahko s prisilno selitvijo izbrišete obstoječe podatke.',
    ...
    'new_login_description' => 'Nedavno ste se prijavili v svoj račun Red Invoice z nove lokacije ali naprave:<br><br> <b>IP:</b> :ip<br> <b>Čas:</b> :time<br> <b>Elektronski naslov:</b> :email',
    ...
    'stripe_connect_migration_desc' => 'Red Invoice v5 uporablja Stripe Connect za povezavo vašega računa Stripe z Red Invoice. To zagotavlja dodatno raven varnosti za vaš račun. Zdaj, ko so se vaši podatki preselili, boste morali pooblastiti Stripe za sprejemanje plačil v v5.<br><br> Če želite to narediti, pojdite na Nastavitve &gt; Spletna plačila &gt; Konfiguriraj prehode. Kliknite Stripe Connect in nato pod Nastavitve kliknite Nastavitev prehoda. To vas bo pripeljalo do Stripe za avtorizacijo Red Invoice in po vaši vrnitvi bo vaš račun uspešno povezan!',
    ...
    'nordigen_requisition_body' => 'Dostop do virov bančnega računa je potekel, kot je določeno v pogodbi za končnega uporabnika.<br><br> Če želite še naprej prejemati transakcije, se prijavite v Red Invoice in znova preverite pristnost pri svojih bankah.',
    ...
    'expense_mailbox_help' => 'Dohodni e-poštni naslov, ki sprejema dokumente o stroških. tj. stroški@invoice.theredsun.org',
    ...
    'peppol_token_description' => 'Žeton se uporablja kot dodaten korak za zagotovitev varnega pošiljanja računov. Za razliko od licenc z belo oznako je žeton mogoče zamenjati kadar koli, ne da bi morali čakati na podporo za Red Invoice.',
    ...
    'einvoice_something_went_wrong' => 'Ups! Nekaj je šlo narobe. Za več informacij nas kontaktirajte na contact@invoice.theredsun.org.',
    ...
    'enable_public_notifications_help' => 'Omogočite obvestila v realnem času od Red Invoice.',
    'navigate' => 'Navigacija',
