...
$lang = array(
    ...
    'email_from' => 'El equipo de Red Invoice ',
    ...
    'stripe_payment_text' => 'Número de factura :invoice para :amount para el cliente :client',
    'stripe_payment_text_without_invoice' => 'Pago sin factura por importe :amount para cliente :client',
    ...
    'invitation_message' => ':invitor te ha invitado a unirte a su cuenta en Red Invoice.',
    ...
    'app_description' => 'Red Invoice es una solución gratuita de código abierto para facturar y facturar a los clientes. Con Red Invoice, puedes crear y enviar fácilmente hermosas facturas desde cualquier dispositivo que tenga acceso a la web. Sus clientes pueden imprimir sus facturas, descargarlas como archivos pdf e incluso pagarle en línea desde el sistema.',
    'rows' => 'filas',
    'www' => 'www',
    'logo' => 'Logo',
    ...
    'pro_plan_feature3' => 'URLs Personalizadas - "SuMarca.Red Invoice.com"',
    'pro_plan_feature4' => 'Remueve "Creado por Red Invoice"',
    ...
    'pro_plan_feature8' => 'Opción para adjuntar archivos PDF a los correos electrónicos de los clientes',
    'resume' => 'Continuar',
    ...
    'quote_reminder_emails' => 'Correos de Recordatorio de Cotizaciones',
    ...
    'archive_account_gateway' => 'Eliminar Pasarela de Pago',
    ...
    'archived' => 'Archivado',
    'untitled_account' => 'Empresa sin Nombre',
    'before' => 'Antes',
    'after' => 'Después',
    ...
    'button_confirmation_message' => 'Confirme su email.',
    'confirm' => 'Confirmar',
    ...
    'auto_convert_quote_help' => 'Convierta automáticamente una cotización en una factura cuando se apruebe.',
    'validate' => 'Validar',
    'info' => 'Info',
    ...
    'pro_plan_remove_logo' => ':link haz click para eliminar el logo de Red Invoice',
    ...
    'recurring_invoice_number_prefix_help' => 'Especifica un prefijo para ser agregado al número de las facturas recurrentes.',
    ...
    'invoice_embed_documents' => 'Incrustar imágenes/documentos',
    'invoice_embed_documents_help' => 'Incluya imágenes/pdf adjuntos en la factura.',
    'document_email_attachment' => 'Adjuntar documentos',
    'ubl_email_attachment' => 'Adjuntar UBL',
    'download_documents' => 'Download Documents (:size)',
    'documents_from_expenses' => 'From Expenses:',
    'dropzone_default_message' => 'Drop files or click to upload',
    'dropzone_default_message_disabled' => 'Subidas de archivos deshabilitados',
    ...
    'missing_account_holder_type' => 'Por favor seleccione una cuenta de empresa o persona.',
    ...
    'ach_authorization' => 'Autorizo ​​a :company a usar mi cuenta bancaria para pagos futuros y, si es necesario, acreditar electrónicamente mi cuenta para corregir débitos erróneos. Entiendo que puedo cancelar esta autorización en cualquier momento eliminando el método de pago o poniéndome en contacto con :email.',
    ...
    'export_help' => 'Use JSON si planea importar la información en Red Invoice.<br/>El archivo incluye clientes, productos, facturas, cotizaciones y pagos.',
    ...
    'realtime_preview' => 'Vista Previa en Tiempo Real',
    ...
    'logged_in' => 'Conectado',
    'switch_to_primary' => 'Cámbiese a su empresa principal (:name) para administrar su plan.',
    'inclusive' => 'Inclusivo',
    'exclusive' => 'Exclusivo',
    ...
    'white_label_license_error' => 'No se pudo validar la licencia, ya sea caducada o activaciones excesivas. Envíe un correo electrónico a contact@invoice.theredsun.org para obtener más información.',
    ...
    'invoices_are_attached' => 'Se adjuntan sus facturas en formato PDF.',
    ...
    'currency_macedonian_denar' => 'Denar macedonio',
    ...
    'contact_custom1' => 'Primero Contacto Personalizado',
    ...
    'deleted_company_details' => 'Su empresa (:account) ha sido eliminada con éxito.',
    'deleted_account_details' => 'Tu cuenta (:account) ha sido eliminada con éxito.',

    'alipay' => 'Alipay',
    'sofort' => 'Sofort',
    'sepa' => 'Débito Directo SEPA',
    'name_without_special_characters' => 'Ingrese un nombre con solo las letras az y espacios en blanco',
    ...
    'two_factor_setup_help' => 'Escanee el código de barras con una aplicación compatible con :link ',
    ...
    'self_host_login' => 'Inicio de Sesión en Servidor Propio',
    ...
    'expense_mailbox_taken' => 'El buzón de entrada ya está en uso',
    'expense_mailbox_invalid' => 'El buzón de entrada no coincide con el esquema requerido',
    ...
    'scheduled_report_attached' => 'Su informe :type programado se adjunta.',
    ...
    'archive_proposal_category' => 'Categoría de archivo',
    'delete_proposal_category' => 'Eliminar categoría',
    'created_proposal_category' => 'Categoría creada con éxito',
    'updated_proposal_category' => 'Categoría actualizada con éxito',
    'archived_proposal_category' => 'Categoría archivada con éxito',
    'deleted_proposal_category' => 'Categoría archivada con éxito',
    'archived_proposal_categories' => 'Categorías :count archivadas con éxito',
    'deleted_proposal_categories' => 'Categorías :count archivadas con éxito',
    'restored_proposal_category' => 'Categoría restaurada con éxito',
    'restore_proposal_category' => 'Categoría de restauración',
    ...
    'clone_proposal_template' => 'Plantilla de clonación',
    'proposal_email' => 'Correo electrónico de propuesta',
    'proposal_subject' => 'Nueva propuesta :number de :account',
    'proposal_message' => 'Para ver su propuesta para :amount, haga clic en el enlace a continuación.',
    'emailed_proposal' => 'Propuesta enviada por correo electrónico con éxito',
    ...
    'taxes_are_included_help' => 'Nota: Se han habilitado los impuestos incluidos.',
    'taxes_are_not_included_help' => 'Nota: Los impuestos incluidos no están habilitados.',
    'change_requires_purge' => 'Cambiar esta configuración requiere :link los datos de la cuenta.',
    'purging' => 'purga',
    'warning_local_refund' => 'El reembolso se registrará en la aplicación, pero NO será procesado por la pasarela de pago.',
    'email_address_changed' => 'Se ha cambiado la dirección de correo electrónico',
    ...
    'total_opened' => 'Total abierto',
    'total_bounced' => 'Total rebotado',
    'total_spam' => 'Correo no deseado total',
    'platforms' => 'Plataformas',
    'email_clients' => 'Clientes de correo electrónico',
    'mobile' => 'Móvil',
    'desktop' => 'Escritorio',
    'webmail' => 'Correo web',
    'group' => 'Grupo',
    ...
    'slack_webhook_help' => 'Reciba notificaciones de pago usando :link.',
    'slack_incoming_webhooks' => 'Webhooks entrantes de Slack',
    'accept' => 'Aceptar',
    'accepted_terms' => 'Aceptó con éxito los últimos términos de servicio',
    'invalid_url' => 'URL invalida',
    'workflow_settings' => 'Configuración del flujo de trabajo',
    'auto_email_invoice' => 'Correo electrónico automático',
    'auto_email_invoice_help' => 'Envíe por correo electrónico automáticamente las facturas recurrentes cuando se creen.',
    'auto_archive_invoice' => 'Archivo automático',
    'auto_archive_invoice_help' => 'Archiva automáticamente las facturas cuando se pagan.',
    'auto_archive_quote' => 'Archivo automático',
    'auto_archive_quote_help' => 'Archivar cotizaciones automáticamente cuando se convierten en factura.',
    'require_approve_quote' => 'Requerir cotización aprobada',
    'require_approve_quote_help' => 'Requerir que los clientes aprueben las cotizaciones.',
    'allow_approve_expired_quote' => 'Permitir aprobar presupuesto vencido',
    'allow_approve_expired_quote_help' => 'Permita que los clientes aprueben cotizaciones vencidas.',
    'invoice_workflow' => 'Flujo de trabajo de facturas',
    'quote_workflow' => 'Flujo de trabajo de cotización',
    'client_must_be_active' => 'Error: el cliente debe estar activo',
    'purge_client' => 'Purgar cliente',
    'purged_client' => 'Cliente purgado con éxito',
    'purge_client_warning' => 'Todos los registros relacionados (facturas, tareas, gastos, documentos, etc.) también serán eliminados.',
    'clone_product' => 'Producto Clon',
    'item_details' => 'detalles del artículo',
    'send_item_details_help' => 'Envíe los detalles de la línea de pedido a la pasarela de pago.',
    ...
    'custom_task_fields_help' => 'Agregue un campo al crear una tarea.',
    'custom_project_fields_help' => 'Agregue un campo al crear un proyecto.',
    'custom_expense_fields_help' => 'Agregue un campo al crear un gasto.',
    ...
    'unapproved_quote' => 'Cotización no aprobada',
    'unapproved_proposal' => 'Propuesta no aprobada',
    'autofills_city_state' => 'Autocompleta ciudad/estado',
    ...
    'mark' => 'Marca',
    'updated_task_status' => 'Actualizar con éxito el estado de la tarea',
    'background_image' => 'Imagen de fondo',
    'background_image_help' => 'Use :link para administrar sus imágenes, le recomendamos que use un archivo pequeño.',
    'proposal_editor' => 'editor de propuestas',
    'background' => 'Fondo',
    'guide' => 'Guía',
    'gateway_fee_item' => 'Elemento de tarifa de puerta de enlace',
    'gateway_fee_description' => 'Recargo por tarifa de puerta de enlace',
    'gateway_fee_discount_description' => 'Descuento de tarifa de puerta de enlace',
    'show_payments' => 'Mostrar pagos',
    'show_aging' => 'Mostrar envejecimiento',
    'reference' => 'Referencia',
    'amount_paid' => 'Cantidad pagada',
    'send_notifications_for' => 'Enviar notificaciones para',
    'all_invoices' => 'Todas las facturas',
    'my_invoices' => 'Mis facturas',
    'payment_reference' => 'Referencia de pago',
    'maximum' => 'Máximo',
    'sort' => 'Clasificar',
    'refresh_complete' => 'Actualizar completo',
    ...
    'please_enter_your_url' => 'Por favor ingrese su URL',
    'please_enter_a_product_key' => 'Por favor ingrese una clave de producto',
    ...
    'pdf' => 'PDF',
    'invoice_status_id' => 'Estado de la factura',
    'click_plus_to_add_item' => 'Haga clic en + para agregar un elemento',
    'count_selected' => ':count seleccionado',
    'dismiss' => 'Despedir',
    'please_select_a_date' => 'Por favor seleccione una fecha',
    'please_select_a_client' => 'Por favor seleccione un cliente',
    'language' => 'Idioma',
    'updated_at' => 'Actualizado',
    'please_enter_an_invoice_number' => 'Por favor, introduzca un número de factura',
    'please_enter_a_quote_number' => 'Por favor ingrese un número de cotización',
    ...
    'invoice_status_4' => 'Aprobado',
    'invoice_status_5' => 'Parcial',
    'invoice_status_6' => 'Pagado',
    'marked_invoice_as_sent' => 'Factura marcada correctamente como enviada',
    'please_enter_a_client_or_contact_name' => 'Por favor ingrese un nombre de cliente o contacto',
    'restart_app_to_apply_change' => 'Reinicie la aplicación para aplicar el cambio.',
    'refresh_data' => 'Actualizar datos',
    'blank_contact' => 'Contacto en blanco',
    ...
    'payment_status_4' => 'Terminado',
    'payment_status_5' => 'reintegrado parcialmente',
    'payment_status_6' => 'Reintegrado',
    'send_receipt_to_client' => 'Enviar recibo al cliente',
    ...
    'medium' => 'Medio',
    'high' => 'Alto',
    'no_due_date' => 'Sin fecha de vencimiento establecida',
    ...
    'local_part_invalid' => 'Nombre no válido (solo alfanumérico, sin espacios)',
    'local_part_help' => 'Personalice la parte local de su correo electrónico de soporte entrante, es decir. TU_NOMBRE@support.invoice.theredsun.org',
    ...
    'enable_client_upload_help' => 'Permitir a los clientes cargar documentos/archivos adjuntos',
    ...
    'close_ticket_template_id' => 'Billete cerrado',
    ...
    'clone_to_quote' => 'Clonar para cotizar',
    'convert' => 'Convertir',
    'last7_days' => 'Los últimos 7 días',
    'last30_days' => 'Últimos 30 días',
    'custom_js' => 'JS personalizado',
    'adjust_fee_percent_help' => 'Ajustar el porcentaje para tener en cuenta la tarifa',
    'show_product_notes' => 'Mostrar detalles del producto',
    'show_product_notes_help' => 'Incluya la <b>descripción y el costo</b> en el menú desplegable del producto',
    'important' => 'Importante',
    'thank_you_for_using_our_app' => '¡Gracias por usar nuestra aplicación!',
    'if_you_like_it' => 'si te gusta por favor',
    'to_rate_it' => 'para calificarlo.',
    'average' => 'Promedio',
    'unapproved' => 'no aprobado',
    'authenticate_to_change_setting' => 'Por favor, autentícate para cambiar esta configuración',
    'locked' => 'bloqueado',
    'authenticate' => 'Autenticar',
    'please_authenticate' => 'por favor autenticar',
    'biometric_authentication' => 'Autenticación biométrica',
    'auto_start_tasks' => 'Tareas de inicio automático',
    'budgeted' => 'presupuestado',
    'please_enter_a_name' => 'Por favor ingresa un nombre',
    'click_plus_to_add_time' => 'Haga clic en + para agregar tiempo',
    'design' => 'Diseño',
    'password_is_too_short' => 'La contraseña es demasiado corta',
    'failed_to_find_record' => 'No se pudo encontrar el registro',
    ...
    'uploaded_document' => 'Documento subido correctamente',
    'updated_document' => 'Documento actualizado correctamente',
    'archived_document' => 'Documento archivado correctamente',
    'deleted_document' => 'Documento eliminado con éxito',
    'restored_document' => 'Documento restaurado con éxito',
    ...
    'error_unsaved_changes' => 'Guarde o cancele sus cambios',
    ...
    'upgrade' => 'Mejora',
    'please_enter_a_first_name' => 'Por favor ingrese un nombre',
    'please_enter_a_last_name' => 'Por favor ingrese un apellido',
    'please_agree_to_terms_and_privacy' => 'Acepte los términos de servicio y la política de privacidad para crear una cuenta.',
    ...
    'email_login' => 'Correo electrónico de inicio de sesión',
    ...
    'limits_and_fees' => 'Límites/Cargos',
    'credentials' => 'Cartas credenciales',
    'require_billing_address_help' => 'Requerir que el cliente proporcione su dirección de facturación',
    'require_shipping_address_help' => 'Requerir que el cliente proporcione su dirección de envío',
    'deleted_tax_rate' => 'Tasa de impuestos eliminada con éxito',
    'restored_tax_rate' => 'Tasa de impuestos restaurada con éxito',
    'provider' => 'Proveedor',
    'company_gateway' => 'Pasarela de pago',
    'company_gateways' => 'Via de pago',
    'new_company_gateway' => 'Nueva puerta de enlace',
    'edit_company_gateway' => 'Editar puerta de enlace',
    'created_company_gateway' => 'Puerta de enlace creada con éxito',
    'updated_company_gateway' => 'Puerta de enlace actualizada con éxito',
    'archived_company_gateway' => 'Puerta de enlace archivada correctamente',
    'deleted_company_gateway' => 'Puerta de enlace eliminada con éxito',
    'restored_company_gateway' => 'Puerta de enlace restaurada con éxito',
    ...
    'created_group' => 'Grupo creado con éxito',
    ...
    'price' => 'Precio',
    'email_sign_up' => 'Registrarse por correo electrónico',
    'google_sign_up' => 'Registrarse en Google',
    'sign_up_with_google' => 'Regístrese con Google',
    'long_press_multiselect' => 'Multiselección de pulsación larga',
    'migrate_to_next_version' => 'Migrar a la próxima versión de Red Invoice',
    'migrate_intro_text' => 'Hemos estado trabajando en la próxima versión de Red Invoice. Haga clic en el botón de abajo para iniciar la migración.',
    'start_the_migration' => 'Iniciar la migración',
    'migration' => 'Migración',
    ...
    'expense3' => 'Gastos de Aduana 3',
    'expense4' => 'Gastos de Aduana 4',
    ...
    'contact_last_login' => 'Contacto Último inicio de sesión',
    'contact_full_name' => 'Nombre completo del contacto',
    'contact_custom_value1' => 'Contacto Valor personalizado 1',
    'contact_custom_value2' => 'Contacto Valor personalizado 2',
    'contact_custom_value3' => 'Contacto Valor personalizado 3',
    'contact_custom_value4' => 'Contacto Valor personalizado 4',
    'assigned_to_id' => 'Asignado a identificación',
    'created_by_id' => 'Creado por identificación',
    'add_column' => 'Añadir columna',
    'edit_columns' => 'Editar columnas',
    'to_learn_about_gogle_fonts' => 'para obtener información sobre las fuentes de Google',
    ...
    'your_message_has_been_received' => 'Hemos recibido su mensaje e intentaremos responder a la brevedad.',
    'show_product_details' => 'Mostrar detalles del producto',
    'show_product_details_help' => 'Incluya la descripción y el costo en el menú desplegable del producto',
    'pdf_min_requirements' => 'El procesador de PDF requiere :version',
    ...
    'password_is_too_easy' => 'La contraseña debe contener un carácter en mayúsculas y un número',
    'client_portal_tasks' => 'Tareas del portal del cliente',
    'client_portal_dashboard' => 'Panel del portal del cliente',
    'please_enter_a_value' => 'porfavor introduzca un valor',
    'deleted_logo' => 'Logotipo eliminado con éxito',
    'generate_number' => 'Generar Número',
    'when_saved' => 'Cuando se guarda',
    'when_sent' => 'Cuando se envía',
    'select_company' => 'Seleccionar Empresa',
    'float' => 'Flotar',
    'collapse' => 'Colapsar',
    'show_or_hide' => 'Mostrar ocultar',
    'menu_sidebar' => 'Barra lateral del menú',
    'history_sidebar' => 'Barra lateral de historial',
    'tablet' => 'Tableta',
    'layout' => 'Disposición',
    'module' => 'Módulo',
    'first_custom' => 'Primera costumbre',
    'second_custom' => 'Segunda costumbre',
    'third_custom' => 'Tercera costumbre',
    'show_cost' => 'Mostrar costo',
    'show_cost_help' => 'Muestre un campo de costo del producto para rastrear el margen de beneficio/beneficio',
    'show_product_quantity' => 'Mostrar cantidad de producto',
    'show_product_quantity_help' => 'Mostrar un campo de cantidad de producto, de lo contrario, predeterminado a uno',
    'show_invoice_quantity' => 'Mostrar cantidad de factura',
    'show_invoice_quantity_help' => 'Mostrar un campo de cantidad de artículo de línea, de lo contrario, predeterminado a uno',
    'default_quantity' => 'Cantidad predeterminada',
    'default_quantity_help' => 'Establecer automáticamente la cantidad de la línea de pedido en uno',
    'one_tax_rate' => 'Tasa de un impuesto',
    'two_tax_rates' => 'Dos tasas de impuestos',
    'three_tax_rates' => 'Tres tasas de impuestos',
    'default_tax_rate' => 'Tasa de impuestos predeterminada',
    'invoice_tax' => 'Factura Impuesto',
    'line_item_tax' => 'Impuesto de artículo de línea',
    'inclusive_taxes' => 'Impuestos Inclusivos',
    'invoice_tax_rates' => 'Tasas de impuestos de factura',
    'item_tax_rates' => 'Tasas de impuestos de artículos',
    'configure_rates' => 'Configurar tarifas',
    'tax_settings_rates' => 'Las tasas de impuestos',
    'accent_color' => 'Acentuar el color',
    ...
    'recover_password_email_sent' => 'Se ha enviado un correo electrónico de recuperación de contraseña.',
    'removed_user' => 'Usuario eliminado con éxito',
    ...
    'email_style_custom' => 'Estilo de correo electrónico personalizado',
    'custom_message_dashboard' => 'Mensaje de panel personalizado',
    'custom_message_unpaid_invoice' => 'Mensaje personalizado de factura sin pagar',
    'custom_message_paid_invoice' => 'Mensaje de factura pagada personalizado',
    ...
    'task_number_pattern' => 'Patrón de número de tarea',
    'task_number_counter' => 'Contador de números de tareas',
    'expense_number_pattern' => 'Patrón de número de gastos',
    'expense_number_counter' => 'Contador de números de gastos',
    'vendor_number_pattern' => 'Patrón de número de proveedor',
    'vendor_number_counter' => 'Contador de número de proveedor',
    'ticket_number_pattern' => 'Patrón de número de boleto',
    'ticket_number_counter' => 'Contador de número de billete',
    'payment_number_pattern' => 'Patrón de número de pago',
    'payment_number_counter' => 'Contador de número de pago',
    'invoice_number_pattern' => 'Patrón de número de factura',
    'quote_number_pattern' => 'Patrón de número de cotización',
    'client_number_pattern' => 'Patrón de número de crédito',
    'client_number_counter' => 'Contador de números de crédito',
    'credit_number_pattern' => 'Patrón de número de crédito',
    ...
    'default_tax_rate_2' => 'Tasa de impuestos predeterminada 2',
    'default_tax_name_3' => 'Nombre fiscal predeterminado 3',
    'default_tax_rate_3' => 'Tasa de impuesto predeterminada 3',
    'email_subject_invoice' => 'Asunto de la factura por correo electrónico',
    'email_subject_quote' => 'Asunto de la cotización por correo electrónico',
    'email_subject_payment' => 'Asunto del pago por correo electrónico',
    'switch_list_table' => 'Tabla de lista de interruptores',
    ...
    'client_address2' => 'Apartamento/Suite Cliente',
    'client_shipping_address1' => 'Calle de envío del cliente',
    'client_shipping_address2' => 'Cliente Envío Apt/Suite',
    'tax_rate1' => 'Tasa de impuesto 1',
    'tax_rate2' => 'Tasa de impuesto 2',
    'tax_rate3' => 'Tasa de impuestos 3',
    'archived_at' => 'Archivado en',
    'has_expenses' => 'tiene gastos',
    'custom_taxes1' => 'Impuestos aduaneros 1',
    'custom_taxes2' => 'Impuestos aduaneros 2',
    'custom_taxes3' => 'Impuestos aduaneros 3',
    'custom_taxes4' => 'Impuestos aduaneros 4',
    ...
    'migration_went_wrong' => '¡Huy! Algo salió mal! Asegúrese de haber configurado una instancia de Red Invoice v5 antes de iniciar la migración.',
    'cross_migration_message' => 'No se permite la migración entre cuentas. Lea más sobre esto aquí: <a href="https://invoiceninja.github.io/docs/migration/#troubleshooting">https://invoiceninja.github.io/docs/migration/#troubleshooting</a>',
    'email_credit' => 'Crédito de correo electrónico',
    'client_email_not_set' => 'El cliente no tiene una dirección de correo electrónico configurada',
    'ledger' => 'Libro mayor',
    'view_pdf' => 'Ver PDF',
    ...
    'reminder_endless' => 'Recordatorios interminables',
    'number_of_days' => 'Número de días',
    'configure_payment_terms' => 'Configurar condiciones de pago',
    'payment_term' => 'Plazo de pago',
    'new_payment_term' => 'Nuevo plazo de pago',
    'deleted_payment_term' => 'Plazo de pago eliminado con éxito',
    'removed_payment_term' => 'Plazo de pago eliminado con éxito',
    'restored_payment_term' => 'Plazo de pago restaurado con éxito',
    'full_width_editor' => 'Editor de ancho completo',
    'full_height_filter' => 'Filtro de altura completa',
    'email_sign_in' => 'Iniciar sesión con correo electrónico',
    'change' => 'Cambiar',
    'change_to_mobile_layout' => '¿Cambiar al diseño móvil?',
    'change_to_desktop_layout' => '¿Cambiar al diseño del escritorio?',
    'send_from_gmail' => 'Enviar desde Gmail',
    'reversed' => 'invertido',
    'cancelled' => 'Cancelado',
    'quote_amount' => 'Importe de cotización',
    'hosted' => 'alojado',
    'selfhosted' => 'Autohospedado',
    'hide_menu' => 'Ocultar el menú',
    'show_menu' => 'Muestrame el menu',
    ...
    'search_tax_rates' => 'Buscar tasas de impuestos',
    ...
    'cancelled_invoice' => 'Factura cancelada con éxito',
    'cancelled_invoices' => 'Facturas canceladas con éxito',
    'reversed_invoice' => 'Factura revertida exitosamente',
    'reversed_invoices' => 'Facturas revertidas exitosamente',
    'reverse' => 'Contrarrestar',
    'filtered_by_project' => 'Filtrado por Proyecto',
    'google_sign_in' => 'Inicia sesión con Google',
    'activity_58' => ':user factura anulada :invoice',
    'activity_59' => ':user factura cancelada :invoice',
    'payment_reconciliation_failure' => 'Error de conciliación',
    'payment_reconciliation_success' => 'Éxito de la reconciliación',
    'gateway_success' => 'Éxito de la puerta de enlace',
    'gateway_failure' => 'Fallo de puerta de enlace',
    'gateway_error' => 'Error de puerta de enlace',
    'email_send' => 'Enviar correo electrónico',
    'email_retry_queue' => 'Cola de reintento de correo electrónico',
    'failure' => 'Falla',
    'quota_exceeded' => 'Cuota excedida',
    'upstream_failure' => 'Fallo aguas arriba',
    'system_logs' => 'Registros del sistema',
    'copy_link' => 'Copiar link',
    'welcome_to_invoice_ninja' => 'Bienvenido a Factura Ninja',
    'optin' => 'Optar en',
    'optout' => 'Optar por no',
    ...
    'emailed_credits' => 'Créditos enviados por correo electrónico con éxito',
    'view_in_stripe' => 'Ver en banda',
    ...
    'storefront_help' => 'Habilitar aplicaciones de terceros para crear facturas',
    'count_records_selected' => ':count registros seleccionados',
    'count_record_selected' => ':count registro seleccionado',
    'client_created' => 'Cliente creado',
    'online_payment_email' => 'Correo electrónico de pago en línea',
    'manual_payment_email' => 'Correo electrónico de pago manual',
    'completed' => 'Terminado',
    'gross' => 'Bruto',
    ...
    'selected_quotes' => 'Cotizaciones seleccionadas',
    ...
    'when_paid' => 'cuando se paga',
    'expires_on' => 'Expira el',
    'show_sidebar' => 'Mostrar barra lateral',
    'hide_sidebar' => 'Esconder barra lateral',
    'event_type' => 'Tipo de evento',
    'copy' => 'Copiar',
    'must_be_online' => 'Reinicie la aplicación una vez que esté conectado a Internet.',
    'crons_not_enabled' => 'Los crones necesitan estar habilitados',
    'api_webhooks' => 'Webhooks de API',
    ...
    'created_webhook' => 'Webhook creado con éxito',
    'updated_webhook' => 'Webhook actualizado con éxito',
    'archived_webhook' => 'Webhook archivado correctamente',
    'deleted_webhook' => 'Webhook eliminado con éxito',
    'removed_webhook' => 'Webhook eliminado con éxito',
    'restored_webhook' => 'Webhook restaurado con éxito',
    'search_tokens' => 'Buscar tokens :count',
    'search_token' => 'Buscar 1 ficha',
    'new_token' => 'Nueva ficha',
    'removed_token' => 'Token eliminado con éxito',
    'restored_token' => 'Token restaurado con éxito',
    'client_registration' => 'Registro de Cliente',
    'client_registration_help' => 'Permitir que los clientes se registren por sí mismos en el portal',
    'customize_and_preview' => 'Personalizar y vista previa',
    ...
    'force_update_help' => 'Está ejecutando la última versión, pero puede haber correcciones pendientes disponibles.',
    'mark_paid_help' => 'Rastree el gasto que ha sido pagado',
    'mark_invoiceable_help' => 'Habilitar el gasto a facturar',
    'add_documents_to_invoice_help' => 'Hacer que los documentos sean visibles para el cliente',
    ...
    'capture_card' => 'Tarjeta de captura',
    'auto_bill_enabled' => 'Factura automática habilitada',
    'total_taxes' => 'Impuestos Totales',
    'line_taxes' => 'Impuestos de línea',
    'total_fields' => 'Campos totales',
    'stopped_recurring_invoice' => 'Factura recurrente detenida con éxito',
    'started_recurring_invoice' => 'Factura recurrente iniciada con éxito',
    'resumed_recurring_invoice' => 'Factura recurrente reanudada con éxito',
    'gateway_refund' => 'Reembolso de puerta de enlace',
    'gateway_refund_help' => 'Tramitar la devolución con la pasarela de pago',
    'due_date_days' => 'Fecha de vencimiento',
    'paused' => 'en pausa',
    'day_count' => 'Día :count',
    'first_day_of_the_month' => 'Primer día del mes',
    'last_day_of_the_month' => 'Último día del mes',
    'use_payment_terms' => 'Usar condiciones de pago',
    'endless' => 'Sin fin',
    'next_send_date' => 'Próxima fecha de envío',
    'remaining_cycles' => 'Ciclos restantes',
    'created_recurring_invoice' => 'Factura recurrente creada con éxito',
    'updated_recurring_invoice' => 'Factura recurrente actualizada con éxito',
    'removed_recurring_invoice' => 'Factura recurrente eliminada con éxito',
    ...
    'default_task_rate' => 'Tasa de tareas predeterminada',
    ...
    'edit_task_status' => 'Editar estado de tareas',
    'created_task_status' => 'Estado de la tarea creada con éxito',
    'archived_task_status' => 'Estado de la tarea archivada con éxito',
    'deleted_task_status' => 'Estado de la tarea eliminada con éxito',
    'removed_task_status' => 'Estado de la tarea eliminada con éxito',
    'restored_task_status' => 'Estado de tarea restaurado con éxito',
    'search_task_status' => 'Estado de la tarea de búsqueda 1',
    'search_task_statuses' => 'Buscar :count Estados de tareas',
    'show_tasks_table' => 'Mostrar tabla de tareas',
    'show_tasks_table_help' => 'Mostrar siempre la sección de tareas al crear facturas',
    'invoice_task_timelog' => 'Registro de tiempo de tareas de facturas',
    'invoice_task_timelog_help' => 'Agregar detalles de tiempo a los elementos de línea de la factura',
    'auto_start_tasks_help' => 'Iniciar tareas antes de guardar',
    ...
    'removed_expense_category' => 'Categoría de gastos eliminada con éxito',
    'search_expense_category' => 'Buscar 1 categoría de gastos',
    'search_expense_categories' => 'Buscar :count Categorías de gastos',
    'use_available_credits' => 'Usar créditos disponibles',
    'show_option' => 'Mostrar opción',
    'negative_payment_error' => 'El monto del crédito no puede exceder el monto del pago',
    'should_be_invoiced_help' => 'Habilitar el gasto a facturar',
    'configure_gateways' => 'Configurar puertas de enlace',
    'payment_partial' => 'Pago parcial',
    'is_running' => 'Esta corriendo',
    'invoice_currency_id' => 'ID de moneda de factura',
    'tax_name1' => 'Nombre fiscal 1',
    'tax_name2' => 'Nombre fiscal 2',
    'transaction_id' => 'ID de transacción',
    'invoice_late' => 'Factura atrasada',
    'quote_expired' => 'Cotización caducada',
    'recurring_invoice_total' => 'Total de la factura',
    'actions' => 'Comportamiento',
    'expense_number' => 'Número de gastos',
    'task_number' => 'Número de tarea',
    'project_number' => 'Número de proyecto',
    'view_settings' => 'Ver configuraciones',
    'company_disabled_warning' => 'Advertencia: esta empresa aún no ha sido activada',
    'late_invoice' => 'Factura atrasada',
    'expired_quote' => 'Cotización vencida',
    'remind_invoice' => 'Recordar Factura',
    'client_phone' => 'Teléfono del cliente',
    'required_fields' => 'Campos requeridos',
    'enabled_modules' => 'Módulos habilitados',
    'activity_60' => ':contact cita vista :quote',
    'activity_61' => ':user cliente actualizado :client',
    'activity_62' => ':user proveedor actualizado :vendor',
    'activity_63' => ':user envió por correo electrónico el primer recordatorio de la factura :invoice a :contact',
    'activity_64' => ':user segundo recordatorio por correo electrónico de la factura :invoice a :contact',
    'activity_65' => ':user envió por correo electrónico el tercer recordatorio de la factura :invoice a :contact',
    'activity_66' => ':user envió un recordatorio interminable por correo electrónico para la factura :invoice a :contact',
    'expense_category_id' => 'Id. de categoría de gastos',
    'view_licenses' => 'Ver licencias',
    'fullscreen_editor' => 'Editor de pantalla completa',
    'sidebar_editor' => 'Editor de barra lateral',
    'please_type_to_confirm' => 'Escriba &quot;:value&quot; para confirmar',
    'purge' => 'Purga',
    'clone_to' => 'Clonar a',
    'clone_to_other' => 'Clonar a otro',
    'labels' => 'Etiquetas',
    'add_custom' => 'Añadir personalizado',
    'payment_tax' => 'Pago de impuestos',
    ...
    'app_platforms' => 'Plataformas de aplicaciones',
    'archived_task_statuses' => 'Estados de tareas :value archivados con éxito',
    'deleted_task_statuses' => 'Estados de tareas :value eliminados con éxito',
    'restored_task_statuses' => 'Restaurado con éxito los estados de la tarea :value',
    'deleted_expense_categories' => 'Se eliminaron con éxito las categorías de gastos :value',
    'restored_expense_categories' => 'Gasto restaurado con éxito :value categorías',
    'archived_recurring_invoices' => 'Facturas :value recurrentes archivadas con éxito',
    'deleted_recurring_invoices' => 'Facturas :value recurrentes eliminadas con éxito',
    'restored_recurring_invoices' => 'Facturas :value recurrentes restauradas con éxito',
    'archived_webhooks' => 'Webhooks :value archivados con éxito',
    'deleted_webhooks' => 'Se eliminaron con éxito los webhooks :value',
    'removed_webhooks' => 'Se eliminaron con éxito los webhooks :value',
    'restored_webhooks' => 'Webhooks :value restaurados con éxito',
    'api_docs' => 'Documentos API',
    'archived_tokens' => 'Tokens :value archivados con éxito',
    'deleted_tokens' => 'Tokens :value eliminados con éxito',
    'restored_tokens' => 'Tokens :value restaurados con éxito',
    'archived_payment_terms' => 'Condiciones de pago :value archivadas con éxito',
    'deleted_payment_terms' => 'Se eliminaron con éxito las condiciones de pago :value',
    'restored_payment_terms' => 'Condiciones de pago :value restauradas con éxito',
    'archived_designs' => 'Diseños :value archivados con éxito',
    'deleted_designs' => 'Diseños :value eliminados con éxito',
    'restored_designs' => 'Diseños :value restaurados con éxito',
    'restored_credits' => 'Créditos :value restaurados con éxito',
    'archived_users' => 'Usuarios :value archivados con éxito',
    'deleted_users' => 'Usuarios :value eliminados con éxito',
    'removed_users' => 'Se eliminaron con éxito los usuarios :value',
    'restored_users' => 'Usuarios :value restaurados con éxito',
    'archived_tax_rates' => 'Tasas de impuestos archivadas con éxito :value',
    'deleted_tax_rates' => 'Tasas de impuestos eliminadas con éxito :value',
    'restored_tax_rates' => 'Tasas de impuestos :value restauradas con éxito',
    'archived_company_gateways' => 'Puertas de enlace :value archivadas correctamente',
    'deleted_company_gateways' => 'Puertas de enlace :value eliminadas con éxito',
    'restored_company_gateways' => 'Puertas de enlace :value restauradas con éxito',
    'archived_groups' => 'Grupos :value archivados con éxito',
    'deleted_groups' => 'Grupos :value eliminados con éxito',
    'restored_groups' => 'Grupos :value restaurados con éxito',
    'archived_documents' => 'Documentos :value archivados con éxito',
    'deleted_documents' => 'Documentos :value eliminados con éxito',
    'restored_documents' => 'Documentos :value restaurados con éxito',
    'restored_vendors' => 'Proveedores restaurados con éxito :value',
    'restored_expenses' => 'Gastos :value restaurados con éxito',
    'restored_tasks' => 'Tareas :value restauradas con éxito',
    'restored_projects' => 'Proyectos :value restaurados con éxito',
    'restored_products' => 'Productos :value restaurados con éxito',
    'restored_clients' => 'Clientes :value restaurados con éxito',
    'restored_invoices' => 'Facturas :value restauradas con éxito',
    'restored_payments' => 'Pagos :value restaurados con éxito',
    'restored_quotes' => 'Cotizaciones :value restauradas con éxito',
    'update_app' => 'Actualizar aplicación',
    'started_import' => 'Importación iniciada con éxito',
    'duplicate_column_mapping' => 'Asignación de columnas duplicadas',
    'uses_inclusive_taxes' => 'Utiliza Impuestos Inclusivos',
    'is_amount_discount' => 'Es cantidad de descuento',
    'map_to' => 'Mapa para',
    'first_row_as_column_names' => 'Usar la primera fila como nombres de columna',
    'no_file_selected' => 'Ningún archivo seleccionado',
    'import_type' => 'Tipo de importación',
    'draft_mode' => 'Modo borrador',
    'draft_mode_help' => 'Obtener una vista previa de las actualizaciones más rápido pero menos preciso',
    'show_product_discount' => 'Mostrar descuento del producto',
    'show_product_discount_help' => 'Mostrar un campo de descuento de artículo de línea',
    'tax_name3' => 'Nombre fiscal 3',
    'debug_mode_is_enabled' => 'El modo de depuración está habilitado',
    'debug_mode_is_enabled_help' => 'Advertencia: está diseñado para usarse en máquinas locales, puede filtrar credenciales. Haz click para aprender mas.',
    'running_tasks' => 'Tareas en ejecución',
    'recent_tasks' => 'Tareas recientes',
    'recent_expenses' => 'Gastos Recientes',
    'upcoming_expenses' => 'Próximos gastos',
    'search_payment_term' => 'Buscar 1 Plazo de pago',
    'search_payment_terms' => 'Buscar :count Condiciones de pago',
    ...
    'is_sent' => 'Se ha enviado',
    'document_upload' => 'Carga de documentos',
    'document_upload_help' => 'Permitir que los clientes carguen documentos',
    'expense_total' => 'Total de gastos',
    'enter_taxes' => 'Ingresar Impuestos',
    'by_rate' => 'Por tarifa',
    'by_amount' => 'Por monto',
    'enter_amount' => 'Ingrese la cantidad',
    'before_taxes' => 'Antes de los impuestos',
    'after_taxes' => 'después de impuestos',
    'color' => 'Color',
    'show' => 'Espectáculo',
    'empty_columns' => 'Columnas vacías',
    'project_name' => 'Nombre del proyecto',
    'counter_pattern_error' => 'Para usar :client_counter, agregue :client_number o :client_id_number para evitar conflictos',
    'this_quarter' => 'Este cuarto',
    'to_update_run' => 'Para actualizar ejecutar',
    ...
    'pay_with' => 'Pagar con',
    'n/a' => 'N / A',
    'by_clicking_next_you_accept_terms' => 'Al hacer clic en &quot;Siguiente&quot; acepta los términos.',
    ...
    'notification_invoice_custom_sent_subject' => 'Se envió un recordatorio personalizado a :client',
    ...
    'refund_without_invoices' => 'Si intenta reembolsar un pago con facturas adjuntas, especifique la(s) factura(s) válida(s) a reembolsar.',
    'refund_without_credits' => 'Si intenta reembolsar un pago con créditos adjuntos, especifique los créditos válidos que se reembolsarán.',
    ...
    'user_not_associated_with_this_account' => 'No es posible vincular a este usuario a esta empresa. ¿Quizás ya haya registrado un usuario en otra cuenta?',
    ...
    'online_payments_minimum_note' => 'Nota: Los pagos en línea solo se admiten si el monto es mayor a $1 o su equivalente en otra moneda.',
    ...
    'migration_api_secret_notice' => 'Puede encontrar API_SECRET en el archivo .env o en Red Invoice v5. Si falta alguna propiedad, deje el campo en blanco.',
    ...
    'activity_83' => ':user suscripción eliminada :subscription',
    'activity_84' => ':user suscripción restaurada :subscription',
    'amount_greater_than_balance_v5' => 'El importe es mayor que el saldo de la factura. No se puede pagar de más una factura.',
    'click_to_continue' => 'Haz click para continuar',
    'notification_invoice_created_body' => 'La siguiente factura :invoice fue creada para el cliente :client para :amount.',
    'notification_invoice_created_subject' => 'Se creó la factura :invoice para :client',
    'notification_quote_created_body' => 'La siguiente cotización :invoice fue creada para el cliente :client para :amount.',
    'notification_quote_created_subject' => 'Citar :invoice fue creado para :client',
    'notification_credit_created_body' => 'Se creó el siguiente crédito :invoice para el cliente :client para :amount.',
    'notification_credit_created_subject' => 'El crédito :invoice fue creado para :client',
    'max_companies' => 'Máximo de empresas migradas',
    'max_companies_desc' => 'Ha alcanzado su número máximo de empresas. Eliminar empresas existentes para migrar otras nuevas.',
    'migration_already_completed' => 'La empresa ya migró',
    'migration_already_completed_desc' => 'Parece que ya migró <b>:company_name</b> a la versión V5 de Red Invoice. En caso de que desee comenzar de nuevo, puede forzar la migración para borrar los datos existentes.',
    'payment_method_cannot_be_authorized_first' => 'Este método de pago se puede guardar para uso futuro, una vez que complete su primera transacción. No olvide verificar &quot;Detalles de la tienda&quot; durante el proceso de pago.',
    'new_account' => 'Nueva cuenta',
    'activity_100' => ':user factura recurrente creada :recurring_invoice',
    'activity_101' => ':user factura recurrente actualizada :recurring_invoice',
    'activity_102' => ':user factura recurrente archivada :recurring_invoice',
    'activity_103' => ':user factura recurrente eliminada :recurring_invoice',
    'activity_104' => ':user factura recurrente restaurada :recurring_invoice',
    'new_login_detected' => 'Nuevo inicio de sesión detectado para su cuenta.',
    'new_login_description' => 'Recientemente inició sesión en su cuenta de Red Invoice desde una nueva ubicación o dispositivo:<br><br> <b>IP:</b> :ip<br> <b>Hora:</b> :time<br> <b>Correo electrónico:</b> :email',
    ...
    'account_passwordless_login' => 'Inicio de sesión sin contraseña de la cuenta',
    'user_duplicate_error' => 'No se puede agregar el mismo usuario a la misma empresa',
    'user_cross_linked_error' => 'El usuario existe pero no se puede vincular de forma cruzada con varias cuentas',
    'ach_verification_notification_label' => 'Verificación ACH',
    'ach_verification_notification' => 'Las cuentas bancarias conectadas requieren verificación. La pasarela de pago enviará automáticamente dos pequeños depósitos para este fin. Estos depósitos tardan de 1 a 2 días hábiles en aparecer en el estado de cuenta en línea del cliente.',
    'login_link_requested_label' => 'Enlace de inicio de sesión solicitado',
    'login_link_requested' => 'Hubo una solicitud para iniciar sesión usando un enlace. Si no solicitó esto, es seguro ignorarlo.',
    'invoices_backup_subject' => 'Tus facturas están listas para descargar',
    'migration_failed_label' => 'Migración fallida',
    ...
    'quote_was_approved_label' => 'La cotización fue aprobada',
    'quote_was_approved' => 'Nos gustaría informarle que la cotización fue aprobada.',
    ...
    'amount_cents' => 'Cantidad en centavos, peniques o centavos. es decir, por $ 0.10, ingrese 10',
    'default_payment_method_label' => 'método de pago por defecto',
    'default_payment_method' => 'Haga de esta su forma preferida de pago.',
    'already_default_payment_method' => 'Esta es su forma preferida de pago.',
    ...
    'quotes_with_status_sent_can_be_approved' => 'Solo se pueden aprobar las cotizaciones con estado &quot;Enviado&quot;. No se pueden aprobar las cotizaciones vencidas.',
    ...
    'recurring_quote_number_taken' => 'Número de cotización recurrente :number ya tomado',
    'account_type' => 'Tipo de cuenta',
    'locality' => 'Localidad',
    'checking' => 'Comprobación',
    'savings' => 'Ahorros',
    'unable_to_verify_payment_method' => 'No se puede verificar el método de pago.',
    'generic_gateway_error' => 'Error de configuración de la puerta de enlace. Por favor verifique sus credenciales.',
    'my_documents' => 'Mis documentos',
    'payment_method_cannot_be_preauthorized' => 'Este método de pago no se puede preautorizar.',
    'kbc_cbc' => 'KBC/CBC',
    ...
    'przelewy24_accept' => 'Declaro que me he familiarizado con las normas y la obligación de información del servicio Przelewy24.',
    'giropay' => 'GiroPay',
    'giropay_law' => 'Al ingresar su información de Cliente (como nombre, código de clasificación y número de cuenta), usted (el Cliente) acepta que esta información se brinda voluntariamente.',
    'klarna' => 'Klarna',
    'eps' => 'EPS',
    'becs' => 'Débito Directo BECS',
    'bacs' => 'Débito Directo BACS',
    'payment_type_BACS' => 'Débito Directo BACS',
    'missing_payment_method' => 'Primero agregue un método de pago, antes de intentar pagar.',
    'becs_mandate' => 'Al proporcionar los detalles de su cuenta bancaria, acepta esta <a class="underline" href="https://stripe.com/au-becs-dd-service-agreement/legal">Solicitud de débito directo y el acuerdo de servicio de Solicitud de débito directo</a> , y autoriza a Stripe Payments Australia Pty Ltd ACN 160 180 343 Número de ID de usuario de débito directo 507156 (&quot;Stripe&quot;) para debitar su cuenta a través del Bulk Electronic Clearing System (BECS) en nombre de :company (el &quot;Comerciante&quot;) por cualquier monto que el Comerciante le haya comunicado por separado. Usted certifica que es titular de una cuenta o un signatario autorizado de la cuenta mencionada anteriormente.',
    ...
    'no_available_methods' => 'No podemos encontrar ninguna tarjeta de crédito en su dispositivo. <a href="https://invoiceninja.github.io/docs/payments#apple-pay-google-pay-microsoft-pay" target="_blank" class="underline">Lea más sobre esto.</a>',
    ...
    'payment_type_Instant Bank Pay' => 'Pago bancario instantáneo',
    'payment_type_Hosted Page' => 'Página alojada',
    ...
    'show_pdf_preview' => 'Mostrar vista previa de PDF',
    'show_pdf_preview_help' => 'Mostrar vista previa de PDF mientras edita facturas',
    'print_pdf' => 'Imprimir PDF',
    'remind_me' => 'Recuerdame',
    'instant_bank_pay' => 'Pago bancario instantáneo',
    'click_selected' => 'Haga clic en Seleccionado',
    'hide_preview' => 'Ocultar vista previa',
    'edit_record' => 'Editar registro',
    'credit_is_more_than_invoice' => 'El monto del crédito no puede ser mayor que el monto de la factura',
    'please_set_a_password' => 'Establezca una contraseña de cuenta',
    'recommend_desktop' => 'Recomendamos usar la aplicación de escritorio para obtener el mejor rendimiento',
    'recommend_mobile' => 'Recomendamos usar la aplicación móvil para obtener el mejor rendimiento',
    ...
    'error_cross_client_expenses' => 'Los gastos deben pertenecer todos al mismo cliente',
    'app' => 'aplicación',
    ...
    'bulk_email_credit' => 'Crédito de correo electrónico',
    ...
    'enable_markdown' => 'Habilitar descuento',
    ...
    'colors' => 'Colores',
    'sidebar_active_background_color' => 'Color de fondo activo de la barra lateral',
    'sidebar_active_font_color' => 'Color de fuente activo de la barra lateral',
    'sidebar_inactive_background_color' => 'Color de fondo inactivo de la barra lateral',
    'sidebar_inactive_font_color' => 'Color de fuente inactivo de la barra lateral',
    ...
    'free_trial_ends_today' => 'Hoy es el último día de la prueba del plan Pro, haga clic para actualizar.',
    'change_email' => 'Cambiar e-mail',
    'client_portal_domain_hint' => 'Opcionalmente, configure un dominio de portal de cliente separado',
    'tasks_shown_in_portal' => 'Tareas mostradas en el portal',
    'uninvoiced' => 'no facturado',
    'subdomain_guide' => 'El subdominio se usa en el portal del cliente para personalizar los enlaces para que coincidan con su marca. es decir, https://your-brand.invoicing.co',
    ...
    'json' => 'JSON',
    'no_payment_types_enabled' => 'No hay tipos de pago habilitados',
    'wait_for_data' => 'Espere a que los datos terminen de cargarse',
    ...
    'show_task_end_date' => 'Mostrar fecha de finalización de la tarea',
    ...
    'preview_sidebar' => 'Barra lateral de vista previa',
    'years_data_shown' => 'Años Datos mostrados',
    'ended_all_sessions' => 'Finalizó con éxito todas las sesiones',
    'end_all_sessions' => 'Finalizar todas las sesiones',
    'count_session' => '1 sesión',
    'count_sessions' => ':count Sesiones',
    ...
    'add_body_variable_message' => 'Asegúrese de incluir una variable :body',
    ...
    'portrait' => 'Retrato',
    'landscape' => 'Paisaje',
    'owner_upgrade_to_paid_plan' => 'El propietario de la cuenta puede actualizar a un plan pago para habilitar la configuración avanzada avanzada',
    'upgrade_to_paid_plan' => 'Actualice a un plan pago para habilitar la configuración avanzada',
    'invoice_payment_terms' => 'Condiciones de pago de facturas',
    'quote_valid_until' => 'Cotización válida hasta',
    'no_headers' => 'Sin encabezados',
    'add_header' => 'Agregar encabezado',
    'remove_header' => 'Eliminar encabezado',
    'return_url' => 'URL de retorno',
    'rest_method' => 'Método REPOSO',
    ...
    'per_seat_enabled' => 'Por puesto habilitado',
    'max_seats_limit' => 'Límite máximo de asientos',
    'trial_enabled' => 'Prueba habilitada',
    ...
    'email_bounced' => 'Correo electrónico rebotado',
    ...
    'authentication_failure' => 'Fallo de autentificacion',
    'pdf_failed' => 'PDF fallido',
    'pdf_success' => 'Éxito en PDF',
    'modified' => 'Modificado',
    'html_mode' => 'Modo HTML',
    'html_mode_help' => 'Obtener una vista previa de las actualizaciones más rápido pero menos preciso',
    'status_color_theme' => 'Tema de color de estado',
    'load_color_theme' => 'Cargar tema de color',
    'lang_Estonian' => 'estonio',
    'marked_credit_as_paid' => 'Crédito marcado correctamente como pagado',
    'marked_credits_as_paid' => 'Créditos marcados con éxito como pagados',
    'wait_for_loading' => 'Carga de datos: espere a que se complete',
    'wait_for_saving' => 'Guardado de datos: espere a que se complete',
    'html_preview_warning' => 'Nota: los cambios realizados aquí solo se muestran en una vista previa, deben aplicarse en las pestañas de arriba para guardarse',
    'remaining' => 'Restante',
    'invoice_paid' => 'Factura pagada',
    'activity_120' => ':user creó un gasto recurrente :recurring_expense',
    'activity_121' => ':user gasto recurrente actualizado :recurring_expense',
    ...
    'client_shipping_state' => 'Estado de envío del cliente',
    ...
    'custom_emails_disabled_help' => 'Para evitar el correo no deseado, necesitamos actualizar a una cuenta paga para personalizar el correo electrónico.',
    'upgrade_to_add_company' => 'Mejora tu plan para agregar empresas',
    'file_saved_in_downloads_folder' => 'El archivo se ha guardado en la carpeta de descargas.',
    'small' => 'Pequeño',
    'quotes_backup_subject' => 'Tus cotizaciones están listas para descargar',
    ...
    'total_columns' => 'Campos de totales',
    'view_task' => 'Ver tarea',
    ...
    'enable_email_markdown' => 'Habilitar la reducción de correo electrónico',
    'enable_email_markdown_help' => 'Use el editor visual de rebajas para correos electrónicos',
    'enable_pdf_markdown' => 'Habilitar reducción de PDF',
    'json_help' => 'Nota: los archivos JSON generados por la aplicación v4 no son compatibles',
    'release_notes' => 'Notas de lanzamiento',
    'upgrade_to_view_reports' => 'Actualiza tu plan para ver informes',
    'started_tasks' => 'Comenzó con éxito las tareas :value',
    'stopped_tasks' => 'Detuvo con éxito las tareas :value',
    'approved_quote' => 'Presupuesto aprobado con éxito',
    'approved_quotes' => 'Cotizaciones aprobadas con éxito :value',
    ...
    'restore_company_gateway' => 'Restaurar puerta de enlace',
    'archive_company_gateway' => 'Pasarela de archivo',
    'delete_company_gateway' => 'Eliminar puerta de enlace',
    'exchange_currency' => 'Cambio de divisas',
    'tax_amount1' => 'Importe fiscal 1',
    'tax_amount2' => 'Importe fiscal 2',
    'tax_amount3' => 'Importe fiscal 3',
    'update_project' => 'Actualizar proyecto',
    'auto_archive_invoice_cancelled' => 'Archivo automático de facturas canceladas',
    'auto_archive_invoice_cancelled_help' => 'Archivar facturas automáticamente cuando se cancelan',
    'no_invoices_found' => 'No se encontraron facturas',
    'created_record' => 'Registro creado con éxito',
    'auto_archive_paid_invoices' => 'Archivo automático pagado',
    'auto_archive_paid_invoices_help' => 'Archiva automáticamente las facturas cuando se pagan.',
    'auto_archive_cancelled_invoices' => 'Archivo automático cancelado',
    'auto_archive_cancelled_invoices_help' => 'Archiva automáticamente las facturas cuando se cancelan.',
    ...
    'download_report_description' => 'Consulte el archivo adjunto para verificar su informe.',
    'left' => 'Izquierda',
    'right' => 'Bien',
    'center' => 'Centro',
    ...
    'stop_on_unpaid' => 'Detener en no pagado',
    'stop_on_unpaid_help' => 'Deje de crear facturas recurrentes si la última factura no se ha pagado.',
    'use_quote_terms' => 'Usar términos de cotización',
    ...
    'enable_tooltips_help' => 'Mostrar información sobre herramientas al pasar el mouse',
    ...
    'activity_133' => ':user orden de compra eliminada :purchase_order',
    'activity_134' => ':user orden de compra restaurada :purchase_order',
    'activity_135' => ':user orden de compra enviada por correo electrónico :purchase_order',
    'activity_136' => ':contact orden de compra vista :purchase_order',
    'purchase_order_subject' => 'Nueva orden de compra :number de :account',
    'purchase_order_message' => 'Para ver su orden de compra de :amount, haga clic en el enlace a continuación.',
    'view_purchase_order' => 'Ver orden de compra',
    'purchase_orders_backup_subject' => 'Tus órdenes de compra están listas para descargar',
    'notification_purchase_order_viewed_subject' => 'Orden de compra :invoice fue visto por :client',
    'notification_purchase_order_viewed' => 'El siguiente proveedor :client vio la orden de compra :invoice para :amount.',
    'purchase_order_date' => 'Fecha de orden de compra',
    'purchase_orders' => 'Ordenes de compra',
    'purchase_order_number_placeholder' => 'Orden de compra n.º :purchase_order',
    'accepted' => 'Aceptado',
    'activity_137' => ':contact orden de compra aceptada :purchase_order',
    ...
    'notification_purchase_order_accepted' => 'El siguiente proveedor :vendor aceptó la orden de compra :purchase_order para :amount.',
    'amount_received' => 'Cantidad recibida',
    'purchase_order_already_expensed' => 'Ya convertido en un gasto.',
    'convert_to_expense' => 'Convertir a Gasto',
    ...
    'client_document_upload' => 'Carga de documentos del cliente',
    ...
    'marked_purchase_order_as_sent' => 'Pedido de compra marcado correctamente como enviado',
    'marked_purchase_orders_as_sent' => 'Órdenes de compra marcadas con éxito como enviadas',
    'accepted_purchase_order' => 'Pedido de compra aceptado con éxito',
    ...
    'email_purchase_order' => 'Orden de compra por correo electrónico',
    'bulk_email_purchase_order' => 'Orden de compra por correo electrónico',
    ...
    'emailed_purchase_order' => 'Orden de compra en cola exitosa para ser enviada',
    'emailed_purchase_orders' => 'Órdenes de compra en cola exitosas para ser enviadas',
    ...
    'purchase_order_footer' => 'Pie de página de orden de compra',
    ...
    'updated_purchase_order' => 'Orden de compra actualizada correctamente',
    'archived_purchase_order' => 'Pedido de compra archivado con éxito',
    ...
    'restore_task_status' => 'Restaurar estado de tarea',
    'lang_Hebrew' => 'hebreo',
    ...
    'activate' => 'Activar',
    'connect_apple' => 'Conecta Apple',
    'disconnect_apple' => 'desconectar manzana',
    'disconnected_apple' => 'Apple desconectó con éxito',
    'send_now' => 'Enviar ahora',
    'received' => 'Recibió',
    'converted_to_expense' => 'Convertido correctamente a gasto',
    'converted_to_expenses' => 'Convertido correctamente a gastos',
    ...
    'total_active_quotes' => 'Cotizaciones activas',
    'total_approved_quotes' => 'Cotizaciones aprobadas',
    'total_unapproved_quotes' => 'Cotizaciones no aprobadas',
    ...
    'invoice_item_tax_rates' => 'Tasas de impuestos de artículos de factura',
    ...
    'bulk_email_purchase_orders' => 'Órdenes de compra por correo electrónico',
    'bulk_email_invoices' => 'Facturas por correo electrónico',
    'bulk_email_quotes' => 'Cotizaciones por correo electrónico',
    'bulk_email_credits' => 'Créditos de correo electrónico',
    ...
    'connect' => 'Conectar',
    'mark_paid_payment_email' => 'Marcar correo electrónico de pago pagado',
    'convert_to_project' => 'Convertir a Proyecto',
    'client_email' => 'Correo electrónico del cliente',
    'invoice_task_project' => 'Proyecto de tarea de factura',
    'invoice_task_project_help' => 'Añadir el proyecto a las partidas de la factura',
    'bulk_action' => 'Acción masiva',
    'phone_validation_error' => 'Este número de teléfono móvil (celular) no es válido, ingrese en formato E.164',
    ...
    'preview_location' => 'Vista previa de la ubicación',
    'bottom' => 'Abajo',
    'side' => 'Lado',
    'pdf_preview' => 'Vista previa en PDF',
    'long_press_to_select' => 'Pulsación larga para seleccionar',
    'purchase_order_item' => 'Artículo de orden de compra',
    'would_you_rate_the_app' => '¿Te gustaría calificar la aplicación?',
    'include_deleted' => 'Incluir eliminado',
    'include_deleted_help' => 'Incluir registros eliminados en informes',
    'due_on' => 'Debido a',
    ...
    'convert_to_payment' => 'Convertir a pago',
    'deposit' => 'Depósito',
    'withdrawal' => 'Retiro',
    'deposits' => 'Depósitos',
    'withdrawals' => 'Retiros',
    ...
    'search_transactions' => 'Buscar transacciones :count',
    ...
    'code_was_sent_to' => 'Se ha enviado un código por SMS a :number',
    'verify_phone_number_2fa_help' => 'Verifique su número de teléfono para la copia de seguridad 2FA',
    'enable_applying_payments_later' => 'Habilitar la aplicación de pagos más tarde',
    ...
    'notification_quote_expired_subject' => 'La cotización :invoice ha expirado para :client',
    ...
    'client_statement_body' => 'Se adjunta su estado de cuenta del :start al :end .',
    ...
    'nordigen_handler_error_heading_eua_failure' => 'Fallo de la EUA',
    'nordigen_handler_error_contents_eua_failure' => 'Se produjo un error durante la creación del Acuerdo de usuario final:',
    ...
    'nordigen_requisition_body' => 'El acceso a los feeds de cuentas bancarias ha caducado según lo establecido en el Acuerdo de usuario final.<br><br> Inicie sesión en Red Invoice y vuelva a autenticarse con sus bancos para continuar recibiendo transacciones.',
    ...
    'paypal_advanced_cards' => 'Pagos con tarjeta por adelantado',
    'local_domain_help' => 'Dominio EHLO (opcional)',
    'port_help' => 'es decir 25.587.465',
    'host_help' => 'es decir, smtp.gmail.com',
    ...
    'currency_mauritanian_ouguiya' => 'Uguiya mauritana',
    'currency_bhutan_ngultrum' => 'Ngultrum de Bután',
    'end_of_month' => 'Fin de mes',
    'merge_e_invoice_to_pdf' => 'Fusionar factura electrónica y PDF',
    'task_assigned_subject' => 'Nueva tarea asignada [Tarea :task ] [ :date ]',
    ...
    'quote_reminder_subject' => 'Recordatorio: Cita :quote de :company',
    'quote_reminder_message' => 'Recordatorio de cotización :number para :amount',
    'quote_reminder1' => 'Recordatorio de la primera cita',
    'before_valid_until_date' => 'Antes de la fecha de validez',
    ...
    'edocument_import_already_exists' => 'La factura ya ha sido importada en :date',
    ...
    'added_comment' => 'Comentario guardado exitosamente',
    'tickets' => 'Entradas',
    ...
    'one_page_checkout_help' => 'Habilitar el nuevo flujo de pago de página única',
    'applies_to' => 'Se aplica a',
    'accept_purchase_order' => 'Aceptar orden de compra',
    'round_to_seconds' => 'Redondear a segundos',
    'activity_142' => 'Cita :quote recordatorio 1 enviado',
    ...
    'country_Ceuta' => 'Ceuta',
    'country_Canary Islands' => 'Canarias',
    ...
    'expense_mailbox' => 'Dirección de correo electrónico entrante',
    'expense_mailbox_help' => 'La dirección de correo electrónico entrante que acepta documentos de gastos, es decir, spend@invoice.theredsun.org',
    'expense_mailbox_active' => 'Buzón de gastos',
    'expense_mailbox_active_help' => 'Permite el procesamiento de documentos como recibos para informes de gastos.',
    'inbound_mailbox_allow_company_users' => 'Permitir remitentes de la empresa',
    'inbound_mailbox_allow_company_users_help' => 'Permite a los usuarios dentro de la empresa enviar documentos de gastos.',
    'inbound_mailbox_allow_vendors' => 'Permitir remitentes de proveedores',
    'inbound_mailbox_allow_vendors_help' => 'Permite a los proveedores de la empresa enviar documentos de gastos',
    'inbound_mailbox_allow_clients' => 'Permitir remitentes de clientes',
    'inbound_mailbox_allow_clients_help' => 'Permite a los clientes enviar documentos de gastos.',
    'inbound_mailbox_whitelist' => 'Lista de remitentes entrantes permitidos',
    'inbound_mailbox_whitelist_help' => 'Lista separada por comas de correos electrónicos a los que se les debe permitir enviar correos electrónicos para su procesamiento',
    'inbound_mailbox_blacklist' => 'Lista de remitentes entrantes prohibidos',
    'inbound_mailbox_blacklist_help' => 'Lista separada por comas de correos electrónicos a los que no se les permite enviar correos electrónicos para su procesamiento',
    'inbound_mailbox_allow_unknown' => 'Permitir todos los remitentes',
    'inbound_mailbox_allow_unknown_help' => 'Permitir que cualquier persona envíe un correo electrónico de gastos para su procesamiento',
    'quick_actions' => 'Acciones rápidas',
    'end_all_sessions_help' => 'Cierra la sesión de todos los usuarios y requiere que todos los usuarios activos se vuelvan a autenticar.',
    'updated_records' => 'Registros actualizados',
    'vat_not_registered' => 'Vendedor no registrado a efectos del IVA',
    'small_company_info' => 'No se informa del impuesto sobre las ventas de conformidad con el § 19 UStG',
    'peppol_onboarding' => 'Parece que es la primera vez que utilizas PEPPOL.',
    'get_started' => 'Empezar',
    'configure_peppol' => 'Configurar PEPPOL',
    'step' => 'Paso',
    'peppol_whitelabel_warning' => 'Se requiere una licencia de marca blanca para utilizar la facturación electrónica en la red PEPPOL.',
    ...
    'peppol_disconnect_short' => 'Desconectarse de PEPPOL.',
    'peppol_disconnect_long' => 'Su número de IVA se retirará de la red PEPPOL después de desconectarse. No podrá enviar ni recibir documentos electrónicos.',
    'log_duration_words' => 'Duración del registro de tiempo en palabras',
    'log_duration' => 'Duración del registro de tiempo',
    'merged_vendors' => 'Proveedores fusionados con éxito',
    ...
    'peppol_token_description' => 'El token se utiliza como un paso más para garantizar que las facturas se envíen de forma segura. A diferencia de las licencias de marca blanca, el token se puede rotar en cualquier momento sin necesidad de esperar al soporte de Red Invoice.',
    'peppol_token_warning' => 'Necesitas generar un token para continuar.',
    'generate_token' => 'Generar token',
    'total_credits_amount' => 'Cantidad de créditos',
    'sales_above_threshold' => 'Ventas por encima del umbral',
    'changing_vat_and_id_number_note' => 'No podrá cambiar su número de IVA ni su número de identificación una vez configurado PEPPOL.',
    'iban_help' => 'El número IBAN completo',
    'bic_swift' => 'Código BIC/Swift',
    'bic_swift_help' => 'El identificador del Banco',
    'payer_bank_account' => 'Número de cuenta bancaria del pagador',
    'payer_bank_account_help' => 'El número de cuenta bancaria del pagador',
    'bsb_sort' => 'BSB / Código de clasificación',
    'bsb_sort_help' => 'Código de sucursal bancaria',
    'card_type' => 'Tipo de tarjeta',
    'card_type_help' => 'es decir, VISA, AMEX',
    'card_number_help' => 'Sólo los últimos 4 dígitos',
    'card_holder' => 'Nombre del titular de la tarjeta',
    'tokenize' => 'Tokenizar',
    'tokenize_help' => 'Tokenizar el método de pago para uso futuro.',
    'credit_card_stripe_help' => 'Acepte pagos con tarjeta de crédito utilizando Stripe.',
    'bank_transfer_stripe_help' => 'Débito directo ACH. Pagos en USD. Verificación instantánea disponible.',
    'alipay_stripe_help' => 'Alipay permite a los usuarios en China pagar de forma segura utilizando sus billeteras móviles.',
    'sofort_stripe_help' => 'Sofort es un popular método de pago europeo que permite realizar transferencias bancarias en tiempo real, utilizado principalmente en Alemania y Austria.',
    'apple_pay_stripe_help' => 'Apple/Google Pay para usuarios con dispositivos Apple/Android, que utiliza información de tarjeta guardada para facilitar el pago.',
    'sepa_stripe_help' => 'Débito Directo SEPA (Zona Única de Pagos en Euros).',
    'bancontact_stripe_help' => 'Bancontact es un método de pago ampliamente utilizado en Bélgica.',
    'ideal_stripe_help' => 'iDEAL es el método de pago más popular en los Países Bajos.',
    'giropay_stripe_help' => 'Giropay es un método de pago alemán que facilita transferencias bancarias en línea seguras e inmediatas.',
    'przelewy24_stripe_help' => 'Przelewy24 es un método de pago común en Polonia.',
    'direct_debit_stripe_help' => 'Transferencias bancarias de Stripe mediante cuentas bancarias virtuales de Stripe, disponibles en Japón, Reino Unido, Estados Unidos, Europa y México. ¡Asegúrate de que esta opción esté habilitada en Stripe!',
    'eps_stripe_help' => 'EPS es un sistema de pago en línea austriaco.',
    'acss_stripe_help' => 'Débito directo ACSS (Sistema Automatizado de Compensación y Liquidación) para cuentas bancarias canadienses.',
    'becs_stripe_help' => 'Débito directo BECS para cuentas bancarias australianas.',
    'klarna_stripe_help' => 'Klarna compra ahora y paga después en cuotas o según un cronograma establecido.',
    'bacs_stripe_help' => 'Débito directo BACS para cuentas bancarias del Reino Unido, comúnmente utilizado para la facturación de suscripciones.',
    'fpx_stripe_help' => 'FPX es un método de pago en línea popular en Malasia.',
    'payment_means' => 'Medios de pago',
    'act_as_sender' => 'Enviar factura electrónica',
    'act_as_receiver' => 'Recibir factura electrónica',
    'saved_einvoice_details' => 'Configuración de factura electrónica guardada',
    'add_license_to_env' => 'Necesitaremos su clave de licencia para futuras comunicaciones con nuestros servicios. Asegúrese de utilizar LICENSE_KEY como variable de entorno.',
    'white_label_license_not_present' => 'No se encontró la licencia. Asegúrese de configurar LICENSE_KEY como variable de entorno.',
    'white_label_license_not_found' => 'Licencia de marca blanca no encontrada.',
    'details_update_info' => 'Actualizaremos los detalles de su empresa con la información proporcionada.',
    'sales_above_threshold' => 'Ventas por encima del umbral',
    'client_address_required' => 'Se requiere la dirección completa del cliente para la facturación electrónica',
    'connected' => 'Conectado',
    'email_count_quotes' => 'Envíe un correo electrónico :count citas',
    'activity_146' => 'Factura electrónica :invoice para :client ¡Entregada correctamente! :notes',
    'activity_147' => 'Factura electrónica :invoice por :client fallida en la entrega. :notes',
    'peppol_routing_problem' => 'Problema de enrutamiento. No se encontró destinatario/destino.',
    'peppol_sending_failed' => 'Problema técnico de entrega. No es posible volver a intentarlo',
    'peppol_cleared_for_sending' => 'Autorizado por la autoridad fiscal, enviando al destinatario',
    'account_holder' => 'Nombre de la cuenta',
    ...
    'additional_tax_identifiers_help' => 'Si está registrado a efectos del IVA en otras regiones, puede agregar sus números de IVA para esas regiones aquí.',
    'configure' => 'Configurar',
    'new_identifier' => 'Nuevo número de IVA',
    'notification_credits_low' => '¡Atención! Su saldo de crédito es bajo.',
    'notification_credits_low_text' => 'Por favor agregue créditos a su cuenta para evitar interrupción de servicios.',
    'notification_no_credits' => '¡Atención! Tu saldo de crédito está vacío.',
    'notification_no_credits_text' => 'Por favor agregue créditos a su cuenta para evitar interrupción de servicios.',
    'saved_comment' => 'Comentario guardado',
    'acts_as_must_be_true' => 'Se debe seleccionar “Enviar factura electrónica” o “Recibir factura electrónica” (o ambos).',
    'delete_identifier' => 'Eliminar identificador',
    'delete_identifier_description' => 'Si elimina este identificador, lo eliminará del sistema. Asegúrese de que esta sea la acción deseada antes de continuar.',
    'einvoice_something_went_wrong' => '¡Ups! Algo salió mal. Contáctanos a contact@invoice.theredsun.org para obtener más información.',
    'download_ready' => '¡Tu descarga ya está lista! [ :message ]',
    ...
    'use_system_fonts' => 'Utilice fuentes del sistema',
    'use_system_fonts_help' => 'Reemplace las fuentes estándar con las del navegador web',
    ...
    'enable_public_notifications_help' => 'Habilite las notificaciones en tiempo real de Red Invoice.',
    'navigate' => 'Navegar por',
    'calculate_taxes_warning' => 'Esta acción habilitará los impuestos de partidas individuales y deshabilitará los impuestos totales. ¡Todas las facturas abiertas se podrán volver a calcular con la nueva configuración!',
    'activity_149' => ':user envió un correo electrónico con el crédito :credit para :client a :contact',
    'email_history_empty' => 'No se encontró historial de correo electrónico, esta función solo está disponible cuando se envía con Postmark/Mailgun.',
    'e_invoicing' => 'Facturación electrónica',
    'einvoice_token_not_found' => 'No se encontró el token de facturación electrónica. Vaya a Configuración &gt; Factura electrónica y vuelva a generar el token.',
    'regenerate' => 'Regenerado',
    'subscription_unavailable' => 'Este artículo ya no está disponible',
    'currency_samoan_tala' => 'Tala samoana',
    'confirm_duplicate_gateway' => '¿Estás seguro de que deseas crear otra conexión?',
    'clients_limit' => 'Has alcanzado tu límite de clientes. Actualiza tu plan.',
    ...
    'pro_plan_feature_2' => 'Eliminar &quot;Creado por Red Invoice&quot;',
