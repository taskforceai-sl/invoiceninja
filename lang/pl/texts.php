...
"Płatne z góry za kwartał :QUARTER+1" >> "Płatne z góry za kwartał Q2"',
    ...
    'limit_clients' => 'Osiągnąłeś limit klientów :count na kontach bezpłatnych. Gratulujemy sukcesu!',
    ...
    'email_from' => 'Zespół The Red Invoice',
    ...
    'token' => 'Token',
    'add_gateway' => 'Dodaj bramkę płatności',
    'delete_gateway' => 'Usuń bramkę płatności',
    'edit_gateway' => 'Edytuj bramkę płatności',
    ...
    'app_title' => 'Bezpłatne fakturowanie online',
    'app_description' => 'Red Invoice to darmowe, otwarte rozwiązanie do fakturowania i rozliczania klientów. Dzięki Red Invoice możesz łatwo tworzyć i wysyłać atrakcyjne faktury z dowolnego urządzenia z dostępem do internetu. Twoi klienci mogą drukować faktury, pobierać je w formacie PDF, a nawet płacić Ci online z poziomu systemu.',
    'rows' => 'wierszy',
    'www' => 'www',
    'logo' => 'Logo',
    'subdomain' => 'Subdomena',
    ...
    'pro_plan_feature3' => 'Custom URLs - "YourBrand.Red Invoice.com"',
    'pro_plan_feature4' => 'Remove "Created by Red Invoice"',
    'pro_plan_feature5' => 'Multi-user Access & Activity Tracking',
    'pro_plan_feature6' => 'Tworzy oferty i faktury pro-forma',
    'pro_plan_feature7' => 'Customize Invoice Field Titles & Numbering',
    'pro_plan_feature8' => 'Możliwość dołączania plików PDF do wiadomości e-mail klientów',
    'resume' => 'Wznów',
    ...
    'notification_invoice_bounced' => 'Nie udało się dostarczyć faktury :invoice do :contact .<br><br> :error',
    'notification_invoice_bounced_subject' => 'Brak możliwości dostarczenia faktury :invoice',
    'notification_quote_bounced' => 'Nie udało się dostarczyć oferty :invoice do :contact .<br><br> :error',
    ...
    'activity_10' => ':user wprowadzono płatność :payment za :payment _kwota na fakturze :invoice za :client',
    ...
    'overdue' => 'Zaległość',
    'white_label_text' => 'Kup roczną licencję white label za $:price, aby usunąć wzmianki o Red Invoice z faktur i portalu klienta.',
    ...
    'pro_plan_remove_logo' => ':link to remove the Red Invoice logo by joining the Pro Plan',
    ...
    'invoice_embed_documents' => 'Osadź obrazy/dokumenty',
    'invoice_embed_documents_help' => 'Dołącz do faktury załączone obrazy/pliki PDF.',
    'document_email_attachment' => 'Dołącz dokumenty',
    'ubl_email_attachment' => 'Dołącz UBL',
    ...
    'pro_plan_year_description' => 'One year enrollment in the Red Invoice Pro Plan.',
    'pro_plan_month_description' => 'One month enrollment in the Red Invoice Pro Plan.',
    'enterprise_plan_product' => 'Plan Enterprise',
    'enterprise_plan_year_description' => 'One year enrollment in the Red Invoice Enterprise Plan.',
    'enterprise_plan_month_description' => 'One month enrollment in the Red Invoice Enterprise Plan.',
    ...
    'add_users_not_supported' => 'Przejdź na plan Enterprise, aby dodać do swojego konta więcej użytkowników.',
    ...
    'activity_40' => ':user zwrócono :adjustment z :payment _kwota płatności :payment',
    ...
    'plaid_environment_help' => 'Po podaniu klucza testowego Stripe zostanie użyte środowisko programistyczne Plaid (tartan).',
...
Gdy przelewy zostaną zaksięgowane na Twoim koncie, wróć do tej strony i kliknij "Dokończ weryfikację" obok właściwego konta.',
    ...
    'gocardless_webhook_help_link_text' => 'dodaj ten adres URL jako punkt końcowy w GoCardless',
    ...
    'upgrade_for_permissions' => 'Aby włączyć uprawnienia, przejdź na plan Enterprise.',
    ...
    'export_help' => 'Użyj formatu JSON, jeśli planujesz zaimportować dane do Red Invoice.<br/> Taki plik zawiera dane klientów, produkty, faktury, oferty i płatności.',
    ...
    'auto_bill_notification' => 'Ta faktura zostanie automatycznie wystawiona na Twój :payment _method zapisany w pliku :due_date .',
    ...
    'warn_change_auto_bill' => 'Ze względu na przepisy NACHA zmiany na tej fakturze mogą uniemożliwić automatyczne rozliczenie ACH.',
    ...
    'use_bank_on_file' => 'Użyj Bank on File',
    ...
    'wepay_account_description' => 'Dostawca płatności dla Red Invoice',
    ...
    'update_invoiceninja_title' => 'Zaktualizuj Red Invoice',
    'update_invoiceninja_warning' => 'Przed przejściem na nową wersję Red Invoice stwórz kopię bezpieczeństwa swojej bazy danych i plików.',
    'update_invoiceninja_available' => 'Nowa wersja Red Invoice jest dostępna.',
    'update_invoiceninja_unavailable' => 'Nowa wersja Red Invoice nie jest dostępna.',
    ...
    'pro_upgrade_feature1' => 'TwojaMarka.fakturowanie.co',
    ...
    'enterprise_upgrade_feature2' => 'Dołącz pliki stron trzecich do faktur i wydatków',
    ...
    'sign_here_ux_tip' => 'Użyj myszki lub touchpada, aby naszkicować swój podpis.',
    ...
    'credit_note' => 'Nota',
    'credit_issued_to' => 'Kredyt udzielony dla',
    'credit_to' => 'Kredyt dla',
    ...
    'bcc_email_help' => 'Dołączaj ten adres prywatnie do wiadomości e-mail klientów.',
    ...
    'white_label_license_error' => 'Nie udało się zweryfikować licencji, wygasła lub nastąpiła nadmierna aktywacja. Aby uzyskać więcej informacji, wyślij wiadomość e-mail na adres contact@invoice.theredsun.org.',
    ...
    'invoiceplane_import' => 'Użyj :link aby przenieść swoje dane z InvoicePlane.',
    ...
    'accepted_card_logos' => 'Akceptowane loga kart',
    ...
    'brevo_domain' => 'Domena Brevo',
    'brevo_private_key' => 'Klucz prywatny Brevo',
    'send_test_email' => 'Wyślij e-mail testowy',
    ...
    'deleted_recurring_expense' => 'Pomyślnie usunięto wydatek cykliczny',
    ...
    'next_credit_number' => 'Następny numer kredytu to :number .',
    'padding_help' => 'Liczba zer uzupełniających liczbę.',
    ...
    'invoices_are_attached' => 'Załączono faktury w formacie PDF.',
    ...
    'refund_body' => 'Zwrócono Ci kwotę :amount na podstawie faktury :invoice _number.',
    ...
    'currency_albanian_lek' => 'Albański Lek',
    'currency_serbian_dinar' => 'Dinar Serbski',
    'currency_lebanese_pound' => 'Funt libański',
    'currency_armenian_dram' => 'Dram ormiański',
    'currency_azerbaijan_manat' => 'Manat azerski',
    'currency_bosnia_and_herzegovina_convertible_mark' => 'Marka konwertywna Bośni i Hercegowiny',
    ...
    'currency_cambodian_riel' => 'Riel kambodżański',
    'currency_vanuatu_vatu' => 'Vanuatu Vatu',

    'currency_cuban_peso' => 'Kubańskie Peso',
    'currency_bz_dollar' => 'Dolar BZ',
    'currency_libyan_dinar' => 'Dinar libijski',
    'currency_silver_troy_ounce' => 'Uncja srebra trojańskiego',
    ...
    'currency' => 'Waluta',
    'ofx_help' => 'Aby rozwiązać problem, sprawdź komentarze dotyczące :ofxhome_link i przetestuj za pomocą :ofxget_link .',
    'comments' => 'Uwagi',

    'item_product' => 'Produkt przedmiotowy',
    'item_notes' => 'Notatki dotyczące przedmiotu',
    'item_cost' => 'Koszt przedmiotu',
    'item_quantity' => 'Ilość',
    'item_tax_rate' => 'Stawka podatku na pozycji',
    'item_tax_name' => 'Nazwa podatku na pozycji',
    'item_tax1' => 'Podatek od pozycji 1',
    'item_tax2' => 'Podatek od pozycji 2',
    ...
    'name_without_special_characters' => 'Proszę wpisać nazwę zawierającą tylko litery od a do z oraz spacje',
    'enable_alipay' => 'Akceptuj Alipay',
    'enable_sofort' => 'Akceptuj przelewy bankowe UE',
    'stripe_alipay_help' => 'Te bramy muszą zostać również aktywowane w :link .',
    'calendar' => 'Kalendarz',
    'pro_plan_calendar' => ':link , aby włączyć kalendarz poprzez dołączenie do planu Pro',
    ...
    'tasks_not_enabled' => 'Zadania nie są włączone.',
    'started_task' => 'Zadanie rozpoczęte pomyślnie',
    ...
    'time_tracker_mobile_help' => 'Kliknij dwukrotnie zadanie, aby je wybrać',
    'stopped' => 'Zatrzymany',
    'ascending' => 'Rosnąco',
    'descending' => 'Malejąco',
    ...
    'time_hrs' => 'godz',
    'clear' => 'Wyczyść',
    'warn_payment_gateway' => 'Uwaga: aby akceptować płatności online, potrzebna jest bramka płatnicza :link .',
    'task_rate' => 'Stawka zadania',
    'task_rate_help' => 'Ustaw domyślną stawkę dla zafakturowanych zadań.',
    'past_due' => 'Po terminie',
    'document' => 'Dokument',
    'invoice_or_expense' => 'Faktura/Wydatek',
    'invoice_pdfs' => 'Faktury w formacie PDF',
    'enable_sepa' => 'Akceptuj SEPA',
    ...
    'recover' => 'Odzyskaj',
    'apply' => 'Zastosuj',
    'recover_white_label_header' => 'Odzyskaj licencję White Label',
    ...
    'task_fields' => 'Pola zadań',
    'product_fields_help' => 'Przeciągnij i upuść pola, aby zmienić ich kolejność',
    'custom_value1' => 'Wartość niestandardowa 1',
    'custom_value2' => 'Wartość niestandardowa 2',
    'enable_two_factor' => 'Uwierzytelnianie dwuskładnikowe',
    'enable_two_factor_help' => 'Użyj telefonu, aby potwierdzić swoją tożsamość podczas logowania',
    'two_factor_setup' => 'Konfiguracja dwuskładnikowa',
    'two_factor_setup_help' => 'Zeskanuj kod kreskowy za pomocą aplikacji zgodnej z :link .',
    'one_time_password' => 'Hasło jednorazowe',
    'set_phone_for_two_factor' => 'Ustaw swój numer telefonu komórkowego jako zapasowy, aby włączyć tę funkcję.',
    'enabled_two_factor' => 'Pomyślnie włączono uwierzytelnianie dwuskładnikowe',
    'add_product' => 'Dodaj produkt',
    'email_will_be_sent_on' => 'Uwaga: wiadomość e-mail zostanie wysłana na :date .',
    'invoice_product' => 'Produkt fakturowy',
    'self_host_login' => 'Logowanie do samodzielnego hostingu',
    'set_self_hoat_url' => 'Adres URL do samodzielnego hostowania',
    'local_storage_required' => 'Błąd: pamięć lokalna jest niedostępna.',
    'your_password_reset_link' => 'Twój link do resetowania hasła',
    'subdomain_taken' => 'Subdomena jest już w użyciu',
    'expense_mailbox_taken' => 'Skrzynka pocztowa przychodząca jest już używana',
    'expense_mailbox_invalid' => 'Skrzynka pocztowa przychodząca nie jest zgodna z wymaganym schematem',
    'client_login' => 'Logowanie klienta',
    'converted_amount' => 'Kwota przeliczona',
    'default' => 'Domyślny',
    'shipping_address' => 'Adres dostawy',
    'bllling_address' => 'Adres rozliczeniowy',
    'billing_address1' => 'Ulica Billing',
    'billing_address2' => 'Apartament/Apartament rozliczeniowy',
    'billing_city' => 'Miasto rozliczeniowe',
    'billing_state' => 'Stan/prowincja rozliczeniowa',
    'billing_postal_code' => 'Kod pocztowy rozliczeniowy',
    ...
    'ship_to_billing_address' => 'Wyślij na adres rozliczeniowy',
    'delivery_note' => 'Dowód dostawy',
    'show_tasks_in_portal' => 'Pokaż zadania w portalu klienta',
    'cancel_schedule' => 'Anuluj harmonogram',
    'scheduled_report' => 'Zaplanowany raport',
    'scheduled_report_help' => 'Wyślij raport :report jako :format na adres :email',
    'created_scheduled_report' => 'Pomyślnie zaplanowano raport',
    'deleted_scheduled_report' => 'Pomyślnie anulowano zaplanowany raport',
    'scheduled_report_attached' => 'Załączono zaplanowany raport :type .',
    'scheduled_report_error' => 'Nie udało się utworzyć raportu harmonogramu',
    'invalid_one_time_password' => 'Nieprawidłowe hasło jednorazowe',
    'apple_pay' => 'Apple/Google Pay',
    'enable_apple_pay' => 'Akceptuj Apple Pay i Płać z Google',
    'requires_subdomain' => 'Ten rodzaj płatności wymaga :link .',
    'subdomain_is_set' => 'subdomena jest ustawiona',
    'verification_file' => 'Plik weryfikacyjny',
    'verification_file_missing' => 'Plik weryfikacyjny jest potrzebny do akceptowania płatności.',
    'apple_pay_domain' => 'Użyj <code>:domain</code> jako domeny w :link .',
    'apple_pay_not_supported' => 'Przepraszamy, Twoja przeglądarka nie obsługuje usługi Apple/Google Pay',
    'optional_payment_methods' => 'Dodatkowe metody płatności',
    'add_subscription' => 'Dodaj subskrypcję',
    'target_url' => 'Cel',
    'target_url_help' => 'Gdy wybrane zdarzenie nastąpi, aplikacja opublikuje jednostkę pod docelowym adresem URL.',
    'event' => 'Wydarzenie',
    ...
    'updated_subscription' => 'Pomyślnie zaktualizowano subskrypcję',
    'created_subscription' => 'Pomyślnie utworzono subskrypcję',
    'edit_subscription' => 'Edytuj subskrypcję',
    'archive_subscription' => 'Subskrypcja archiwum',
    'archived_subscription' => 'Pomyślnie zarchiwizowano subskrypcję',
    'project_error_multiple_clients' => 'Projekty nie mogą należeć do różnych klientów',
    'invoice_project' => 'Projekt faktury',
    'module_recurring_invoice' => 'Faktury cykliczne',
    'module_credit' => 'Środki na koncie',
    'module_quote' => 'Oferty i propozycje',
    'module_task' => 'Zadania i projekty',
    'module_expense' => 'Wydatki i dostawcy',
    'module_ticket' => 'Bilety',
    'reminders' => 'Przypomnienia',
    'send_client_reminders' => 'Wyślij przypomnienie mailowe',
    'can_view_tasks' => 'Zadania są widoczne w portalu',
    'is_not_sent_reminders' => 'Przypomnienia nie są wysyłane',
    'promotion_footer' => 'Twoja promocja wkrótce wygaśnie, :link aby dokonać aktualizacji już teraz.',
    'unable_to_delete_primary' => 'Uwaga: aby usunąć tę firmę, najpierw usuń wszystkie powiązane z nią firmy.',
    ...
    'edit_times' => 'Edytuj czasy',
    'inclusive_taxes_help' => 'Wlicz <b>podatki w koszt</b>',
    'inclusive_taxes_notice' => 'Po utworzeniu faktury tego ustawienia nie można zmienić.',
    'inclusive_taxes_warning' => 'Ostrzeżenie: istniejące faktury będą musiały zostać ponownie zapisane',
    'copy_shipping' => 'Kopiuj dostawę',
    'copy_billing' => 'Kopia faktury',
    'quote_has_expired' => 'Oferta wygasła, skontaktuj się ze sprzedawcą.',
    ...
    'kanban' => 'Kanban',
    'backlog' => 'Zaległości',
    'ready_to_do' => 'Gotowy do zrobienia',
    'in_progress' => 'W trakcie',
    'add_status' => 'Dodaj status',
    'archive_status' => 'Status archiwum',
    'new_status' => 'Nowy status',
    'convert_products' => 'Konwertuj produkty',
    'convert_products_help' => 'Automatycznie zamieniaj ceny produktu na walutę klienta',
    'improve_client_portal_link' => 'Ustaw subdomenę, aby skrócić łącze do portalu klienta.',
    'budgeted_hours' => 'Zaplanowane godziny',
    'progress' => 'Postęp',
    'view_project' => 'Zobacz projekt',
    'summary' => 'Podsumowanie',
    'endless_reminder' => 'Niekończące się przypomnienie',
    'signature_on_invoice_help' => 'Dodaj poniższy kod, aby wyświetlić podpis klienta w pliku PDF.',
    'signature_on_pdf' => 'Pokaż w PDF',
    'signature_on_pdf_help' => 'Pokaż podpis klienta na fakturze/ofercie PDF.',
    'expired_white_label' => 'Licencja białej etykiety wygasła',
    'return_to_login' => 'Powrót do logowania',
    'convert_products_tip' => 'Uwaga: dodaj :link o nazwie „ :name ”, aby zobaczyć kurs wymiany.',
    'amount_greater_than_balance' => 'Kwota jest większa niż saldo faktury, w takim przypadku zostanie utworzona karta kredytowa na pozostałą kwotę.',
    'custom_fields_tip' => 'Użyj <code>Label|Option1,Option2</code> aby wyświetlić pole wyboru.',
    'client_information' => 'Informacje o kliencie',
    'updated_client_details' => 'Pomyślnie zaktualizowano dane klienta',
    'auto' => 'Automatyczny',
    ...
    'deleted_proposal' => 'Pomyślnie zarchiwizowano propozycję',
    'archived_proposals' => 'Pomyślnie zarchiwizowano propozycje :count',
    'deleted_proposals' => 'Pomyślnie zarchiwizowano propozycje :count',
    'restored_proposal' => 'Propozycja została przywrócona',
    'restore_proposal' => 'Przywróć propozycję',
    'snippet' => 'Skrawek',
    'snippets' => 'Fragmenty',
    'proposal_snippet' => 'Skrawek',
    'proposal_snippets' => 'Fragmenty',
    'new_proposal_snippet' => 'Nowy fragment kodu',
    'edit_proposal_snippet' => 'Edytuj fragment kodu',
    'archive_proposal_snippet' => 'Fragment archiwum',
    'delete_proposal_snippet' => 'Usuń fragment kodu',
    'created_proposal_snippet' => 'Pomyślnie utworzono fragment kodu',
    'updated_proposal_snippet' => 'Pomyślnie zaktualizowano fragment kodu',
    'archived_proposal_snippet' => 'Pomyślnie zarchiwizowano fragment kodu',
    'deleted_proposal_snippet' => 'Pomyślnie zarchiwizowano fragment kodu',
    'archived_proposal_snippets' => 'Pomyślnie zarchiwizowano fragmenty kodu :count',
    'deleted_proposal_snippets' => 'Pomyślnie zarchiwizowano fragmenty kodu :count',
    'restored_proposal_snippet' => 'Pomyślnie przywrócono fragment kodu',
    'restore_proposal_snippet' => 'Przywróć fragment kodu',
    'template' => 'Szablon',
    'templates' => 'Szablony',
    ...
    'deleted_proposal_category' => 'Pomyślnie zarchiwizowano kategorię',
    'archived_proposal_categories' => 'Pomyślnie zarchiwizowano kategorie :count',
    'deleted_proposal_categories' => 'Pomyślnie zarchiwizowano kategorie :count',
    'restored_proposal_category' => 'Pomyślnie przywrócono kategorię',
    'restore_proposal_category' => 'Przywróć kategorię',
    'delete_status' => 'Usuń status',
    'standard' => 'Standard',
    'icon' => 'Ikona',
    'proposal_not_found' => 'Żądana propozycja nie jest dostępna',
    'create_proposal_category' => 'Utwórz kategorię',
    'clone_proposal_template' => 'Klonuj szablon',
    'proposal_email' => 'Email propozycji',
    'proposal_subject' => 'Nowa propozycja :number od :account',
    'proposal_message' => 'Aby wyświetlić propozycję dla :amount , kliknij poniższy link.',
    'emailed_proposal' => 'Pomyślnie wysłano propozycję e-mailem',
    'load_template' => 'Załaduj szablon',
    'no_assets' => 'Brak obrazów, przeciągnij, aby przesłać',
    'add_image' => 'Dodaj obraz',
    'select_image' => 'Wybierz obraz',
    'upgrade_to_upload_images' => 'Przejdź na plan Enterprise, aby przesyłać pliki i obrazy',
    'delete_image' => 'Usuń obraz',
    'delete_image_help' => 'Ostrzeżenie: usunięcie obrazu spowoduje jego usunięcie ze wszystkich propozycji.',
    'amount_variable_help' => 'Uwaga: pole $amount faktury będzie używać pola partial/deposit, w przeciwnym razie używane będzie saldo faktury.',
    'taxes_are_included_help' => 'Uwaga: włączono podatki wliczone w cenę.',
    'taxes_are_not_included_help' => 'Uwaga: Podatki wliczone w cenę nie są dostępne.',
    'change_requires_purge' => 'Zmiana tego ustawienia wymaga :link danych konta.',
    'purging' => 'biegunka',
    'warning_local_refund' => 'Zwrot zostanie zarejestrowany w aplikacji, ale NIE zostanie przetworzony przez bramkę płatniczą.',
    'email_address_changed' => 'Adres e-mail został zmieniony',
    'email_address_changed_message' => 'Adres e-mail Twojego konta został zmieniony z :old_email na :new_email .',
    'test' => 'Test',
    'beta' => 'Beta',
    ...
    'reactivated_email' => 'Adres e-mail został ponownie aktywowany',
    'emails' => 'E-maile',
    'opened' => 'Otwarto',
    'bounced' => 'Odbił się',
    'total_sent' => 'Łącznie wysłano',
    'total_opened' => 'Łącznie otwartych',
    'total_bounced' => 'Całkowita liczba odrzuceń',
    'total_spam' => 'Całkowity spam',
    'platforms' => 'Platformy',
    'email_clients' => 'Klienci poczty e-mail',
    ...
    'subgroup' => 'Podgrupa',
    'unset' => 'Nieoprawny',
    'received_new_payment' => 'Otrzymałeś nową płatność!',
    'slack_webhook_help' => 'Otrzymuj powiadomienia o płatnościach za pomocą :link .',
    'slack_incoming_webhooks' => 'Przychodzące webhooki Slacka',
    'accept' => 'Przyjąć',
    'accepted_terms' => 'Pomyślnie zaakceptowano najnowsze warunki usługi',
    'invalid_url' => 'Nieprawidłowy URL',
    'workflow_settings' => 'Ustawienia przepływu pracy',
    'auto_email_invoice' => 'Automatyczny e-mail',
    'auto_email_invoice_help' => 'Automatycznie wysyłaj e-mailem faktury cykliczne po ich utworzeniu.',
    'auto_archive_invoice' => 'Archiwum automatyczne',
    'auto_archive_invoice_help' => 'Automatycznie archiwizuj faktury po ich opłaceniu.',
    'auto_archive_quote' => 'Archiwum automatyczne',
    'auto_archive_quote_help' => 'Automatycznie archiwizuj oferty po przekształceniu ich w fakturę.',
    'require_approve_quote' => 'Wymagaj zatwierdzenia oferty',
    'require_approve_quote_help' => 'Wymagaj od klientów akceptacji ofert.',
    'allow_approve_expired_quote' => 'Zezwól na zatwierdzenie wygasłej oferty',
    'allow_approve_expired_quote_help' => 'Zezwól klientom na zatwierdzanie wygasłych ofert.',
    'invoice_workflow' => 'Przepływ pracy faktur',
    'quote_workflow' => 'Przepływ pracy z wyceną',
    'client_must_be_active' => 'Błąd: klient musi być aktywny',
    'purge_client' => 'Wyczyść klienta',
    'purged_client' => 'Pomyślnie oczyszczono klienta',
    'purge_client_warning' => 'Wszystkie powiązane rekordy (faktury, zadania, wydatki, dokumenty itp.) również zostaną usunięte.',
    'clone_product' => 'Powiel produkt',
    'item_details' => 'Szczegóły przedmiotu',
    'send_item_details_help' => 'Wyślij szczegóły pozycji zamówienia do bramki płatności.',
    'view_proposal' => 'Zobacz propozycję',
    'view_in_portal' => 'Zobacz w portalu',
    'cookie_message' => 'Ta strona korzysta z plików cookie w celu zapewnienia najlepszej jakości korzystania z witryny.',
    'got_it' => 'Zrozumiałem!',
    'vendor_will_create' => 'zostanie utworzony dostawca',
    'vendors_will_create' => 'zostaną stworzeni dostawcy',
    'created_vendors' => 'Pomyślnie utworzono dostawców :count',
    'import_vendors' => 'Importuj dostawców',
    'company' => 'Firma',
    'client_field' => 'Pole klienta',
    'contact_field' => 'Pole kontaktowe',
    'product_field' => 'Pole produktu',
    'task_field' => 'Pole zadania',
    'project_field' => 'Pole projektu',
    'expense_field' => 'Pole wydatków',
    'vendor_field' => 'Pole dostawcy',
    'company_field' => 'Pole firmy',
    'invoice_field' => 'Pole faktury',
    'invoice_surcharge' => 'Dopłata do faktury',
    'custom_task_fields_help' => 'Dodaj pole podczas tworzenia zadania.',
    'custom_project_fields_help' => 'Dodaj pole podczas tworzenia projektu.',
    'custom_expense_fields_help' => 'Dodaj pole podczas tworzenia wydatku.',
    'custom_vendor_fields_help' => 'Dodaj pole podczas tworzenia dostawcy.',
    'messages' => 'Wiadomości',
    'unpaid_invoice' => 'Niezapłacona faktura',
    'paid_invoice' => 'Faktura zapłacona',
    'unapproved_quote' => 'Niezatwierdzona wycena',
    'unapproved_proposal' => 'Niezatwierdzona propozycja',
    'autofills_city_state' => 'Automatycznie wypełnia miasto/stan',
    'no_match_found' => 'Nie znaleziono dopasowania',
    'password_strength' => 'Siła hasła',
    'strength_weak' => 'Słabe',
    'strength_good' => 'Dobre',
    'strength_strong' => 'Silne',
    'mark' => 'Ocena',
    'updated_task_status' => 'Pomyślnie zaktualizowano status zadania',
    'background_image' => 'Obraz tła',
    'background_image_help' => 'Do zarządzania obrazami użyj :link ; zalecamy użycie małego pliku.',
    'proposal_editor' => 'redaktor propozycji',
    'background' => 'Tło',
    'guide' => 'Przewodnik',
    'gateway_fee_item' => 'Opłata za bramkę',
    'gateway_fee_description' => 'Dopłata za opłatę za bramkę',
    'gateway_fee_discount_description' => 'Zniżka za opłatę za bramkę',
    ...
    'items' => 'Rzeczy',
    'partial_deposit' => 'Częściowo/Depozyt',
    ...
    'please_enter_a_quote_number' => 'Proszę podać numer oferty',
    ...
    'marked_invoice_as_sent' => 'Pomyślnie oznaczono fakturę jako wysłaną',
    'please_enter_a_client_or_contact_name' => 'Proszę wpisać nazwę klienta lub osoby kontaktowej',
    ...
    'edit_recurring_quote' => 'Edytuj powtarzający się cytat',
    ...
    'refunded' => 'Zwrócone',
    'marked_quote_as_sent' => 'Pomyślnie oznaczono ofertę jako wysłaną',
    ...
    'comment' => 'Komentarz',
    'tags' => 'Tagi',
    'linked_objects' => 'Połączone obiekty',
    'low' => 'Niski',
    'medium' => 'Średni',
    'high' => 'Wysoki',
    ...
    'local_part_help' => 'Dostosuj lokalną część przychodzącej wiadomości e-mail z pomocą techniczną, np. YOUR_NAME@support.invoice.theredsun.org',
    ...
    'enable_client_upload_help' => 'Zezwól klientom na przesyłanie dokumentów/załączników',
    ...
    'ticket_number_start_help' => 'Numer biletu musi być większy niż aktualny numer biletu',
    'new_ticket_template_id' => 'Nowy bilet',
    'new_ticket_autoresponder_help' => 'Wybranie szablonu spowoduje wysłanie automatycznej odpowiedzi do klienta/kontaktu po utworzeniu nowego zgłoszenia',
    'update_ticket_template_id' => 'Zaktualizowany bilet',
    'update_ticket_autoresponder_help' => 'Wybranie szablonu spowoduje wysłanie automatycznej odpowiedzi do klienta/kontaktu po zaktualizowaniu zgłoszenia',
    'close_ticket_template_id' => 'Zamknięte zgłoszenie',
    'close_ticket_autoresponder_help' => 'Wybranie szablonu spowoduje wysłanie automatycznej odpowiedzi do klienta/kontaktu po zamknięciu zgłoszenia',
    ...
    'default_agent_help' => 'Jeśli zaznaczono, opcja zostanie automatycznie przypisana do wszystkich biletów przychodzących',
    ...
    'enter_ticket_message' => 'Proszę wpisać wiadomość, aby zaktualizować zgłoszenie',
    ...
    'compare' => 'Porównaj',
    'hosted_login' => 'Logowanie hostowane',
    'selfhost_login' => 'Logowanie do Selfhost',
    'google_login' => 'Logowanie Google',
    'thanks_for_patience' => 'Dziękujemy za cierpliwość podczas prac nad wprowadzeniem tych funkcji.<br><br> Mamy nadzieję, że uda nam się je ukończyć w ciągu najbliższych kilku miesięcy.<br><br> Do tego czasu będziemy nadal wspierać',
    ...
    'custom_js' => 'Własny JS',
    'adjust_fee_percent_help' => 'Dostosuj procent, aby uwzględnić opłatę',
    'show_product_notes' => 'Pokaż szczegóły produktu',
    'show_product_notes_help' => 'Wpisz <b>opis i cenę</b> w rozwijanej liście produktów',
    'important' => 'Ważne',
    ...
    'auto_start_tasks' => 'Zadania automatycznego uruchamiania',
    ...
    'valid_until_days_help' => 'Automatycznie ustawia wartość <b>„Ważny do</b> ” w cudzysłowach na określoną liczbę dni w przyszłości. Pozostaw puste, aby wyłączyć.',
    'usually_pays_in_days' => 'Dni',
    'requires_an_enterprise_plan' => 'Wymaga planu Enterprise',
    ...
    'email_login' => 'Logowanie do poczty e-mail',
    ...
    'attach_ubl' => 'Dołącz UBL/E-fakturę',
    ...
    'upload_logo' => 'Prześlij logo swojej firmy',
    'uploaded_logo' => 'Pomyślnie przesłano logo',
    'saved_settings' => 'Ustawienia zostały pomyślnie zapisane',
    'device_settings' => 'Ustawienia urządzenia',
    'credit_cards_and_banks' => 'Karty kredytowe i banki',
    'price' => 'Cena',
    'email_sign_up' => 'Zarejestruj się na e-mail',
    'google_sign_up' => 'Rejestracja w Google',
    'sign_up_with_google' => 'Zarejestruj się za pomocą Google',
    'long_press_multiselect' => 'Długie naciśnięcie przycisku wielokrotnego wyboru',
    'migrate_to_next_version' => 'Migracja do następnej wersji Red Invoice',
    'migrate_intro_text' => 'Pracujemy nad kolejną wersją Red Invoice. Kliknij przycisk poniżej, aby rozpocząć migrację.',
    'start_the_migration' => 'Rozpocznij migrację',
    'migration' => 'Migracja',
    'welcome_to_the_new_version' => 'Witamy w nowej wersji Red Invoice',
    'next_step_data_download' => 'W następnym kroku umożliwimy Ci pobranie danych w celu migracji.',
    'download_data' => 'Aby pobrać dane, naciśnij przycisk poniżej.',
    'continue' => 'Kontynuuj',
    'company1' => 'Firma niestandardowa 1',
    'company2' => 'Firma niestandardowa 2',
    'company3' => 'Firma niestandardowa 3',
    'company4' => 'Firma niestandardowa 4',
    'product1' => 'Produkt niestandardowy 1',
    'product2' => 'Produkt niestandardowy 2',
    'product3' => 'Produkt niestandardowy 3',
    'product4' => 'Produkt niestandardowy 4',
    'client1' => 'Klient niestandardowy 1',
    'client2' => 'Klient niestandardowy 2',
    'client3' => 'Klient niestandardowy 3',
    'client4' => 'Klient niestandardowy 4',
    ...
    'task1' => 'Zadanie niestandardowe 1',
    'task2' => 'Zadanie niestandardowe 2',
    'task3' => 'Zadanie niestandardowe 3',
    'task4' => 'Zadanie niestandardowe 4',
    'project1' => 'Projekt niestandardowy 1',
    'project2' => 'Projekt niestandardowy 2',
    'project3' => 'Projekt niestandardowy 3',
    'project4' => 'Projekt niestandardowy 4',
    'expense1' => 'Wydatek niestandardowy 1',
    'expense2' => 'Wydatek niestandardowy 2',
    'expense3' => 'Wydatki niestandardowe 3',
    'expense4' => 'Wydatki niestandardowe 4',
    'vendor1' => 'Dostawca niestandardowy 1',
    'vendor2' => 'Dostawca niestandardowy 2',
    'vendor3' => 'Dostawca niestandardowy 3',
    'vendor4' => 'Dostawca niestandardowy 4',
    'invoice1' => 'Faktura niestandardowa 1',
    'invoice2' => 'Faktura niestandardowa 2',
    'invoice3' => 'Faktura niestandardowa 3',
    'invoice4' => 'Faktura niestandardowa 4',
    'payment1' => 'Płatność niestandardowa 1',
    'payment2' => 'Płatność niestandardowa 2',
    'payment3' => 'Płatność niestandardowa 3',
    'payment4' => 'Płatność niestandardowa 4',
    'surcharge1' => 'Dopłata niestandardowa 1',
    'surcharge2' => 'Dopłata niestandardowa 2',
    'surcharge3' => 'Dopłata niestandardowa 3',
    'surcharge4' => 'Dopłata niestandardowa 4',
    ...
    'count' => 'Ilość',
    'is_active' => 'Aktywny',
    'contact_last_login' => 'Kontakt Ostatnie logowanie',
    ...
    'assigned_to_id' => 'Przypisano do identyfikatora',
    'created_by_id' => 'Utworzone przez Id',
    'add_column' => 'Dodaj kolumnę',
    'edit_columns' => 'Edytuj kolumnę',
    'to_learn_about_gogle_fonts' => 'aby dowiedzieć się więcej o czcionkach Google',
    'refund_date' => 'Data zwrotu',
    'multiselect' => 'Zaznaczanie wielu',
    'verify_password' => 'Zweryfikuj hasło',
    'applied' => 'Zastosowany',
    'include_recent_errors' => 'Uwzględnij ostatnie błędy z dzienników',
    'your_message_has_been_received' => 'Otrzymaliśmy Twoją wiadomość i postaramy się odpowiedzieć niezwłocznie.',
    'show_product_details' => 'Pokaż szczegóły produktu',
    'show_product_details_help' => 'Wpisz opis i cenę w rozwijanej liście produktów',
    'pdf_min_requirements' => 'Renderer PDF wymaga :version',
    'adjust_fee_percent' => 'Dostosuj procent opłaty',
    'configure_settings' => 'Konfiguruj ustawienia',
    'about' => 'O',
    'credit_email' => 'E-mail kredytowy',
    'domain_url' => 'Adres URL domeny',
    'password_is_too_easy' => 'Hasło musi zawierać wielką literę i cyfrę',
    'client_portal_tasks' => 'Zadania portalu klienta',
    ...
    'layout' => 'Układ',
    'module' => 'Moduł',
    'first_custom' => 'Pierwszy niestandardowy',
    'second_custom' => 'Drugi zwyczaj',
    'third_custom' => 'Trzeci zwyczaj',
    'show_cost' => 'Pokaż koszt',
    'show_cost_help' => 'Wyświetl pole kosztu produktu, aby śledzić marżę/zysk',
    'show_product_quantity' => 'Pokaż ilość produktów',
    'show_product_quantity_help' => 'Wyświetl pole ilości produktu, w przeciwnym razie domyślnie wyświetlana jest jedna ilość',
    'show_invoice_quantity' => 'Pokaż ilość faktury',
    'show_invoice_quantity_help' => 'Wyświetl pole ilości pozycji wiersza, w przeciwnym razie domyślnie wyświetl jedną',
    'default_quantity' => 'Domyślna ilość',
    'default_quantity_help' => 'Automatycznie ustaw ilość pozycji zamówienia na jedną',
    ...
    'invoice_tax' => 'Podatek od faktury',
    'line_item_tax' => 'Podatek od pozycji zamówienia',
    'inclusive_taxes' => 'Podatki wliczone',
    'invoice_tax_rates' => 'Stawki podatku od faktur',
    'item_tax_rates' => 'Stawki podatku od pozycji',
    ...
    'marked_invoice_as_paid' => 'Pomyślnie oznaczono fakturę jako opłaconą',
    'marked_invoices_as_sent' => 'Pomyślnie oznaczono faktury jako wysłane',
    'marked_invoices_as_paid' => 'Pomyślnie oznaczono faktury jako opłacone',
    'activity_57' => 'System nie mógł wysłać faktury e-mailem :invoice',
    'custom_value3' => 'Wartość niestandardowa 3',
    'custom_value4' => 'Wartość niestandardowa 4',
    'email_style_custom' => 'Niestandardowy styl wiadomości e-mail',
    'custom_message_dashboard' => 'Niestandardowa wiadomość na pulpicie nawigacyjnym',
    'custom_message_unpaid_invoice' => 'Niestandardowy komunikat o niezapłaconej fakturze',
    'custom_message_paid_invoice' => 'Niestandardowa wiadomość o zapłaconej fakturze',
    'custom_message_unapproved_quote' => 'Niestandardowa wiadomość o niezatwierdzonej wycenie',
    'lock_sent_invoices' => 'Blokada edycji wysłanych faktur',
    'translations' => 'Tłumaczenia',
    'task_number_pattern' => 'Wzór numeru zadania',
    'task_number_counter' => 'Licznik numerów zadań',
    'expense_number_pattern' => 'Wzór numeru wydatku',
    'expense_number_counter' => 'Licznik wydatków',
    'vendor_number_pattern' => 'Wzór numeru dostawcy',
    'vendor_number_counter' => 'Licznik numerów dostawców',
    'ticket_number_pattern' => 'Wzór numeru biletu',
    'ticket_number_counter' => 'Licznik numerów biletów',
    'payment_number_pattern' => 'Wzór numeru płatności',
    'payment_number_counter' => 'Licznik numerów płatności',
    'invoice_number_pattern' => 'Wzór numeru faktury',
    'quote_number_pattern' => 'Wzór numeru cytatu',
    'client_number_pattern' => 'Wzór numeru kredytowego',
    'client_number_counter' => 'Licznik numerów kredytowych',
    'credit_number_pattern' => 'Wzór numeru kredytowego',
    'credit_number_counter' => 'Licznik numerów kredytowych',
    'reset_counter_date' => 'Resetuj datę licznika',
    'counter_padding' => 'Wyściółka licznika',
    'shared_invoice_quote_counter' => 'Udostępnij licznik faktur/ofert',
    'default_tax_name_1' => 'Domyślna nazwa podatku 1',
    'default_tax_rate_1' => 'Domyślna stawka podatku 1',
    'default_tax_name_2' => 'Domyślna nazwa podatku 2',
    'default_tax_rate_2' => 'Domyślna stawka podatku 2',
    'default_tax_name_3' => 'Domyślna nazwa podatku 3',
    'default_tax_rate_3' => 'Domyślna stawka podatku 3',
    ...
    'switch_list_table' => 'Tabela listy przełączników',
    ...
    'client_address2' => 'Apartament/apartament klienta',
    'client_shipping_address1' => 'Klienta Ulica Dostawy',
    'client_shipping_address2' => 'Klienta numer budynku dostawy',
    'tax_rate1' => 'Stawka podatku 1',
    'tax_rate2' => 'Stawka podatku 2',
    'tax_rate3' => 'Stawka podatku 3',
    'archived_at' => 'Zarchiwizowano w',
    'has_expenses' => 'Ma wydatki',
    'custom_taxes1' => 'Podatki celne 1',
    'custom_taxes2' => 'Podatki celne 2',
    'custom_taxes3' => 'Podatki celne 3',
    'custom_taxes4' => 'Podatki celne 4',
    'custom_surcharge1' => 'Dopłata niestandardowa 1',
    'custom_surcharge2' => 'Dopłata niestandardowa 2',
    'custom_surcharge3' => 'Dopłata niestandardowa 3',
    'custom_surcharge4' => 'Dopłata niestandardowa 4',
    'is_deleted' => 'Usunięto',
    'vendor_city' => 'Miasto Dostawcy',
    'vendor_state' => 'Województwo Dostawcy',
    'vendor_country' => 'Kraj Dostawcy',
    'credit_footer' => 'Stopka kredytowa',
    'credit_terms' => 'Warunki kredytowe',
    'untitled_company' => 'Firma bez tytułu',
    'added_company' => 'Pomyślnie dodano firmę',
    'supported_events' => 'Obsługiwane wydarzenia',
    'custom3' => 'Trzeci zwyczaj',
    'custom4' => 'Czwarty zwyczaj',
    'optional' => 'Fakultatywny',
    'license' => 'Licencja',
    'invoice_balance' => 'Saldo faktury',
    'saved_design' => 'Pomyślnie zapisano projekt',
    'client_details' => 'Szczegóły Klienta',
    'company_address' => 'Adres Firmy',
    'quote_details' => 'Szczegóły oferty',
    'credit_details' => 'Szczegóły kredytowe',
    'product_columns' => 'Kolumny w produkcie',
    'task_columns' => 'Kolumny zadań',
    'add_field' => 'Dodaj pole',
    'all_events' => 'Wszystkie wydarzenia',
    'owned' => 'Posiadany',
    'payment_success' => 'Płatność pomyślna',
    'payment_failure' => 'Niepowodzenie płatności',
    'quote_sent' => 'Cytat wysłany',
    'credit_sent' => 'Wysłano kredyt',
    'invoice_viewed' => 'Faktura odczytana',
    'quote_viewed' => 'Wyświetlono',
    'credit_viewed' => 'Kredyt Wyświetlony',
    'quote_approved' => 'Zaakceptowano',
    'receive_all_notifications' => 'Otrzymuj wszystkie powiadomienia',
    'purchase_license' => 'Kup licencję',
    'enable_modules' => 'Włącz moduły',
    'converted_quote' => 'Pomyślnie przekonwertowano wycenę',
    'credit_design' => 'Projektowanie kredytów',
    'includes' => 'Zawiera',
    'css_framework' => 'Struktura CSS',
    'custom_designs' => 'Projekty niestandardowe',
    'designs' => 'Projekty',
    'new_design' => 'Nowy projekt',
    'edit_design' => 'Edytuj projekt',
    'created_design' => 'Pomyślnie utworzono projekt',
    'updated_design' => 'Pomyślnie zaktualizowano projekt',
    'archived_design' => 'Projekt został pomyślnie zarchiwizowany',
    'deleted_design' => 'Pomyślnie usunięto projekt',
    'removed_design' => 'Pomyślnie usunięto projekt',
    'restored_design' => 'Projekt został pomyślnie odrestaurowany',
    'recurring_tasks' => 'Zadania cykliczne',
    'removed_credit' => 'Pomyślnie usunięto kredyt',
    ...
    'slack_webhook_url' => 'Adres URL webhooka Slacka',
    'partial_payment' => 'Częściowa płatność',
    'partial_payment_email' => 'Częściowy e-mail z płatnością',
    'clone_to_credit' => 'Klonuj na kredyt',
    'emailed_credit' => 'Pomyślnie wysłano e-mail z informacją o kredycie',
    'marked_credit_as_sent' => 'Pomyślnie oznaczono kredyt jako wysłany',
    'email_subject_payment_partial' => 'Temat częściowej płatności e-mailem',
    'is_approved' => 'Jest zatwierdzony',
    'migration_went_wrong' => 'Ups, coś poszło nie tak! Przed rozpoczęciem migracji upewnij się, że masz skonfigurowaną instancję Red Invoice v5.',
    'cross_migration_message' => 'Migracja między kontami jest niedozwolona. Więcej informacji znajdziesz tutaj: <a href="https://invoiceninja.github.io/docs/migration/#troubleshooting">https://invoiceninja.github.io/docs/migration/#troubleshooting</a>',
    'email_credit' => 'Kredyt e-mailowy',
    'client_email_not_set' => 'Klient nie ma ustawionego adresu e-mail',
    'ledger' => 'Księga główna',
    'view_pdf' => 'Wyświetl PDF',
    'all_records' => 'Wszystkie rekordy',
    'owned_by_user' => 'Własność użytkownika',
    'credit_remaining' => 'Pozostały kredyt',
    'use_default' => 'Użyj domyślnego',
    'reminder_endless' => 'Niekończące się przypomnienia',
    'number_of_days' => 'Liczba dni',
    'configure_payment_terms' => 'Konfiguruj warunki płatności',
    'payment_term' => 'Termin płatności',
    'new_payment_term' => 'Nowy termin płatności',
    'deleted_payment_term' => 'Pomyślnie usunięto termin płatności',
    'removed_payment_term' => 'Pomyślnie usunięto termin płatności',
    'restored_payment_term' => 'Pomyślnie przywrócono termin płatności',
    'full_width_editor' => 'Edytor pełnej szerokości',
    'full_height_filter' => 'Filtr pełnej wysokości',
    'email_sign_in' => 'Zaloguj się przez email',
    'change' => 'Zmiana',
    'change_to_mobile_layout' => 'Zmienić na układ mobilny?',
    'change_to_desktop_layout' => 'Zmienić układ pulpitu?',
    'send_from_gmail' => 'Wyślij z Gmail',
    'reversed' => 'Wywrócony',
    'cancelled' => 'Odwołany',
    'quote_amount' => 'Kwota oferty',
    'hosted' => 'Hostowane',
    'selfhosted' => 'Samodzielnie hostowany',
    'hide_menu' => 'Ukryj menu',
    'show_menu' => 'Pokaż menu',
    'partially_refunded' => 'Częściowo zwrócone',
    'search_documents' => 'Szukaj dokumentów',
    'search_designs' => 'Wyszukaj projekty',
    ...
    'cancelled_invoice' => 'Pomyślnie anulowano fakturę',
    'cancelled_invoices' => 'Pomyślnie anulowano faktury',
    'reversed_invoice' => 'Pomyślnie odwrócona faktura',
    'reversed_invoices' => 'Pomyślnie cofnięto faktury',
    'reverse' => 'Odwracać',
    'filtered_by_project' => 'Filtrowane według projektu',
    'google_sign_in' => 'Zaloguj się przez Google',
    'activity_58' => ':user odwrócona faktura :invoice',
    'activity_59' => ':user anulowana faktura :invoice',
    'payment_reconciliation_failure' => 'Niepowodzenie pojednania',
    'payment_reconciliation_success' => 'Sukces pojednania',
    'gateway_success' => 'Sukces bramy',
    'gateway_failure' => 'Awaria bramy',
    'gateway_error' => 'Błąd bramy',
    'email_send' => 'Wyślij E-Mail',
    'email_retry_queue' => 'Kolejka ponownych prób wysłania wiadomości e-mail',
    'failure' => 'Awaria',
    'quota_exceeded' => 'Przekroczono limit',
    'upstream_failure' => 'Awaria w górnym biegu rzeki',
    'system_logs' => 'Logi systemu',
    'copy_link' => 'Kopiuj link',
    'welcome_to_invoice_ninja' => 'Witamy w Red Invoice',
    'optin' => 'Opt-In',
    'optout' => 'Rezygnacja',
    'auto_convert' => 'Automatyczna konwersja',
    'reminder1_sent' => 'Przypomnienie 1 wysłane',
    'reminder2_sent' => 'Przypomnienie 2 wysłane',
    'reminder3_sent' => 'Przypomnienie 3 wysłane',
    ...
    'view_in_stripe' => 'Wyświetl w Stripe',
    'rows_per_page' => 'Wierszy na stronę',
    'apply_payment' => 'Zastosuj płatność',
    'unapplied' => 'Niezastosowany',
    'custom_labels' => 'Etykiety niestandardowe',
    'record_type' => 'Typ rekordu',
    'record_name' => 'Nazwa rekordu',
    'file_type' => 'Typ pliku',
    'height' => 'Wysokość',
    'width' => 'Szerokość',
    'health_check' => 'Kontrola stanu zdrowia',
    'last_login_at' => 'Ostanie logowanie',
    'company_key' => 'Klucz firmy',
    'storefront' => 'Witryna sklepowa',
    'storefront_help' => 'Włącz tworzenie faktur za pomocą aplikacji innych firm',
    'count_records_selected' => 'Wybrano rekordy :count',
    'count_record_selected' => ':count wybrano rekord',
    'client_created' => 'Klient utworzony',
    'online_payment_email' => 'E-mail do płatności online',
    'manual_payment_email' => 'E-mail z płatnością ręczną',
    'completed' => 'Zakończone',
    'gross' => 'Brutto',
    'net_amount' => 'Kwota netto',
    'net_balance' => 'Saldo netto',
    'client_settings' => 'Ustawienia klienta',
    'selected_invoices' => 'Wybrane faktury',
    'selected_payments' => 'Wybrane płatności',
    'selected_quotes' => 'Wybrane cytaty',
    'selected_tasks' => 'Wybrane zadania',
    'selected_expenses' => 'Wybrane wydatki',
    'past_due_invoices' => 'Przeterminowane faktury',
    ...
    'update_vendor' => 'Aktualizacja dostawcy',
    'create_expense' => 'Utwórz wydatek',
    'update_expense' => 'Aktualizacja wydatków',
    ...
    'crons_not_enabled' => 'Należy włączyć crony',
    'api_webhooks' => 'Webhooki API',
    'search_webhooks' => 'Wyszukaj webhooki :count',
    'search_webhook' => 'Wyszukaj 1 webhook',
    'webhook' => 'Webhook',
    'webhooks' => 'Webhooki',
    'new_webhook' => 'Nowy webhook',
    'edit_webhook' => 'Edytuj webhook',
    'created_webhook' => 'Pomyślnie utworzono webhook',
    'updated_webhook' => 'Pomyślnie zaktualizowano webhook',
    'archived_webhook' => 'Pomyślnie zarchiwizowano webhook',
    'deleted_webhook' => 'Pomyślnie usunięto webhook',
    'removed_webhook' => 'Pomyślnie usunięto webhook',
    'restored_webhook' => 'Pomyślnie przywrócono webhook',
    'search_tokens' => 'Wyszukaj tokeny :count',
    'search_token' => 'Wyszukaj 1 token',
    'new_token' => 'Nowy token',
    'removed_token' => 'Pomyślnie usunięto token',
    'restored_token' => 'Pomyślnie przywrócono token',
    'client_registration' => 'Rejestracja klienta',
    'client_registration_help' => 'Włącz klientom możliwość samodzielnej rejestracji w portalu',
    'customize_and_preview' => 'Dostosuj i wyświetl podgląd',
    'search_document' => 'Szukaj 1 dokumentu',
    'search_design' => 'Wyszukaj 1 Projekt',
    'search_invoice' => 'Szukaj 1 faktury',
    'search_client' => 'Szukaj 1 klienta',
    'search_product' => 'Wyszukaj 1 produkt',
    'search_quote' => 'Wyszukaj 1 cytat',
    'search_credit' => 'Wyszukaj 1 kredyt',
    'search_vendor' => 'Wyszukaj 1 dostawcę',
    'search_user' => 'Wyszukaj 1 użytkownika',
    'search_tax_rate' => 'Wyszukaj 1 stawkę podatku',
    'search_task' => 'Wyszukaj 1 zadanie',
    'search_project' => 'Wyszukaj 1 projekt',
    'search_expense' => 'Wyszukaj 1 Wydatek',
    'search_payment' => 'Wyszukaj 1 Płatność',
    'search_group' => 'Wyszukaj 1 grupę',
    'created_on' => 'Utworzono dnia',
    'payment_status_-1' => 'Niezastosowany',
    'lock_invoices' => 'Blokuj faktury',
    'show_table' => 'Widok tabeli',
    'show_list' => 'Widok listy',
    'view_changes' => 'Wyświetl zmiany',
    'force_update' => 'Wymuś aktualizację',
    'force_update_help' => 'Używasz najnowszej wersji, ale mogą być dostępne oczekujące poprawki.',
    'mark_paid_help' => 'Śledź opłacony koszt',
    'mark_invoiceable_help' => 'Włącz fakturowanie wydatku',
    'add_documents_to_invoice_help' => 'Udostępnij dokumenty klientowi',
    ...
    'capture_card' => 'Karta przechwytująca',
    'auto_bill_enabled' => 'Włączono automatyczne fakturowanie',
    'total_taxes' => 'Razem podatki',
    'line_taxes' => 'Podatki liniowe',
    'total_fields' => 'Suma pól',
    'stopped_recurring_invoice' => 'Pomyślnie zatrzymano fakturę cykliczną',
    'started_recurring_invoice' => 'Pomyślnie rozpoczęto cykliczne wystawianie faktury',
    'resumed_recurring_invoice' => 'Pomyślnie wznowiono fakturę cykliczną',
    'gateway_refund' => 'Zwrot Gateway',
    'gateway_refund_help' => 'Przetwórz zwrot za pomocą bramki płatniczej',
    ...
    'created_recurring_invoice' => 'Pomyślnie utworzono fakturę cykliczną',
    'updated_recurring_invoice' => 'Pomyślnie zaktualizowano fakturę cykliczną',
    'removed_recurring_invoice' => 'Pomyślnie usunięto fakturę cykliczną',
    'search_recurring_invoice' => 'Wyszukaj 1 fakturę cykliczną',
    'search_recurring_invoices' => 'Wyszukaj :count Faktury cykliczne',
    'send_date' => 'Data wysłania',
    'auto_bill_on' => 'Automatyczne włączanie faktury',
    'minimum_under_payment_amount' => 'Minimalna kwota niedopłaty',
    'allow_over_payment' => 'Zezwól na nadpłatę',
    'allow_over_payment_help' => 'Akceptuj płacenie napiwków',
    'allow_under_payment' => 'Zezwól na niedopłatę',
    'allow_under_payment_help' => 'Wsparcie w zapłaceniu co najmniej częściowej kwoty/zaliczki',
    'test_mode' => 'Tryb testowy',
    'calculated_rate' => 'Obliczona stawka',
    'default_task_rate' => 'Domyślna stawka zadań',
    'clear_cache' => 'Wyczyść pamięć podręczną',
    'sort_order' => 'Kolejność sortowania',
    'task_status' => 'Status',
    'task_statuses' => 'Statusy zadań',
    'new_task_status' => 'Nowy status zadania',
    'edit_task_status' => 'Edytuj status zadania',
    'created_task_status' => 'Pomyślnie utworzono status zadania',
    'archived_task_status' => 'Pomyślnie zarchiwizowano status zadania',
    'deleted_task_status' => 'Pomyślnie usunięto status zadania',
    'removed_task_status' => 'Pomyślnie usunięto status zadania',
    'restored_task_status' => 'Pomyślnie przywrócono status zadania',
    'search_task_status' => 'Wyszukaj 1 Status zadania',
    'search_task_statuses' => 'Wyszukaj statusy zadań :count',
    'show_tasks_table' => 'Pokaż tabelę zadań',
    'show_tasks_table_help' => 'Zawsze pokazuj sekcję zadań podczas tworzenia faktur',
    'invoice_task_timelog' => 'Rejestr zadań fakturowania',
    'invoice_task_timelog_help' => 'Dodaj szczegóły dotyczące czasu do pozycji faktury',
    'auto_start_tasks_help' => 'Rozpocznij zadania przed zapisaniem',
    'configure_statuses' => 'Skonfiguruj statusy',
    'task_settings' => 'Ustawienia zadania',
    'configure_categories' => 'Konfiguruj kategorie',
    'edit_expense_category' => 'Edytuj kategorię wydatków',
    'removed_expense_category' => 'Pomyślnie usunięto kategorię wydatków',
    'search_expense_category' => 'Wyszukaj 1 kategorię wydatków',
    'search_expense_categories' => 'Wyszukaj kategorie wydatków :count',
    'use_available_credits' => 'Użyj dostępnych kredytów',
    'show_option' => 'Pokaż opcję',
    'negative_payment_error' => 'Kwota kredytu nie może przekroczyć kwoty płatności',
    'should_be_invoiced_help' => 'Włącz fakturowanie wydatku',
    'configure_gateways' => 'Konfiguruj bramy',
    'payment_partial' => 'Częściowa płatność',
    'is_running' => 'Biegnie',
    'invoice_currency_id' => 'Identyfikator waluty faktury',
    'tax_name1' => 'Nazwa podatku 1',
    'tax_name2' => 'Nazwa podatku 2',
    'transaction_id' => 'Identyfikator transakcji',
    'invoice_late' => 'Opóźniona faktura',
    ...
    'company_disabled_warning' => 'Ostrzeżenie: ta firma nie została jeszcze aktywowana',
    'late_invoice' => 'Opóźniona faktura',
    'expired_quote' => 'Oferta przedawniona',
    'remind_invoice' => 'Przypomnij o fakturze',
    'client_phone' => 'Telefon klienta',
    'required_fields' => 'Wymagane pola',
    'enabled_modules' => 'Włączone moduły',
    'activity_60' => ':contact wyświetlono cytat :quote',
    'activity_61' => ':user zaktualizowany klient :client',
    'activity_62' => ':user zaktualizowany dostawca :vendor',
    'activity_63' => ':user wysłał pierwsze przypomnienie o fakturze :invoice do :contact',
    'activity_64' => ':user wysłał drugie przypomnienie o fakturze :invoice do :contact',
    'activity_65' => ':user wysłał e-mailem trzecie przypomnienie o fakturze :invoice na adres :contact',
    'activity_66' => ':user wysłał e-mail z niekończącym się przypomnieniem o fakturze :invoice do :contact',
    'expense_category_id' => 'Identyfikator kategorii wydatków',
    'view_licenses' => 'Wyświetl licencje',
    'fullscreen_editor' => 'Edytor pełnoekranowy',
    'sidebar_editor' => 'Edytor paska bocznego',
    'please_type_to_confirm' => 'Wpisz „ :value ”, aby potwierdzić',
    'purge' => 'Oczyszczać',
    'clone_to' => 'Powiel do',
    'clone_to_other' => 'Powiel do Innych',
    'labels' => 'Etykiety',
    'add_custom' => 'Dodaj niestandardowy',
    'payment_tax' => 'Podatek od płatności',
    'white_label' => 'Biała etykieta',
    'sent_invoices_are_locked' => 'Wysłane faktury są zablokowane',
    'paid_invoices_are_locked' => 'Opłacone faktury są zablokowane',
    'source_code' => 'Kod źródłowy',
    'app_platforms' => 'Platformy aplikacji',
    'archived_task_statuses' => 'Pomyślnie zarchiwizowano statusy zadań :value',
    'deleted_task_statuses' => 'Pomyślnie usunięto statusy zadań :value',
    'restored_task_statuses' => 'Pomyślnie przywrócono statusy zadań :value',
    'deleted_expense_categories' => 'Pomyślnie usunięto kategorie wydatków :value',
    'restored_expense_categories' => 'Pomyślnie przywrócono kategorie wydatków :value',
    'archived_recurring_invoices' => 'Pomyślnie zarchiwizowano cykliczne faktury :value',
    'deleted_recurring_invoices' => 'Pomyślnie usunięto cykliczne faktury :value',
    'restored_recurring_invoices' => 'Pomyślnie przywrócono cykliczne faktury :value',
    'archived_webhooks' => 'Pomyślnie zarchiwizowano webhooki :value',
    'deleted_webhooks' => 'Pomyślnie usunięto webhooki :value',
    'removed_webhooks' => 'Pomyślnie usunięto webhooki :value',
    'restored_webhooks' => 'Pomyślnie przywrócono webhooki :value',
    'api_docs' => 'Dokumentacja API',
    'archived_tokens' => 'Pomyślnie zarchiwizowano tokeny :value',
    'deleted_tokens' => 'Pomyślnie usunięto tokeny :value',
    'restored_tokens' => 'Pomyślnie przywrócono tokeny :value',
    'archived_payment_terms' => 'Pomyślnie zarchiwizowano warunki płatności :value',
    'deleted_payment_terms' => 'Pomyślnie usunięto warunki płatności :value',
    'restored_payment_terms' => 'Pomyślnie przywrócono warunki płatności :value',
    'archived_designs' => 'Pomyślnie zarchiwizowano projekty :value',
    'deleted_designs' => 'Pomyślnie usunięto projekty :value',
    'restored_designs' => 'Pomyślnie przywrócono projekty :value',
    'restored_credits' => 'Pomyślnie przywrócono kredyty :value',
    'archived_users' => 'Pomyślnie zarchiwizowano użytkowników :value',
    'deleted_users' => 'Pomyślnie usunięto użytkowników :value',
    'removed_users' => 'Pomyślnie usunięto użytkowników :value',
    'restored_users' => 'Pomyślnie przywrócono użytkowników :value',
    'archived_tax_rates' => 'Pomyślnie zarchiwizowano stawki podatkowe :value',
    'deleted_tax_rates' => 'Pomyślnie usunięto stawki podatkowe :value',
    'restored_tax_rates' => 'Pomyślnie przywrócono stawki podatkowe :value',
    'archived_company_gateways' => 'Pomyślnie zarchiwizowano bramy :value',
    'deleted_company_gateways' => 'Pomyślnie usunięto bramy :value',
    'restored_company_gateways' => 'Pomyślnie przywrócono bramy :value',
    ...
    'archived_documents' => 'Pomyślnie zarchiwizowano dokumenty :value',
    'deleted_documents' => 'Pomyślnie usunięto dokumenty :value',
    'restored_documents' => 'Pomyślnie przywrócono dokumenty :value',
    'restored_vendors' => 'Pomyślnie przywrócono dostawców :value',
    'restored_expenses' => 'Pomyślnie przywrócono wydatki :value',
    'restored_tasks' => 'Pomyślnie przywrócono zadania :value',
    'restored_projects' => 'Pomyślnie przywrócono projekty :value',
    'restored_products' => 'Pomyślnie przywrócono produkty :value',
    'restored_clients' => 'Pomyślnie przywrócono klientów :value',
    'restored_invoices' => 'Pomyślnie przywrócono faktury :value',
    'restored_payments' => 'Pomyślnie przywrócono płatności :value',
    'restored_quotes' => 'Pomyślnie przywrócono cytaty :value',
    'update_app' => 'Aktualizacja aplikacji',
    'started_import' => 'Import został pomyślnie rozpoczęty',
    'duplicate_column_mapping' => 'Duplikowanie mapowania kolumn',
    'uses_inclusive_taxes' => 'Stosuje podatki włącznie',
    'is_amount_discount' => 'Czy kwota rabatu',
    'map_to' => 'Mapa do',
    'first_row_as_column_names' => 'Użyj pierwszego wiersza jako nazw kolumn',
    ...
    'tax_name3' => 'Nazwa podatku 3',
    'debug_mode_is_enabled' => 'Tryb debugowania jest włączony',
    'debug_mode_is_enabled_help' => 'Ostrzeżenie: jest przeznaczony do użytku na komputerach lokalnych i może ujawnić dane uwierzytelniające. Kliknij, aby dowiedzieć się więcej.',
    'running_tasks' => 'Zadania w trakcie',
    'recent_tasks' => 'Ostatnie zadania',
    'recent_expenses' => 'Ostatnie wydatki',
    'upcoming_expenses' => 'Nadchodzące wydatki',
    'search_payment_term' => 'Wyszukaj 1 Termin płatności',
    'search_payment_terms' => 'Przeszukaj :count warunki płatności',
    'save_and_preview' => 'Zapis i Podgląd',
    'save_and_email' => 'Zapisz i wyślij',
    'converted_balance' => 'Saldo przeliczone',
    'is_sent' => 'Wysłano',
    ...
    'enter_taxes' => 'Wprowadź podatki',
    'by_rate' => 'Według stawki',
    'by_amount' => 'Według kwoty',
    ...
    'counter_pattern_error' => 'Aby użyć licznika :client dodaj numer :client lub numer identyfikacyjny :client aby zapobiec konfliktom',
    ...
    'notification_credit_sent_subject' => 'Kredyt :invoice został wysłany na adres :client',
    'notification_credit_viewed_subject' => 'Kredyt :invoice został wyświetlony przez :client',
    'notification_credit_sent' => 'Następujący klient :client otrzymał wiadomość e-mail z informacją o kredycie :invoice dla :amount .',
    ...
    'account_login_text' => 'Witaj! Miło Cię widzieć.',
    ...
    'client_information_text' => 'Użyj stałego adresu, pod którym będziesz mógł odbierać pocztę.',
    ...
    'new_signup' => 'Nowe zapisy',
    'new_signup_text' => 'Utworzono nowe konto przez :user - :email - z adresu IP: :ip',
    ...
    'setup' => 'Instalacja',
    'quick_overview_statistics' => 'Szybki przegląd i statystyki',
    ...
    'personal_address' => 'Adres osobisty',
    'enter_your_personal_address' => 'Wprowadź swój adres osobisty',
    'enter_your_shipping_address' => 'Wprowadź swój adres dostawy',
    'list_of_invoices' => 'Lista faktur',
    'with_selected' => 'Z wybranymi',
    'invoice_still_unpaid' => 'Faktura nadal nie jest opłacona. Naciśnij przycisk aby dokończyć płatność',
    'list_of_recurring_invoices' => 'Lista faktur cyklicznych',
    'details_of_recurring_invoice' => 'Oto kilka szczegółów na temat faktury cyklicznej',
    'cancellation' => 'Anulowanie',
    'about_cancellation' => 'Jeśli chcesz zatrzymać cykliczne wystawianie faktury, kliknij, aby poprosić o anulowanie.',
    'cancellation_warning' => 'Uwaga! Żądasz anulowania tej usługi. Usługa może zostać anulowana bez powiadomienia.',
    'cancellation_pending' => 'W oczekiwaniu na anulowanie, skontaktujemy się z Tobą!',
    'list_of_payments' => 'Lista płatności',
    'payment_details' => 'Szczegóły płatności',
    'list_of_payment_invoices' => 'Faktury partnerskie',
    ...
    'required_extensions' => 'Wymagane rozszerzenia',
    ...
    'per_page' => 'Na stronę',
    'of' => 'z',
    'view_credit' => 'Wyświetl kredyt',
    'to_view_entity_password' => 'Aby wyświetlić :entity należy podać hasło.',
    'showing_x_of' => 'Wyświetlono od :first do :last z :total wpisów',
    'no_results' => 'Nie znaleziono wyników.',
    'payment_failed_subject' => 'Płatność nie powiodła się dla klienta :client',
    'payment_failed_body' => 'Płatność dokonana przez klienta :client nie powiodła się i pojawił się komunikat :message',
    ...
    'footer_label' => 'Prawa autorskie © :year :company .',
    ...
    'application_settings_label' => 'Przechowujmy podstawowe informacje o Twoim Red Invoice!',
    'recommended_in_production' => 'Polecany na produkcji',
    'enable_only_for_development' => 'Włącz tylko dla deweloperów',
    'test_pdf' => 'Test PDF',
    'checkout_authorize_label' => 'Checkout.com można zapisać jako metodę płatności do wykorzystania w przyszłości po zakończeniu pierwszej transakcji. Nie zapomnij zaznaczyć pola „Dane karty kredytowej sklepu” podczas płatności.',
    'sofort_authorize_label' => 'Konto bankowe (SOFORT) można zapisać jako metodę płatności do wykorzystania w przyszłości po zakończeniu pierwszej transakcji. Nie zapomnij sprawdzić „Szczegółów płatności w sklepie” podczas procesu płatności.',
    ...
    'resource' => 'Zasób',
    'document_details' => 'Szczegóły dotyczące dokumentu',
    'hash' => 'Haszysz',
    'resources' => 'Zasoby',
    'allowed_file_types' => 'Dozwolone typy plików:',
    'common_codes' => 'Popularne kody i ich znaczenie',
    'payment_error_code_20087' => '20087: Nieprawidłowe dane śledzenia (nieprawidłowy kod CVV i/lub data ważności)',
    'download_selected' => 'Pobierz zaznaczone',
    'to_pay_invoices' => 'Aby zapłacić faktury, musisz',
    'add_payment_method_first' => 'dodaj metodę płatności',
    'no_items_selected' => 'Nie wybrano żadnych elementów.',
    'payment_due' => 'Należność płatna',
    'account_balance' => 'Saldo konta',
    'thanks' => 'Dzięki',
    'minimum_required_payment' => 'Minimalna wymagana płatność to :amount',
    'under_payments_disabled' => 'Firma nie toleruje niedopłat.',
    'over_payments_disabled' => 'Firma nie dopuszcza nadpłat.',
    'saved_at' => 'Zapisano o :time',
    'credit_payment' => 'Kredyt zastosowany do faktury :invoice _number',
    'credit_subject' => 'Nowy kredyt :number z :account',
    'credit_message' => 'Aby zobaczyć swój kredyt na :amount , kliknij poniższy link.',
    'payment_type_Crypto' => 'Kryptowaluta',
    'payment_type_Credit' => 'Kredyt',
    'store_for_future_use' => 'Przechowuj do wykorzystania w przyszłości',
    'pay_with_credit' => 'Zapłać kartą kredytową',
    'payment_method_saving_failed' => 'Metody płatności nie można zapisać do wykorzystania w przyszłości.',
    'pay_with' => 'Zapłać za pomocą',
    'n/a' => 'Nie dotyczy',
    'by_clicking_next_you_accept_terms' => 'Klikając „Dalej” akceptujesz warunki.',
    'not_specified' => 'Nie określono',
    'before_proceeding_with_payment_warning' => 'Przed dokonaniem płatności należy wypełnić następujące pola',
    'after_completing_go_back_to_previous_page' => 'Po zakończeniu wróć do poprzedniej strony.',
    'pay' => 'Płacić',
    'instructions' => 'Instrukcje',
    'notification_invoice_reminder1_sent_subject' => 'Przypomnienie nr 1 dotyczące faktury :invoice zostało wysłane na :client',
    'notification_invoice_reminder2_sent_subject' => 'Przypomnienie nr 2 dotyczące faktury :invoice zostało wysłane na :client',
    'notification_invoice_reminder3_sent_subject' => 'Przypomnienie nr 3 dotyczące faktury :invoice zostało wysłane na :client',
    'notification_invoice_custom_sent_subject' => 'Niestandardowe przypomnienie zostało wysłane do :client',
    'notification_invoice_reminder_endless_sent_subject' => 'Niekończące się przypomnienie dotyczące faktury :invoice zostało wysłane na :client',
    'assigned_user' => 'Przypisany użytkownik',
    'setup_steps_notice' => 'Aby przejść do następnego kroku, przetestuj każdą sekcję.',
    'setup_phantomjs_note' => 'Uwaga dotycząca Phantom JS. Przeczytaj więcej.',
    'minimum_payment' => 'Minimalna płatność',
    'no_action_provided' => 'Brak działań. Jeśli uważasz, że to błąd, skontaktuj się z pomocą techniczną.',
    'no_payable_invoices_selected' => 'Nie wybrano faktur do zapłaty. Upewnij się, że nie próbujesz zapłacić faktury roboczej lub faktury z zerowym saldem należności.',
    'required_payment_information' => 'Wymagane dane płatnicze',
    'required_payment_information_more' => 'Aby zrealizować płatność potrzebujemy więcej informacji o Tobie.',
    'required_client_info_save_label' => 'Zapiszemy te dane, więc nie będziesz musiał ich wpisywać następnym razem.',
    'notification_credit_bounced' => 'Nie udało się dostarczyć karty kredytowej :invoice na adres :contact .\n :error',
    'notification_credit_bounced_subject' => 'Nie można dostarczyć karty kredytowej :invoice',
    'save_payment_method_details' => 'Zapisz szczegóły metody płatności',
    'new_card' => 'Nowa karta',
    'new_bank_account' => 'Dodaj konto bankowe',
    'company_limit_reached' => 'Limit firm :limit na jedno konto.',
    'credits_applied_validation' => 'Łączna liczba zastosowanych kredytów nie może być WIĘKSZA niż suma faktur',
    'credit_number_taken' => 'Numer kredytowy już zajęty',
    'credit_not_found' => 'Nie znaleziono kredytu',
    'invoices_dont_match_client' => 'Wybrane faktury nie pochodzą od jednego klienta',
    'duplicate_credits_submitted' => 'Złożono duplikaty kredytów.',
    'duplicate_invoices_submitted' => 'Złożono duplikaty faktur.',
    'credit_with_no_invoice' => 'W przypadku korzystania z kredytu w płatnościach konieczne jest posiadanie ustawionej faktury',
    'client_id_required' => 'Wymagany jest identyfikator klienta',
    'expense_number_taken' => 'Numer wydatku już zajęty',
    'invoice_number_taken' => 'Numer faktury jest już w użyciu',
    'payment_id_required' => 'Wymagany `id` płatności.',
    'unable_to_retrieve_payment' => 'Nie można pobrać określonej płatności',
    'invoice_not_related_to_payment' => 'Identyfikator faktury :invoice nie jest powiązany z tą płatnością',
    'credit_not_related_to_payment' => 'Identyfikator karty kredytowej :credit nie jest powiązany z tą płatnością',
    'max_refundable_invoice' => 'Próba zwrotu większej kwoty niż dozwolona dla identyfikatora faktury :invoice , maksymalna kwota zwrotu wynosi :amount',
    'refund_without_invoices' => 'Próba zwrotu płatności z załączonymi fakturami. Proszę podać prawidłowe faktury, które mają zostać zwrócone.',
    'refund_without_credits' => 'Próba zwrotu płatności z dołączonymi kredytami. Proszę podać prawidłowe kredyty, które mają zostać zwrócone.',
    'max_refundable_credit' => 'Próba zwrotu większej kwoty niż dozwolona kwota kredytu :credit , maksymalna kwota zwrotu wynosi :amount',
    'project_client_do_not_match' => 'Klient projektu nie pasuje do klienta jednostki',
    'quote_number_taken' => 'Numer oferty już zajęty',
    'recurring_invoice_number_taken' => 'Numer faktury cyklicznej :number jest już zajęty',
    'user_not_associated_with_account' => 'Użytkownik nie jest powiązany z tym kontem',
    'amounts_do_not_balance' => 'Kwoty nie bilansują się prawidłowo.',
    'insufficient_applied_amount_remaining' => 'Kwota wykorzystanego materiału jest niewystarczająca do pokrycia płatności.',
    'insufficient_credit_balance' => 'Niewystarczające saldo na rachunku kredytowym.',
    'one_or_more_invoices_paid' => 'Jedna lub więcej faktur została zapłacona',
    'invoice_cannot_be_refunded' => 'Faktury o identyfikatorze :number nie można zwrócić',
    'attempted_refund_failed' => 'Próba zwrotu pieniędzy :amount Tylko :refundable_amount jest dostępny do zwrotu.',
    'user_not_associated_with_this_account' => 'Tego użytkownika nie można powiązać z tą firmą. Być może zarejestrował już użytkownika na innym koncie?',
    ...
    'large_account_update_parameter' => 'Nie można załadować dużego konta bez parametru updated_at',
    'no_backup_exists' => 'Nie istnieje kopia zapasowa dla tej aktywności',
    'company_user_not_found' => 'Nie znaleziono rekordu użytkownika firmy',
    'no_credits_found' => 'Nie znaleziono dokumentów',
    'action_unavailable' => 'Żądana akcja :action jest niedostępna.',
    ...
    'invoice_license_or_environment' => 'Nieprawidłowa licencja lub nieprawidłowe środowisko :environment',
    'route_not_available' => 'Trasa niedostępna',
    'invalid_design_object' => 'Nieprawidłowy obiekt projektu niestandardowego',
    ...
    'create_webhook_failure' => 'Nie udało się utworzyć webhooka',
    'payment_message_extended' => 'Dziękujemy za wpłatę :amount za :invoice',
    'online_payments_minimum_note' => 'Uwaga: Płatności online są obsługiwane tylko wtedy, gdy kwota jest większa niż 1 USD lub równowartość w innej walucie.',
    'payment_token_not_found' => 'Nie znaleziono tokenu płatności. Spróbuj ponownie. Jeśli problem nadal występuje, spróbuj użyć innej metody płatności.',
    'vendor_address1' => 'Ulica Sprzedawcy',
    'vendor_address2' => 'Mieszkanie/apartament sprzedawcy',
    'partially_unapplied' => 'Częściowo niezastosowane',
    'select_a_gmail_user' => 'Proszę wybrać użytkownika uwierzytelnionego za pomocą Gmaila',
    'list_long_press' => 'Lista Długie naciśnięcie',
    'show_actions' => 'Pokaż akcje',
    'start_multiselect' => 'Rozpocznij zaznaczanie wielu',
    'email_sent_to_confirm_email' => 'Wysłano wiadomość e-mail w celu potwierdzenia adresu e-mail',
    'converted_paid_to_date' => 'Konwertowanie zapłacono',
    'converted_credit_balance' => 'Przekształcone saldo kredytowe',
    'converted_total' => 'Całkowita konwersja',
    'reply_to_name' => 'Odpowiedz do',
    'payment_status_-2' => 'Częściowo niezastosowane',
    'color_theme' => 'Kolor szablonu',
    'start_migration' => 'Rozpocznij migrację',
    'recurring_cancellation_request' => 'Prośba o anulowanie faktury cyklicznej z :contact',
    'recurring_cancellation_request_body' => ':contact od klienta :client poproszono o anulowanie faktury cyklicznej :invoice',
    'hello' => 'Cześć',
    'group_documents' => 'Dokumenty grupy',
    'quote_approval_confirmation_label' => 'Czy na pewno chcesz zatwierdzić tę ofertę?',
    'migration_select_company_label' => 'Wybierz firmy do migracji',
    'force_migration' => 'Wymuszona migracja',
    'require_password_with_social_login' => 'Wymagaj hasła przy logowaniu społecznościowym',
    'stay_logged_in' => 'Pozostań zalogowany',
    'session_about_to_expire' => 'Ostrzeżenie: Twoja sesja wkrótce wygaśnie',
    'count_hours' => ':count Godziny',
    'count_day' => '1 dzień',
    ...
    'invoice2go' => 'Faktura2go',
    'invoicely' => 'Fakturowo',
    'waveaccounting' => 'Rachunkowość falowa',
    'zoho' => 'Zoho',
    'accounting' => 'Księgowość',
    'required_files_missing' => 'Proszę dostarczyć wszystkie pliki CSV.',
    'migration_auth_label' => 'Kontynuujmy uwierzytelnianie.',
    'api_secret' => 'Tajny klucz API',
    'migration_api_secret_notice' => 'Parametr API_SECRET znajdziesz w pliku .env lub w Red Invoice v5. Jeśli brakuje właściwości, pozostaw pole puste.',
    'billing_coupon_notice' => 'Zniżka zostanie naliczona przy płatności.',
    'use_last_email' => 'Użyj ostatniego adresu e-mail',
    ...
    'changing_phone_disables_two_factor' => 'Ostrzeżenie: Zmiana numeru telefonu spowoduje wyłączenie uwierzytelniania dwuskładnikowego',
    'help_translate' => 'Pomóż w tłumaczeniu',
    'please_select_a_country' => 'Proszę wybrać kraj',
    'disabled_two_factor' => 'Pomyślnie wyłączono 2FA',
    'connected_google' => 'Pomyślnie połączono konto',
    'disconnected_google' => 'Pomyślnie odłączono konto',
    'delivered' => 'Dostarczono',
    'spam' => 'Spam',
    'view_docs' => 'Dokumentacja',
    'enter_phone_to_enable_two_factor' => 'Podaj numer telefonu komórkowego, aby włączyć uwierzytelnianie dwuskładnikowe',
    'send_sms' => 'Wyślij SMS',
    'sms_code' => 'Kod SMS',
    'connect_google' => 'Połącz z Google',
    'disconnect_google' => 'Odłącz Google',
    'disable_two_factor' => 'Wyłącz uwierzytelnianie dwuskładnikowe',
    'invoice_task_datelog' => 'Rejestr zadań fakturowania',
    'invoice_task_datelog_help' => 'Dodaj szczegóły daty do pozycji faktury',
    'promo_code' => 'Kod promocyjny',
    'recurring_invoice_issued_to' => 'Faktura cykliczna wystawiona na',
    'subscription' => 'Subskrypcja',
    'new_subscription' => 'Nowa subskrypcja',
    'deleted_subscription' => 'Pomyślnie usunięto subskrypcję',
    'removed_subscription' => 'Pomyślnie usunięto subskrypcję',
    'restored_subscription' => 'Pomyślnie przywrócono subskrypcję',
    'search_subscription' => 'Wyszukaj 1 subskrypcję',
    'search_subscriptions' => 'Wyszukaj subskrypcje :count',
    'subdomain_is_not_available' => 'Subdomena jest niedostępna',
    'connect_gmail' => 'Połącz Gmaila',
    'disconnect_gmail' => 'Odłącz Gmaila',
    'connected_gmail' => 'Pomyślnie połączono z Gmailem',
    'disconnected_gmail' => 'Pomyślnie odłączono Gmaila',
    'update_fail_help' => 'Zmiany w bazie kodu mogą blokować aktualizację. Aby odrzucić zmiany, możesz uruchomić to polecenie:',
    'client_id_number' => 'Numer ID Klienta',
    'count_minutes' => ':count Minut',
    'password_timeout' => 'Czas wygasania hasła',
    'shared_invoice_credit_counter' => 'Udostępnij fakturę/licznik kredytowy',
    'activity_80' => ':user utworzył subskrypcję :subscription',
    'activity_81' => ':user zaktualizowana subskrypcja :subscription',
    'activity_82' => ':user zarchiwizowana subskrypcja :subscription',
    'activity_83' => ':user usunięto subskrypcję :subscription',
    'activity_84' => ':user przywrócono subskrypcję :subscription',
    ...
    'notification_invoice_created_body' => 'Poniższa faktura :invoice została utworzona dla klienta :client dla :amount .',
    'notification_invoice_created_subject' => 'Faktura :invoice została utworzona dla :client',
    'notification_quote_created_body' => 'Poniższy cytat :invoice został utworzony dla klienta :client dla :amount .',
    'notification_quote_created_subject' => 'Cytat :invoice został stworzony dla :client',
    'notification_credit_created_body' => 'Poniższy kredyt :invoice został utworzony dla klienta :client dla :amount .',
    'notification_credit_created_subject' => 'Kredyt :invoice został utworzony dla :client',
    'max_companies' => 'Maksymalna liczba zmigrowanych firm',
    'max_companies_desc' => 'Osiągnąłeś maksymalną liczbę firm. Usuń istniejące firmy, aby przenieść nowe.',
    'migration_already_completed' => 'Firma już przeniesiona',
    'migration_already_completed_desc' => 'Wygląda na to, że migracja <b>:company</b> została już przeprowadzona do wersji V5 Red Invoice. Jeśli chcesz zacząć od nowa, możesz wymusić migrację, aby usunąć istniejące dane.',
    'payment_method_cannot_be_authorized_first' => 'Tę metodę płatności można zapisać do wykorzystania w przyszłości po zakończeniu pierwszej transakcji. Nie zapomnij sprawdzić „Szczegółów sklepu” podczas płatności.',
    ...
    'new_login_description' => 'Ostanie logowania do Twojego konta Red Invoice z nowej lokalizacji lub urządzenia:<br><br><b>IP:</b> :ip<br><b>Czas:</b> :time<br><b>Email:</b> :email',
    'contact_details' => 'Szczegóły kontaktu',
    'download_backup_subject' => 'Kopia zapasowa Twojej firmy jest gotowa do pobrania',
    'account_passwordless_login' => 'Logowanie do konta bez hasła',
    ...
    'ach_verification_notification_label' => 'Weryfikacja ACH',
    'ach_verification_notification' => 'Połączenie kont bankowych wymaga weryfikacji. Bramka płatności automatycznie wyśle w tym celu dwie niewielkie wpłaty. Zaksięgowanie tych wpłat na wyciągu online klienta zajmuje 1-2 dni robocze.',
    'login_link_requested_label' => 'Prośba o link do logowania',
    'login_link_requested' => 'Wysłano prośbę o zalogowanie się za pomocą linku. Jeśli nie wysłałeś/aś tej prośby, możesz ją zignorować.',
    'invoices_backup_subject' => 'Twoje faktury są gotowe do pobrania',
    'migration_failed_label' => 'Migracja nie powiodła się',
    'migration_failed' => 'Wygląda na to, że coś poszło nie tak podczas migracji w przypadku następującej firmy:',
    'client_email_company_contact_label' => 'Jeśli masz jakieś pytania, skontaktuj się z nami, chętnie pomożemy!',
    'quote_was_approved_label' => 'Oferta została zaakceptowana',
    'quote_was_approved' => 'Informujemy, że wycena została zaakceptowana.',
    'company_import_failure_subject' => 'Błąd importowania :company',
    'company_import_failure_body' => 'Wystąpił błąd podczas importowania danych firmy. Komunikat o błędzie:',
    'recurring_invoice_due_date' => 'Termin płatności',
    'amount_cents' => 'Kwota w groszach, pensach lub centach, np. za 0,10 USD proszę wpisać 10',
    'default_payment_method_label' => 'Domyślna metoda płatności',
    'default_payment_method' => 'Ustaw tę metodę płatności jako preferowaną.',
    'already_default_payment_method' => 'To jest Twoja preferowana metoda płatności.',
    'auto_bill_disabled' => 'Rachunek automatyczny wyłączony',
    'select_payment_method' => 'Wybierz metodę płatności:',
    'login_without_password' => 'Zaloguj się bez hasła',
    'email_sent' => 'Wyślij do mnie email, gdy faktura zostanie <b>wysłana</b>',
    'one_time_purchases' => 'Zakupy jednorazowe',
    'recurring_purchases' => 'Zakupy cykliczne',
    'you_might_be_interested_in_following' => 'Może Cię zainteresować:',
    'quotes_with_status_sent_can_be_approved' => 'Zatwierdzane mogą być tylko oferty ze statusem „Wysłane”. Oferty wygasłe nie mogą zostać zatwierdzone.',
    'no_quotes_available_for_download' => 'Brak ofert do pobrania.',
    'copyright' => 'Prawo autorskie',
    'user_created_user' => ':user utworzono :created_user w :time',
    'company_deleted' => 'Usunięto firmę',
    'company_deleted_body' => 'Firma [ :company ] została usunięta przez :user',
    'back_to' => 'Wróć do :url',
    'stripe_connect_migration_title' => 'Połącz swoje konto Stripe',
    'stripe_connect_migration_desc' => 'Red Invoice v5 wykorzystuje Stripe Connect do połączenia Twojego konta Stripe z Red Invoice. Zapewnia to dodatkową warstwę bezpieczeństwa dla Twojego konta. Po migracji danych musisz zezwolić Stripe na akceptowanie płatności w wersji 5.<br><br> Aby to zrobić, przejdź do Ustawienia &gt; Płatności online &gt; Konfiguruj bramki. Kliknij Stripe Connect, a następnie w Ustawieniach kliknij Skonfiguruj bramkę. Spowoduje to przejście do Stripe, gdzie będziesz mógł autoryzować Red Invoice, a po powrocie Twoje konto zostanie pomyślnie połączone!',
    ...
    'sepa_mandat' => 'Podając swój numer IBAN i potwierdzając tę płatność, upoważniasz :company oraz Stripe, naszego dostawcę usług płatniczych, do wysłania do Twojego banku instrukcji obciążenia Twojego konta, a także Twój bank do obciążenia Twojego konta zgodnie z tymi instrukcjami. Masz prawo do zwrotu pieniędzy od swojego banku zgodnie z warunkami umowy zawartej z bankiem. Wniosek o zwrot należy złożyć w ciągu 8 tygodni od daty obciążenia Twojego konta.',
    'ideal' => 'ideał',
    'bank_account_holder' => 'Posiadacz konta bankowego',
    'aio_checkout' => 'Kompleksowa obsługa płatności',
    'przelewy24' => 'Przelewy24',
    'przelewy24_accept' => 'Oświadczam, że zapoznałem się z regulaminem i obowiązkiem informacyjnym usługi Przelewy24.',
    'giropay' => 'GiroPay',
    'giropay_law' => 'Podając swoje dane Klienta (takie jak imię i nazwisko, kod sortowania i numer konta), Ty (Klient) wyrażasz zgodę na dobrowolne podanie tych danych.',
    'klarna' => 'Klarna',
    'eps' => 'EPS',
    'becs' => 'Polecenie zapłaty BECS',
    'bacs' => 'Polecenie zapłaty BACS',
    'payment_type_BACS' => 'Polecenie zapłaty BACS',
    'missing_payment_method' => 'Dodaj metodę płatności, zanim spróbujesz zapłacić.',
    'becs_mandate' => 'Podając dane swojego konta bankowego, wyrażasz zgodę na niniejsze <a class="underline" href="https://stripe.com/au-becs-dd-service-agreement/legal">Żądanie Polecenia Zapłaty oraz Umowę o świadczenie usługi Żądania Polecenia Zapłaty</a> , a także upoważniasz Stripe Payments Australia Pty Ltd ACN 160 180 343, numer identyfikacyjny użytkownika polecenia zapłaty 507156 („Stripe”) do obciążania Twojego konta za pośrednictwem Systemu Elektronicznych Rozliczeń Zbiorczych (BECS) w imieniu :company („Sprzedawca”) wszelkimi kwotami oddzielnie przekazanymi Ci przez Sprzedawcę. Oświadczasz, że jesteś posiadaczem konta lub osobą upoważnioną do podpisu na koncie wymienionym powyżej.',
    'you_need_to_accept_the_terms_before_proceeding' => 'Aby kontynuować, musisz zaakceptować warunki.',
    'direct_debit' => 'Polecenie zapłaty',
    'clone_to_expense' => 'Klonuj jako wydatek',
    'checkout' => 'Wymeldować się',
    'acss' => 'Karta debetowa ACSS',
    'invalid_amount' => 'Nieprawidłowa ilość. Użyj tylko wartości liczbowych.',
    'client_payment_failure_body' => 'Płatność za fakturę :invoice na kwotę :amount nie powiodła się.',
    ...
    'gocardless_mandate_not_ready' => 'Polecenie zapłaty nie jest gotowe. Spróbuj ponownie później.',
    'payment_type_instant_bank_pay' => 'Natychmiastowa płatność bankowa',
    'payment_type_iDEAL' => 'ideał',
    'payment_type_Przelewy24' => 'Przelewy24',
    'payment_type_Mollie Bank Transfer' => 'Przelew bankowy Mollie',
    'payment_type_KBC/CBC' => 'KBC/CBC',
    'payment_type_Instant Bank Pay' => 'Natychmiastowa płatność bankowa',
    'payment_type_Hosted Page' => 'Strona hostowana',
    'payment_type_GiroPay' => 'GiroPay',
    'payment_type_EPS' => 'EPS',
    'payment_type_Direct Debit' => 'Polecenie zapłaty',
    'payment_type_Bancontact' => 'Bancontact',
    'payment_type_BECS' => 'BECS',
    'payment_type_ACSS' => 'ACSS',
    'gross_line_total' => 'Suma brutto',
    'lang_Slovak' => 'słowacki',
    'normal' => 'Normalna',
    'large' => 'Duży',
    ...
    'instant_bank_pay' => 'Natychmiastowa płatność bankowa',
    'click_selected' => 'Kliknięcie zaznaczonego',
    'hide_preview' => 'Ukryj podgląd',
    'edit_record' => 'Edycja rekordu',
    'credit_is_more_than_invoice' => 'Kwota kredytu nie może być wyższa niż kwota faktury',
    ...
    'disconnected_gateway' => 'Pomyślnie odłączono bramę',
    'disconnect' => 'Odłączyć',
    'add_to_invoices' => 'Dodaj do faktur',
    'bulk_download' => 'Pobierz',
    'persist_data_help' => 'Zapisz dane lokalnie, aby umożliwić szybsze uruchomienie aplikacji. Wyłączenie tej opcji może poprawić wydajność na dużych kontach.',
    'persist_ui' => 'Trwały interfejs użytkownika',
    'persist_ui_help' => 'Zapisz stan interfejsu użytkownika lokalnie, aby umożliwić aplikacji uruchomienie się w ostatniej lokalizacji. Wyłączenie tej opcji może poprawić wydajność.',
    'client_postal_code' => 'Kod pocztowy Klienta',
    'client_vat_number' => 'Numer VAT Klienta',
    'has_tasks' => 'Ma zadania',
    'registration' => 'Rejestracja',
    'unauthorized_stripe_warning' => 'Prosimy o zezwolenie firmie Stripe na przyjmowanie płatności online.',
    'update_all_records' => 'Zaktualizuj wszystkie rekordy',
    'set_default_company' => 'Ustaw domyślną firmę',
    'updated_company' => 'Pomyślnie zaktualizowano firmę',
    'kbc' => 'KBC',
    'why_are_you_leaving' => 'Pomóż nam się ulepszyć, podając nam powód (opcjonalnie)',
    'webhook_success' => 'Sukces webhooka',
    'error_cross_client_tasks' => 'Wszystkie zadania muszą należeć do tego samego klienta',
    'error_cross_client_expenses' => 'Wszystkie wydatki muszą należeć do tego samego klienta',
    'app' => 'Aplikacja',
    'for_best_performance' => 'Aby uzyskać najlepszą wydajność, pobierz aplikację :app',
    'bulk_email_invoice' => 'Faktura e-mail',
    'bulk_email_quote' => 'Wyślij ofertę',
    'bulk_email_credit' => 'Kredyt e-mailowy',
    'removed_recurring_expense' => 'Pomyślnie usunięto wydatek cykliczny',
    ...
    'include_drafts' => 'Uwzględnij wersje robocze',
    'include_drafts_help' => 'Uwzględnij projekty rekordów w raportach',
    'is_invoiced' => 'Jest fakturowany',
    'change_plan' => 'Zarządzaj planem',
    'persist_data' => 'Trwałe dane',
    'customer_count' => 'Liczba klientów',
    'verify_customers' => 'Weryfikuj Klientów',
    'google_analytics_tracking_id' => 'Identyfikator śledzenia Google Analytics',
    ...
    'use_web_app_to_connect_gmail' => 'Proszę użyć aplikacji internetowej, aby połączyć się z Gmailem',
    'expense_tax_help' => 'Stawki podatku od towarów są wyłączone',
    'enable_markdown' => 'Włącz Markdown',
    'enable_markdown_help' => 'Konwertuj znaczniki Markdown na HTML w pliku PDF',
    'add_second_contact' => 'Dodaj drugi kontakt',
    'previous_page' => 'Poprzednia strona',
    'next_page' => 'Następna strona',
    'export_colors' => 'Eksportuj kolory',
    'import_colors' => 'Importuj kolory',
    'clear_all' => 'Wyczyść wszystko',
    'contrast' => 'Kontrast',
    'custom_colors' => 'Niestandardowe kolory',
    'colors' => 'Kolory',
    'sidebar_active_background_color' => 'Kolor tła aktywnego paska bocznego',
    'sidebar_active_font_color' => 'Kolor czcionki aktywnego paska bocznego',
    'sidebar_inactive_background_color' => 'Kolor tła nieaktywnego paska bocznego',
    'sidebar_inactive_font_color' => 'Kolor czcionki nieaktywnego paska bocznego',
    'table_alternate_row_background_color' => 'Alternatywny kolor tła wiersza tabeli',
    'invoice_header_background_color' => 'Kolor tła nagłówka faktury',
    'invoice_header_font_color' => 'Kolor czcionki nagłówka faktury',
    'review_app' => 'Przejrzyj aplikację',
    'check_status' => 'Sprawdź status',
    'free_trial' => 'Bezpłatny okres próbny',
    'free_trial_help' => 'Wszystkie konta otrzymują dwutygodniowy okres próbny planu Pro. Po zakończeniu okresu próbnego konto automatycznie zmieni się na plan bezpłatny.',
    'free_trial_ends_in_days' => 'Okres próbny planu Pro kończy się za :count dni, kliknij, aby dokonać uaktualnienia.',
    ...
    'client_portal_domain_hint' => 'Opcjonalnie skonfiguruj osobną domenę portalu klienta',
    'tasks_shown_in_portal' => 'Zadania wyświetlane w portalu',
    'uninvoiced' => 'Niezafakturowane',
    'subdomain_guide' => 'Subdomena jest używana w portalu klienta do personalizacji linków, tak aby odpowiadały Twojej marce, np. https://twoja-marka.invoicing.co',
    ...
    'json' => 'JSON',
    'no_payment_types_enabled' => 'Brak włączonych typów płatności',
    'wait_for_data' => 'Proszę czekać na zakończenie ładowania danych',
    'net_total' => 'Razem netto',
    'has_taxes' => 'Zawiera podatki',
    'import_customers' => 'Klienci importowi',
    'imported_customers' => 'Pomyślnie rozpoczęto importowanie klientów',
    'login_success' => 'Pomyślne logowanie',
    'login_failure' => 'Nieudane logowanie',
    'exported_data' => 'Gdy plik będzie gotowy, otrzymasz wiadomość e-mail z linkiem do pobrania',
    ...
    'step_1_sign_in' => 'Krok 1: Zaloguj się',
    'step_2_authorize' => 'Krok 2: Autoryzacja',
    'account_id' => 'Identyfikator konta',
    'migration_not_yet_completed' => 'Migracja jeszcze się nie zakończyła',
    'show_task_end_date' => 'Pokaż datę zakończenia zadania',
    'show_task_end_date_help' => 'Włącz określanie daty zakończenia zadania',
    'gateway_setup' => 'Konfiguracja bramy',
    'preview_sidebar' => 'Podgląd paska bocznego',
    'years_data_shown' => 'Wyświetlane dane za lata',
    'ended_all_sessions' => 'Wszystkie sesje zostały pomyślnie zakończone',
    'end_all_sessions' => 'Zakończ wszystkie sesje',
    'count_session' => '1 sesja',
    'count_sessions' => 'Sesje :count',
    ...
    'order' => 'Zamówienie',
    'search_kanban' => 'Wyszukaj Kanban',
    'search_kanbans' => 'Wyszukaj Kanban',
    'move_top' => 'Przesuń na początek',
    'move_up' => 'Przesuń w górę',
    'move_down' => 'Przesuń w dół',
    'move_bottom' => 'Przesuń na koniec',
    'body_variable_missing' => 'Błąd: niestandardowy adres e-mail musi zawierać zmienną :body',
    'add_body_variable_message' => 'Pamiętaj o uwzględnieniu zmiennej :body',
    ...
    'quote_valid_until' => 'Oferta ważna do',
    'no_headers' => 'Brak nagłówków',
    'add_header' => 'Dodaj nagłówek',
    'remove_header' => 'Usuń nagłówek',
    'return_url' => 'Adres URL powrotu',
    'rest_method' => 'Metoda REST',
    'header_key' => 'Klucz nagłówka',
    'header_value' => 'Wartość nagłówka',
    'recurring_products' => 'Produkty cykliczne',
    'promo_discount' => 'Rabat promocyjny',
    'allow_cancellation' => 'Zezwalaj na anulowania',
    'per_seat_enabled' => 'Włączone na miejsce',
    'max_seats_limit' => 'Maksymalna liczba miejsc',
    'trial_enabled' => 'Wersja testowa włączona',
    'trial_duration' => 'Czas trwania okresu próbnego',
    'allow_query_overrides' => 'Zezwalaj na nadpisywanie zapytań',
    'allow_plan_changes' => 'Zezwalaj na zmiany planu',
    'plan_map' => 'Plan mapy',
    'refund_period' => 'Okres zwrotu',
    'webhook_configuration' => 'Konfiguracja webhooka',
    'purchase_page' => 'Strona zakupu',
    'email_bounced' => 'E-mail niedostarczony',
    'email_spam_complaint' => 'Skarga na spam',
    'email_delivery' => 'Dostarczanie wiadomości e-mail',
    'webhook_response' => 'Odpowiedź webhooka',
    'pdf_response' => 'Odpowiedź PDF',
    'authentication_failure' => 'Błąd uwierzytelniania',
    'pdf_failed' => 'Niepowodzenie pliku PDF',
    'pdf_success' => 'Sukces PDF',
    'modified' => 'Zmodyfikowano',
    'html_mode' => 'Tryb HTML',
    'html_mode_help' => 'Podgląd jest szybszy, ale jest mniej dokładny',
    'status_color_theme' => 'Motyw kolorów statusu',
    ...
    'wait_for_loading' => 'Ładowanie danych – proszę czekać na zakończenie',
    'wait_for_saving' => 'Zapisywanie danych – proszę czekać na zakończenie',
    'html_preview_warning' => 'Uwaga: zmiany wprowadzone w tym miejscu są dostępne tylko w podglądzie, należy je zastosować w kartach powyżej, aby je zapisać',
    'remaining' => 'Pozostały',
    'invoice_paid' => 'Faktura zapłacona',
    'activity_120' => ':user utworzył cykliczny wydatek :recurring_expense',
    'activity_121' => ':user zaktualizowano cykliczne wydatki :recurring_expense',
    ...
    'unsubscribed_text' => 'Usunięto Cię z powiadomień dotyczących tego dokumentu',
    'client_shipping_state' => 'Stan wysyłki klienta',
    'client_shipping_city' => 'Klient Wysyłka Miasto',
    'client_shipping_postal_code' => 'Kod pocztowy wysyłki klienta',
    'client_shipping_country' => 'Kraj wysyłki klienta',
    'load_pdf' => 'Załaduj PDF',
    'start_free_trial' => 'Rozpocznij bezpłatny okres próbny',
    'start_free_trial_message' => 'Rozpocznij BEZPŁATNY 14-dniowy okres próbny Planu Pro',
    'due_on_receipt' => 'Należne po otrzymaniu',
    'is_paid' => 'Zapłacone',
    ...
    'small' => 'Mały',
    'quotes_backup_subject' => 'Twoje oferty są gotowe do pobrania',
    'credits_backup_subject' => 'Twoje kredyty są gotowe do pobrania',
    ...
    'enable_touch_events_help' => 'Obsługa zdarzeń przeciągania w celu przewijania',
    'after_saving' => 'Po zapisaniu',
    'view_record' => 'Podgląd rekordu',
    'enable_email_markdown' => 'Włącz Markdown e-mailowy',
    'enable_email_markdown_help' => 'Użyj wizualnego edytora Markdown do wiadomości e-mail',
    'enable_pdf_markdown' => 'Włącz znaczniki PDF',
    'json_help' => 'Uwaga: pliki JSON generowane przez aplikację v4 nie są obsługiwane',
    ...
    'approved_quotes' => 'Pomyślnie zatwierdzono oferty :value',
    'client_website' => 'Strona internetowa klienta',
    'invalid_time' => 'Nieprawidłowy czas',
    'signed_in_as' => 'Zalogowany jako',
    'total_results' => 'Wyniki ogółem',
    'restore_company_gateway' => 'Przywróć bramę',
    'archive_company_gateway' => 'Brama archiwum',
    'delete_company_gateway' => 'Usuń bramę',
    ...
    'auto_archive_invoice_cancelled_help' => 'Automatycznie archiwizuj faktury po ich anulowaniu',
    ...
    'auto_archive_cancelled_invoices_help' => 'Automatycznie archiwizuj faktury po ich anulowaniu.',
    ...
    'download_report_description' => 'Aby sprawdzić swój raport, zapoznaj się z załączonym plikiem.',
    'left' => 'Do lewej',
    'right' => 'Do prawej',
    'center' => 'Do środka',
    ...
    'inventory_notification_subject' => 'Powiadomienie o progu zapasów dla produktu: :product',
    'inventory_notification_body' => 'Osiągnięto próg :amount dla produktu: :product',
    'activity_130' => ':user utworzył zamówienie zakupu :purchase_order',
    'activity_131' => ':user zaktualizowano zamówienie zakupu :purchase_order',
    'activity_132' => ':user zarchiwizowane zamówienie zakupu :purchase_order',
    'activity_133' => ':user usunięto zamówienie zakupu :purchase_order',
    'activity_134' => ':user przywrócił zamówienie zakupu :purchase_order',
    'activity_135' => ':user zamówienie zakupu wysłane e-mailem :purchase_order',
    'activity_136' => ':contact przeglądał zamówienie zakupu :purchase_order',
    'purchase_order_subject' => 'Nowe zamówienie zakupu :number od :account',
    'purchase_order_message' => 'Aby wyświetlić zamówienie na :amount , kliknij poniższy link.',
    'view_purchase_order' => 'Zobacz zamówienie',
    'purchase_orders_backup_subject' => 'Twoje zamówienia są gotowe do pobrania',
    'notification_purchase_order_viewed_subject' => 'Zamówienie zakupu :invoice zostało wyświetlone przez :client',
    'notification_purchase_order_viewed' => 'Następujący sprzedawca :client przeglądał zamówienie zakupu :invoice dla :amount .',
    ...
    'activity_137' => ':contact zaakceptowano zamówienie zakupu :purchase_order',
    'vendor_information' => 'Informacje o sprzedawcy',
    'notification_purchase_order_accepted_subject' => 'Zamówienie zakupu :purchase_order zostało przyjęte przez :vendor',
    'notification_purchase_order_accepted' => 'Następujący sprzedawca :vendor zaakceptował zamówienie zakupu :purchase_order na :amount .',
    ...
    'yes_its_great' => 'Tak, jest wspaniale!',
    ...
    'enable_flexible_search_help' => 'Dopasuj znaki nieciągłe, np. „ct” pasuje do „cat”',
    'vendor_details' => 'Szczegóły dostawcy',
    'purchase_order_details' => 'Szczegóły zamówienia',
    'qr_iban' => 'Kod QR IBAN',
    'besr_id' => 'Identyfikator BESR',
    'clone_to_purchase_order' => 'Klonuj do PO',
    'vendor_email_not_set' => 'Sprzedawca nie ma ustawionego adresu e-mail',
    'bulk_send_email' => 'Wyślij Email',
    'marked_purchase_order_as_sent' => 'Zamówienie zakupu zostało pomyślnie oznaczone jako wysłane',
    'marked_purchase_orders_as_sent' => 'Pomyślnie oznaczono zamówienia zakupu jako wysłane',
    'accepted_purchase_order' => 'Zamówienie zakupu zostało pomyślnie przyjęte',
    'accepted_purchase_orders' => 'Pomyślnie zaakceptowane zamówienia zakupu',
    'cancelled_purchase_order' => 'Pomyślnie anulowano zamówienie zakupu',
    'cancelled_purchase_orders' => 'Pomyślnie anulowano zamówienia zakupu',
    'please_select_a_vendor' => 'Proszę wybrać dostawcę',
    'purchase_order_total' => 'Całkowita wartość zamówienia zakupu',
    'email_purchase_order' => 'Zamówienie zakupu e-mailem',
    'bulk_email_purchase_order' => 'Zamówienie zakupu e-mailem',
    ...
    'emailed_purchase_order' => 'Zamówienie zakupu zostało pomyślnie umieszczone w kolejce do wysłania',
    'emailed_purchase_orders' => 'Zamówienia zakupu zostały pomyślnie umieszczone w kolejce do wysłania',
    'enable_react_app' => 'Zmiana na aplikację internetową React',
    'purchase_order_design' => 'Projekt zamówienia zakupu',
    'purchase_order_terms' => 'Warunki zamówienia zakupu',
    'purchase_order_footer' => 'Stopka zamówienia zakupu',
    ...
    'enable_applying_payments' => 'Nadpłaty ręczne',
    'enable_applying_payments_help' => 'Wsparcie dla ręcznego dodawania kwoty nadpłaty w płatności',
    ...
    'total_active_quotes' => 'Aktywne notowania',
    'total_approved_quotes' => 'Zatwierdzone oferty',
    'total_unapproved_quotes' => 'Niezatwierdzone oferty',
    'total_logged_tasks' => 'Zapisane zadania',
    'total_invoiced_tasks' => 'Zadania fakturowane',
    'total_paid_tasks' => 'Zadania płatne',
    'total_logged_expenses' => 'Zarejestrowane wydatki',
    'total_pending_expenses' => 'Oczekujące wydatki',
    'total_invoiced_expenses' => 'Zafakturowane wydatki',
    'total_invoice_paid_expenses' => 'Wydatki zapłacone na fakturze',
    'vendor_portal' => 'Portal dostawcy',
    'send_code' => 'Wyślij kod',
    'save_to_upload_documents' => 'Zapisz rekord, aby przesłać dokumenty',
    'expense_tax_rates' => 'Stawki podatku od wydatków',
    ...
    'bulk_email_purchase_orders' => 'Zamówienia zakupu e-mailem',
    'bulk_email_invoices' => 'Faktury e-mail',
    'bulk_email_quotes' => 'Cytaty e-mailowe',
    'bulk_email_credits' => 'Kredyty e-mailowe',
    'archive_purchase_order' => 'Archiwum zamówień zakupu',
    'restore_purchase_order' => 'Przywróć zamówienie zakupu',
    'delete_purchase_order' => 'Usuń zamówienie zakupu',
    'connect' => 'Połącz',
    'mark_paid_payment_email' => 'Oznacz płatny e-mail z płatnością',
    'convert_to_project' => 'Konwertuj na projekt',
    'client_email' => 'E-mail klienta',
    'invoice_task_project' => 'Projekt zadania fakturowania',
    'invoice_task_project_help' => 'Dodaj projekt do pozycji faktury',
    'bulk_action' => 'Akcja zbiorcza',
    'phone_validation_error' => 'Ten numer telefonu komórkowego jest nieprawidłowy, proszę wpisać w formacie E.164',
    'transaction' => 'Transakcja',
    'disable_2fa' => 'Wyłącz 2FA',
    'change_number' => 'Zmień numer',
    'resend_code' => 'Wyślij ponownie kod',
    'base_type' => 'Typ podstawowy',
    'category_type' => 'Typ kategorii',
    'bank_transaction' => 'Transakcja',
    'bulk_print' => 'Drukuj PDF',
    'vendor_postal_code' => 'Kod pocztowy sprzedawcy',
    'preview_location' => 'Podgląd lokalizacji',
    'bottom' => 'Spód',
    'side' => 'Strona',
    'pdf_preview' => 'Podgląd PDF',
    'long_press_to_select' => 'Naciśnij i przytrzymaj, aby wybrać',
    'purchase_order_item' => 'Pozycja zamówienia zakupu',
    'would_you_rate_the_app' => 'Czy chcesz ocenić aplikację?',
    'include_deleted' => 'Uwzględnij usunięte',
    'include_deleted_help' => 'Uwzględnij usunięte rekordy w raportach',
    'due_on' => 'Należne do',
    'browser_pdf_viewer' => 'Użyj przeglądarki PDF Viewer',
    'browser_pdf_viewer_help' => 'Ostrzeżenie: uniemożliwia interakcję z aplikacją za pośrednictwem pliku PDF',
    'converted_transactions' => 'Pomyślnie przekonwertowane transakcje',
    'default_category' => 'Kategoria domyślna',
    'connect_accounts' => 'Połącz konta',
    'manage_rules' => 'Zarządzaj regułami',
    'search_category' => 'Wyszukaj 1 kategorię',
    'search_categories' => 'Wyszukaj kategorie :count',
    'min_amount' => 'Minimalna kwota',
    'max_amount' => 'Maksymalna kwota',
    'converted_transaction' => 'Transakcja została pomyślnie przekonwertowana',
    'convert_to_payment' => 'Konwertuj na płatność',
    'deposit' => 'Depozyt',
    'withdrawal' => 'Wypłata',
    'deposits' => 'Depozyty',
    'withdrawals' => 'Wypłaty',
    ...
    'search_transactions' => 'Wyszukaj transakcje :count',
    'deleted_bank_account' => 'Pomyślnie usunięto konto bankowe',
    'removed_bank_account' => 'Pomyślnie usunięto konto bankowe',
    'restored_bank_account' => 'Pomyślnie przywrócone konto bankowe',
    'search_bank_account' => 'Wyszukaj konto bankowe',
    'search_bank_accounts' => 'Wyszukaj konta bankowe :count',
    'code_was_sent_to' => 'Kod został wysłany SMS-em na numer :number',
    'verify_phone_number_2fa_help' => 'Zweryfikuj swój numer telefonu, aby utworzyć kopię zapasową 2FA',
    'enable_applying_payments_later' => 'Włącz opcję późniejszego stosowania płatności',
    'line_item_tax_rates' => 'Stawki podatku od pozycji wiersza',
    'show_tasks_in_client_portal' => 'Pokaż zadania w portalu klienta',
    'notification_quote_expired_subject' => 'Cytat :invoice wygasł dla :client',
    'notification_quote_expired' => 'Poniższy cytat :invoice dla klienta :client i :amount stracił ważność.',
    'auto_sync' => 'Automatyczna synchronizacja',
    'refresh_accounts' => 'Odśwież konta',
    'upgrade_to_connect_bank_account' => 'Przejdź na wersję Enterprise, aby połączyć swoje konto bankowe',
    'click_here_to_connect_bank_account' => 'Kliknij tutaj, aby połączyć swoje konto bankowe',
    'include_tax' => 'Uwzględnij podatek',
    'email_template_change' => 'Treść szablonu wiadomości e-mail można zmienić',
    'task_update_authorization_error' => 'Niewystarczające uprawnienia lub zadanie może być zablokowane',
    'cash_vs_accrual' => 'Rachunkowość memoriałowa',
    'cash_vs_accrual_help' => 'Włącz, aby raportować metodą memoriałową, wyłącz, aby raportować metodą kasową.',
    'expense_paid_report' => 'Sprawozdanie z wydatków',
    ...
    'linked_transaction' => 'Pomyślnie powiązano transakcję',
    'link_payment' => 'Płatność za pomocą łącza',
    'link_expense' => 'Koszt łącza',
    'lock_invoiced_tasks' => 'Zablokuj zafakturowane zadania',
    'lock_invoiced_tasks_help' => 'Zapobiegaj edycji zadań po wystawieniu faktury',
    'registration_required_help' => 'Wymagaj od klientów rejestracji',
    'use_inventory_management' => 'Włącz zarządzanie zapasami',
    'use_inventory_management_help' => 'Wymagaj, aby produkty były dostępne w magazynie',
    'optional_products' => 'Produkty opcjonalne',
    'optional_recurring_products' => 'Opcjonalne produkty cykliczne',
    'convert_matched' => 'Konwertować',
    'auto_billed_invoice' => 'Pomyślnie dodano fakturę do kolejki do automatycznego rozliczenia',
    'auto_billed_invoices' => 'Pomyślnie ustawiono faktury w kolejce do automatycznego fakturowania',
    'operator' => 'Operator',
    'value' => 'Wartość',
    'is' => 'Jest',
    'contains' => 'Zawiera',
    ...
    'match_all_rules' => 'Dopasuj wszystkie zasady',
    'match_all_rules_help' => 'Aby zastosować regułę, wszystkie kryteria muszą być spełnione.',
    'auto_convert_help' => 'Automatyczna konwersja dopasowanych transakcji na wydatki',
    'rules' => 'Reguły',
    'transaction_rule' => 'Reguła transakcji',
    'transaction_rules' => 'Zasady transakcji',
    'new_transaction_rule' => 'Nowa reguła transakcji',
    'edit_transaction_rule' => 'Edytuj regułę transakcji',
    ...
    'archived_transaction_rule' => 'Pomyślnie zarchiwizowano regułę transakcji',
    'deleted_transaction_rule' => 'Pomyślnie usunięto regułę transakcji',
    'removed_transaction_rule' => 'Pomyślnie usunięto regułę transakcji',
    'restored_transaction_rule' => 'Pomyślnie przywrócono regułę transakcji',
    'search_transaction_rule' => 'Reguła transakcji wyszukiwania',
    'search_transaction_rules' => 'Wyszukaj reguły transakcji',
    'payment_type_Interac E-Transfer' => 'Interac E-Transfer',
    'delete_bank_account' => 'Usuń konto bankowe',
    'archive_transaction' => 'Archiwum transakcji',
    ...
    'notification_purchase_order_created_body' => 'Następujące zamówienie zakupu :purchase_order zostało utworzone dla sprzedawcy :vendor na :amount .',
    'notification_purchase_order_created_subject' => 'Zamówienie zakupu :purchase_order zostało utworzone dla :vendor',
    'notification_purchase_order_sent_subject' => 'Zamówienie zakupu :purchase_order zostało wysłane na adres :vendor',
    'notification_purchase_order_sent' => 'Do następującego sprzedawcy :vendor wysłano e-mailem zamówienie zakupu :purchase_order na :amount .',
    ...
    'credit_payment_error' => 'Kwota kredytu nie może być większa od kwoty płatności',
    ...
    'matomo_url' => 'Adres URL Matomo',
    'matomo_id' => 'Identyfikator Matomo',
    'action_add_to_invoice' => 'Dodaj do faktury',
    'danger_zone' => 'Strefa zagrożenia',
    'import_completed' => 'Import zakończony',
    'client_statement_body' => 'W załączniku znajduje się Twoje oświadczenie z :start _date do :end _date.',
    'email_queued' => 'E-mail w kolejce',
    'clone_to_recurring_invoice' => 'Klonuj do faktury cyklicznej',
    'inventory_threshold' => 'Próg zapasów',
    'emailed_statement' => 'Pomyślnie umieszczono w kolejce oświadczenie do wysłania',
    'show_email_footer' => 'Pokaż stopkę w e-mailach',
    'invoice_task_hours' => 'Godziny zadania fakturowania',
    'invoice_task_hours_help' => 'Dodaj godziny do pozycji faktury',
    'auto_bill_standard_invoices' => 'Standardowe faktury Auto Bill',
    'auto_bill_recurring_invoices' => 'Automatyczne fakturowanie cykliczne',
    'email_alignment' => 'Wyrównanie treści e-maili',
    'pdf_preview_location' => 'Lokalizacja podglądu PDF',
    'mailgun' => 'Mailgun',
    'brevo' => 'Brevo',
    'postmark' => 'Postmark',
    'microsoft' => 'Microsoft',
    'click_plus_to_create_record' => 'Kliknij +, aby utworzyć rekord',
    'last365_days' => 'Ostatnie 365 dni',
    'import_design' => 'Importuj projekt',
    'imported_design' => 'Pomyślnie zaimportowany projekt',
    'invalid_design' => 'Projekt jest nieprawidłowy, brakuje sekcji :value',
    ...
    'update_payment' => 'Aktualizacja płatności',
    'markup' => 'Markup',
    'unlock_pro' => 'Odblokuj Pro',
    'upgrade_to_paid_plan_to_schedule' => 'Przejdź na plan płatny, aby tworzyć harmonogramy',
    ...
    'only_clients_with_invoices' => 'Tylko klienci z fakturami',
    'email_statement' => 'Wyciąg e-mailowy',
    'once' => 'Raz',
    ...
    'update_purchase_order' => 'Aktualizacja zamówienia zakupu',
    'sent_invoice' => 'Faktura wysłana',
    'sent_quote' => 'Oferta wysłana',
    'sent_credit' => 'Wysłano kredyt',
    'sent_purchase_order' => 'Wysłano zamówienie zakupu',
    'image_url' => 'Adres URL obrazu',
    'max_quantity' => 'Ilość maksymalna',
    'test_url' => 'Testowy adres URL',
    'auto_bill_help_off' => 'Opcja nie jest wyświetlana',
    'auto_bill_help_optin' => 'Opcja jest wyświetlana, ale nie została wybrana',
    'auto_bill_help_optout' => 'Opcja jest wyświetlana i wybrana',
    'auto_bill_help_always' => 'Opcja nie jest wyświetlana',
    'view_all' => 'Zobacz wszystko',
    'edit_all' => 'Edytuj wszystko',
    ...
    'from_email' => 'Z e-maila',
    'show_preview' => 'Pokaż podgląd',
    'show_paid_stamp' => 'Pokaż stempel zapłacone',
    'show_shipping_address' => 'Pokaż adres wysyłki',
    'no_documents_to_download' => 'W wybranych rekordach nie ma dokumentów do pobrania',
    'pixels' => 'Pikseli',
    'logo_size' => 'Rozmiar logo',
    'failed' => 'Nieudane',
    'client_contacts' => 'Kontakty z klientami',
    'sync_from' => 'Synchronizuj z',
    'gateway_payment_text' => 'Faktury: :invoice dla :amount dla klienta :client',
    'gateway_payment_text_no_invoice' => 'Płatność bez faktury na kwotę :amount dla klienta :client',
    'click_to_variables' => 'Kliknij tutaj, aby zobaczyć wszystkie zmienne.',
    'ship_to' => 'Dostawa do',
    'stripe_direct_debit_details' => 'Proszę o dokonanie wpłaty na wskazane powyżej konto bankowe.',
    'branch_name' => 'Nazwa oddziału',
    'branch_code' => 'Kod oddziału',
    'bank_name' => 'Nazwa banku',
    'bank_code' => 'Kod banku',
    'bic' => 'BIC',
    'change_plan_description' => 'Zmień plan na wyższy lub niższy.',
    'add_company_logo' => 'Dodaj logo',
    'add_stripe' => 'Dodaj pasek',
    'invalid_coupon' => 'Nieprawidłowy kupon',
    'no_assigned_tasks' => 'Brak zadań podlegających rozliczeniu dla tego projektu',
    ...
    'white_label_body' => 'Dziękujemy za zakup licencji white label.<br><br> Twój klucz licencyjny to:<br><br> :license_key<br><br> Możesz zarządzać swoją licencją tutaj: https://invoiceninja.invoicing.co/client/login',
    ...
    'number_of_payments_helper' => 'Liczba razy, w której zostanie dokonana ta płatność',
    ...
    'client_initiated_payments_help' => 'Wsparcie dokonywania płatności w portalu klienta bez faktury',
    'share_invoice_quote_columns' => 'Udostępnij kolumny faktur/ofert',
    'cc_email' => 'Adres e-mail w kopercie',
    'payment_balance' => 'Saldo płatności',
    'view_report_permission' => 'Zezwól użytkownikowi na dostęp do raportów, dane są ograniczone do dostępnych uprawnień',
    'activity_138' => 'Płatność :payment została wysłana e-mailem na adres :client',
    'one_time_products' => 'Produkty jednorazowe',
    'optional_one_time_products' => 'Opcjonalne produkty jednorazowe',
    'required' => 'Wymagane',
    'hidden' => 'Ukryte',
    'payment_links' => 'Linki płatnicze',
    'payment_link' => 'Link do płatności',
    'new_payment_link' => 'Nowy link do płatności',
    'edit_payment_link' => 'Edytuj link płatności',
    'created_payment_link' => 'Pomyślnie utworzono link do płatności',
    'updated_payment_link' => 'Pomyślnie zaktualizowano link płatności',
    'archived_payment_link' => 'Pomyślnie zarchiwizowano link do płatności',
    'deleted_payment_link' => 'Pomyślnie usunięto link do płatności',
    'removed_payment_link' => 'Pomyślnie usunięto link do płatności',
    'restored_payment_link' => 'Pomyślnie przywrócono link płatniczy',
    'search_payment_link' => 'Wyszukaj 1 Link do płatności',
    'search_payment_links' => 'Wyszukaj :count Linki płatnicze',
    'increase_prices' => 'Podwyżka cen',
    'update_prices' => 'Aktualizuj ceny',
    'incresed_prices' => 'Udało się ustawić ceny w kolejce do podwyżki',
    'updated_prices' => 'Pomyślnie dodano ceny do kolejki w celu aktualizacji',
    'api_token' => 'Token API',
    'api_key' => 'Klucz API',
    'endpoint' => 'Punkt końcowy',
    'not_billable' => 'Nie podlega rozliczeniu',
    'allow_billable_task_items' => 'Zezwalaj na rozliczalne elementy zadań',
    'allow_billable_task_items_help' => 'Włącz konfigurację elementów zadań, które są rozliczane',
    'show_task_item_description' => 'Pokaż opis elementu zadania',
    'show_task_item_description_help' => 'Włącz określanie opisów elementów zadań',
    'email_record' => 'Rekord e-maila',
    'invoice_product_columns' => 'Kolumny produktów na fakturze',
    'quote_product_columns' => 'Kolumny produktów cytatowych',
    'vendors' => 'Dostawcy',
    'product_sales' => 'Sprzedaż produktów',
    'user_sales_report_header' => 'Raport sprzedaży użytkownika dla klienta/klientów :client z :start _date do :end _date',
    'client_balance_report' => 'Raport salda klienta',
    'client_sales_report' => 'Raport sprzedaży klienta',
    'user_sales_report' => 'Raport sprzedaży użytkownika',
    'aged_receivable_detailed_report' => 'Szczegółowy raport o przeterminowanych należnościach',
    'aged_receivable_summary_report' => 'Raport podsumowujący przeterminowane należności',
    'taxable_amount' => 'Kwota podlegająca opodatkowaniu',
    'tax_summary' => 'Podsumowanie podatkowe',
    'oauth_mail' => 'OAuth / Poczta',
    'preferences' => 'Preferencje',
    'analytics' => 'Analityka',
    'reduced_rate' => 'Obniżona stawka',
    'tax_all' => 'Podatek od wszystkiego',
    'tax_selected' => 'Podatek wybrany',
    'version' => 'wersja',
    'seller_subregion' => 'Podregion sprzedawcy',
    'calculate_taxes' => 'Oblicz podatki',
    'calculate_taxes_help' => 'Automatyczne obliczanie podatków podczas zapisywania faktur',
    'link_expenses' => 'Koszty łącza',
    'converted_client_balance' => 'Przekonwertowane saldo klienta',
    'converted_payment_balance' => 'Saldo płatności przeliczonych',
    'total_hours' => 'Razem godzin',
    'date_picker_hint' => 'Użyj +days, aby ustawić datę w przyszłości',
    'app_help_link' => 'Więcej informacji ',
    'here' => 'Tutaj',
    'industry_Restaurant & Catering' => 'Restauracja i catering',
    'show_credits_table' => 'Pokaż tabelę kredytową',
    'manual_payment' => 'Instrukcja płatności',
    'tax_summary_report' => 'Raport podsumowujący podatek',
    'tax_category' => 'Kategoria podatku',
    'physical_goods' => 'Dobra fizyczne',
    'digital_products' => 'Produkty cyfrowe',
    'services' => 'Usługi',
    'shipping' => 'Wysyłka',
    'tax_exempt' => 'Zwolniony z podatku',
    'late_fee_added_locked_invoice' => 'Dodano opłatę za opóźnienie w fakturze :invoice na :date',
    'lang_Khmer' => 'Khmer',
    'routing_id' => 'Identyfikator routingu',
    'enable_e_invoice' => 'Włącz e-fakturę',
    'e_invoice_type' => 'Typ e-faktury',
    'reduced_tax' => 'Obniżony podatek',
    'override_tax' => 'Nadpisanie podatku',
    'zero_rated' => 'Ocena zerowa',
    'reverse_tax' => 'Podatek odwrócony',
    'updated_tax_category' => 'Pomyślnie zaktualizowano kategorię podatku',
    'updated_tax_categories' => 'Pomyślnie zaktualizowano kategorie podatkowe',
    'set_tax_category' => 'Ustaw kategorię podatku',
    'payment_manual' => 'Instrukcja płatności',
    'expense_payment_type' => 'Rodzaj płatności wydatków',
    'payment_type_Cash App' => 'Aplikacja gotówkowa',
    'rename' => 'Zmień nazwę',
    'renamed_document' => 'Pomyślnie zmieniono nazwę dokumentu',
    'e_invoice' => 'E-faktura',
    ...
    'order_id' => 'Zamówienie',
    'total_invoices_outstanding' => 'Łączna liczba faktur do zapłaty',
    'recent_activity' => 'Ostatnia aktywność',
    'enable_auto_bill' => 'Włącz automatyczne rozliczanie',
    'email_count_invoices' => 'Wyślij faktury e-mailem :count',
    'invoice_task_item_description' => 'Opis elementu zadania faktury',
    'invoice_task_item_description_help' => 'Dodaj opis pozycji do pozycji faktury',
    'next_send_time' => 'Następny czas wysłania',
    'uploaded_certificate' => 'Pomyślnie przesłano certyfikat',
    'certificate_set' => 'Zestaw certyfikatów',
    'certificate_not_set' => 'Certyfikat nie został ustawiony',
    'passphrase_set' => 'Zestaw haseł',
    'passphrase_not_set' => 'Hasło nie zostało ustawione',
    'upload_certificate' => 'Prześlij certyfikat',
    'certificate_passphrase' => 'Hasło certyfikatu',
    'valid_vat_number' => 'Prawidłowy numer VAT',
    'react_notification_link' => 'Linki do powiadomień React',
    'react_notification_link_help' => 'Wiadomości e-mail administratora będą zawierać linki do aplikacji React',
    'show_task_billable' => 'Pokaż zadanie do rozliczenia',
    'credit_item' => 'Pozycja kredytowa',
    'drop_file_here' => 'Tutaj upuść plik',
    'files' => 'Pliki',
    'camera' => 'Aparat',
    'gallery' => 'Galeria',
    'project_location' => 'Lokalizacja projektu',
    'add_gateway_help_message' => 'Dodaj bramkę płatniczą (np. Stripe, WePay lub PayPal), aby akceptować płatności online',
    'lang_Hungarian' => 'Węgierski',
    'use_mobile_to_manage_plan' => 'Użyj ustawień abonamentu telefonicznego, aby zarządzać swoim planem',
    'item_tax3' => 'Podatek od pozycji 3',
    'item_tax_rate1' => 'Stawka podatku od pozycji 1',
    'item_tax_rate2' => 'Stawka podatku od pozycji 2',
    'item_tax_rate3' => 'Stawka podatku od pozycji 3',
    'buy_price' => 'Cena zakupu',
    'country_Macedonia' => 'Macedonia',
    'admin_initiated_payments' => 'Płatności inicjowane przez administratora',
    'admin_initiated_payments_help' => 'Wsparcie wprowadzania płatności w portalu administracyjnym bez faktury',
    'paid_date' => 'Data zapłaty',
    'downloaded_entities' => 'Pliki PDF zostaną wysłane e-mailem',
    'lang_French - Swiss' => 'Francusko-szwajcarski',
    'currency_swazi_lilangeni' => 'Suazi Lilangeni',
    'income' => 'Dochód',
    'amount_received_help' => 'Wpisz tutaj wartość, jeśli całkowita otrzymana kwota była WIĘKSZA niż kwota na fakturze lub jeśli rejestrujesz płatność bez faktur. W przeciwnym razie to pole należy pozostawić puste.',
    'vendor_phone' => 'Telefon sprzedawcy',
    'mercado_pago' => 'Mercado Pago',
    'mybank' => 'Mój Bank',
    'paypal_paylater' => 'Zapłać w 4',
    'district' => 'Dzielnica',
    'region' => 'Region',
    'county' => 'Hrabstwo',
    'tax_details' => 'Szczegóły podatkowe',
    'activity_10_online' => ':contact dokonał płatności :payment za fakturę :invoice za :client',
    'activity_10_manual' => ':user wprowadzono płatność :payment za fakturę :invoice dla :client',
    'default_payment_type' => 'Domyślny typ płatności',
    'number_precision' => 'Precyzja liczbowa',
    'number_precision_help' => 'Kontroluje liczbę miejsc dziesiętnych obsługiwanych w interfejsie',
    'is_tax_exempt' => 'Zwolniony z podatku',
    'drop_files_here' => 'Upuść pliki tutaj',
    'upload_files' => 'Prześlij pliki',
    'download_e_invoice' => 'Pobierz e-fakturę',
    'download_e_credit' => 'Pobierz E-Kredyt',
    'download_e_quote' => 'Pobierz ofertę elektroniczną',
    'triangular_tax_info' => 'Transakcja trójstronna wewnątrzwspólnotowa',
    'intracommunity_tax_info' => 'Dostawa wewnątrzwspólnotowa wolna od podatku',
    'reverse_tax_info' => 'Należy pamiętać, że ta dostawa podlega odwrotnemu obciążeniu',
    'currency_nicaraguan_cordoba' => 'Nikaraguańska Kordoba',
    'public' => 'Publiczny',
    'private' => 'Prywatny',
    'image' => 'Obraz',
    'other' => 'Inny',
    'linked_to' => 'Połączony z',
    'file_saved_in_path' => 'Plik został zapisany w :path',
    'unlinked_transactions' => 'Pomyślnie odłączono transakcje :count',
    'unlinked_transaction' => 'Pomyślnie odłączono transakcję',
    'view_dashboard_permission' => 'Zezwól użytkownikowi na dostęp do pulpitu nawigacyjnego, dane są ograniczone do dostępnych uprawnień',
    'marked_sent_credits' => 'Pomyślnie oznaczone kredyty zostały wysłane',
    'show_document_preview' => 'Pokaż podgląd dokumentu',
    'cash_accounting' => 'Rachunkowość kasowa',
    'click_or_drop_files_here' => 'Kliknij lub upuść pliki tutaj',
    'set_public' => 'Ustaw jako publiczny',
    'set_private' => 'Ustaw jako prywatny',
    ...
    'government' => 'Rząd',
    'in_stock_quantity' => 'Ilość magazynowa',
    'vendor_contact' => 'Kontakt ze sprzedawcą',
    'expense_status_4' => 'Nie zapłacony',
    'expense_status_5' => 'Płatny',
    'ziptax_help' => 'Uwaga: ta funkcja wymaga klucza API Zip-Tax do wyszukiwania podatku od sprzedaży w USA według adresu',
    'cache_data' => 'Dane pamięci podręcznej',
    'unknown' => 'Nieznany',
    'webhook_failure' => 'Błąd webhooka',
    'email_opened' => 'Otwarto e-mail',
    'email_delivered' => 'E-mail dostarczony',
    'log' => 'Dziennik',
    'classification' => 'Klasyfikacja',
    'stock_quantity_number' => 'Stan magazynowy: ilość',
    'upcoming' => 'Nadchodzące',
    'client_contact' => 'Kontakt z klientem',
    'uncategorized' => 'Bez kategorii',
    'login_notification' => 'Powiadomienie o logowaniu',
    'login_notification_help' => 'Wysyła wiadomość e-mail informującą o dokonaniu logowania.',
    'payment_refund_receipt' => 'Potwierdzenie zwrotu płatności nr :number',
    'payment_receipt' => 'Potwierdzenie płatności nr :number',
    'load_template_description' => 'Szablon zostanie zastosowany do następujących elementów:',
    'run_template' => 'Uruchom szablon',
    'statement_design' => 'Projekt oświadczenia',
    'delivery_note_design' => 'Projekt listu przewozowego',
    'payment_receipt_design' => 'Projekt potwierdzenia płatności',
    'payment_refund_design' => 'Projekt zwrotu płatności',
    'task_extension_banner' => 'Dodaj rozszerzenie Chrome, aby zarządzać swoimi zadaniami',
    'watch_video' => 'Obejrzyj wideo',
    'view_extension' => 'Rozszerzenie widoku',
    'reactivate_email' => 'Reaktywuj e-mail',
    'email_reactivated' => 'Pomyślnie reaktywowano e-mail',
    'template_help' => 'Włącz używanie projektu jako szablonu',
    'quarter' => 'Kwartał',
    'item_description' => 'Opis przedmiotu',
    'task_item' => 'Element zadania',
    'record_state' => 'Stan rekordu',
    'save_files_to_this_folder' => 'Zapisz pliki w tym folderze',
    'downloads_folder' => 'Folder pobierania',
    'total_invoiced_quotes' => 'Oferty fakturowane',
    'total_invoice_paid_quotes' => 'Oferty zapłaconych faktur',
    'downloads_folder_does_not_exist' => 'Folder pobierania nie istnieje :value',
    'user_logged_in_notification' => 'Powiadomienie o zalogowaniu użytkownika',
    'user_logged_in_notification_help' => 'Wyślij wiadomość e-mail po zalogowaniu się z nowej lokalizacji',
    'payment_email_all_contacts' => 'E-mail z płatnością do wszystkich kontaktów',
    'payment_email_all_contacts_help' => 'Wysyła e-mail z informacją o płatności do wszystkich kontaktów, jeśli ta opcja jest włączona',
    'add_line' => 'Dodaj linię',
    'activity_139' => 'Powiadomienie o wydatkach :expense zostało wysłane do :contact',
    'vendor_notification_subject' => 'Potwierdzenie płatności :amount wysłane na adres :vendor',
    'vendor_notification_body' => 'Płatność za :amount z dnia :payment _date została przetworzona.<br> [Numer referencyjny transakcji: :transaction_reference ]',
    'receipt' => 'Paragon',
    'charges' => 'Opłaty',
    'email_report' => 'Raport e-mail',
    'payment_type_Pay Later' => 'Zapłać później',
    'payment_type_credit' => 'Rodzaj płatności Kredyt',
    'payment_type_debit' => 'Rodzaj płatności Debet',
    'send_emails_to' => 'Wyślij e-maile do',
    'primary_contact' => 'Główny kontakt',
    'all_contacts' => 'Wszystkie kontakty',
    'insert_below' => 'Wstaw poniżej',
    'nordigen_handler_subtitle' => 'Uwierzytelnianie konta bankowego. Wybierz swoją instytucję, aby uzupełnić wniosek o dane uwierzytelniające Twojego konta.',
    'nordigen_handler_error_heading_unknown' => 'Wystąpił błąd',
    'nordigen_handler_error_contents_unknown' => 'Wystąpił nieznany błąd! Powód:',
    'nordigen_handler_error_heading_token_invalid' => 'Nieprawidłowy token',
    'nordigen_handler_error_contents_token_invalid' => 'Podany token był nieprawidłowy. Jeśli problem będzie się powtarzał, skontaktuj się z pomocą techniczną.',
    'nordigen_handler_error_heading_account_config_invalid' => 'Brak danych uwierzytelniających',
    'nordigen_handler_error_contents_account_config_invalid' => 'Nieprawidłowe lub brakujące dane uwierzytelniające dla konta bankowego Gocardless. Skontaktuj się z pomocą techniczną, jeśli problem będzie się powtarzał.',
    'nordigen_handler_error_heading_not_available' => 'Niedostępne',
    'nordigen_handler_error_contents_not_available' => 'Funkcja niedostępna, dotyczy tylko planu Enterprise.',
    'nordigen_handler_error_heading_institution_invalid' => 'Nieprawidłowa instytucja',
    'nordigen_handler_error_contents_institution_invalid' => 'Podany identyfikator instytucji jest nieprawidłowy lub nie jest już ważny.',
    'nordigen_handler_error_heading_ref_invalid' => 'Nieprawidłowe odniesienie',
    'nordigen_handler_error_contents_ref_invalid' => 'GoCardless nie podał prawidłowego odniesienia. Uruchom ponownie proces i skontaktuj się z pomocą techniczną, jeśli problem będzie się powtarzał.',
    'nordigen_handler_error_heading_eua_failure' => 'Niepowodzenie EUA',
    'nordigen_handler_error_contents_eua_failure' => 'Wystąpił błąd podczas tworzenia Umowy Użytkownika Końcowego:',
    'nordigen_handler_error_heading_not_found' => 'Nieprawidłowe zapotrzebowanie',
    'nordigen_handler_error_contents_not_found' => 'GoCardless nie podał prawidłowego odniesienia. Uruchom ponownie proces i skontaktuj się z pomocą techniczną, jeśli problem będzie się powtarzał.',
    'nordigen_handler_error_heading_requisition_invalid_status' => 'Nie gotowy',
    'nordigen_handler_error_contents_requisition_invalid_status' => 'Wywołanie tej witryny nastąpiło zbyt wcześnie. Zakończ autoryzację i odśwież tę stronę. Skontaktuj się z pomocą techniczną, jeśli problem będzie się powtarzał.',
    'nordigen_handler_error_heading_requisition_no_accounts' => 'Nie wybrano żadnych kont',
    'nordigen_handler_error_contents_requisition_no_accounts' => 'Usługa nie zwróciła żadnych prawidłowych kont. Rozważ ponowne uruchomienie przepływu.',
    'nordigen_handler_restart' => 'Uruchom ponownie przepływ.',
    'nordigen_handler_return' => 'Powrót do aplikacji.',
    'lang_Lao' => 'Laotański',
    'currency_lao_kip' => 'Laotański kip',
    'yodlee_regions' => 'Regiony: USA, Wielka Brytania, Australia i Indie',
    'nordigen_regions' => 'Regiony: Europa i Wielka Brytania',
    'select_provider' => 'Wybierz dostawcę',
    'nordigen_requisition_subject' => 'Zamówienie wygasło, proszę o ponowne uwierzytelnienie.',
    'nordigen_requisition_body' => 'Dostęp do danych z kont bankowych wygasł zgodnie z postanowieniami Umowy użytkownika końcowego.<br><br> Zaloguj się do Red Invoice i ponownie uwierzytelnij się w swoim banku, aby móc nadal otrzymywać transakcje.',
    'participant' => 'Uczestnik',
    'participant_name' => 'Imię i nazwisko uczestnika',
    'client_unsubscribed' => 'Klient zrezygnował z subskrypcji wiadomości e-mail.',
    'client_unsubscribed_help' => 'Klient :client zrezygnował z subskrypcji Twoich wiadomości e-mail. Klient musi wyrazić zgodę na otrzymywanie od Ciebie kolejnych wiadomości e-mail.',
    'resubscribe' => 'Subskrybuj ponownie',
    'subscribe' => 'Subskrybować',
    'subscribe_help' => 'Jesteś obecnie zapisany na listę i nadal będziesz otrzymywać wiadomości e-mail.',
    'unsubscribe_help' => 'Obecnie nie jesteś zapisany na listę i nie będziesz otrzymywać wiadomości e-mail.',
    'notification_purchase_order_bounced' => 'Nie udało się dostarczyć zamówienia zakupu :invoice do :contact .<br><br> :error',
    'notification_purchase_order_bounced_subject' => 'Nie można dostarczyć zamówienia zakupu :invoice',
    'show_pdfhtml_on_mobile' => 'Wyświetl wersję HTML podczas przeglądania na urządzeniu mobilnym',
    'show_pdfhtml_on_mobile_help' => 'W celu lepszej wizualizacji wyświetla wersję HTML faktury/oferty podczas przeglądania na urządzeniu mobilnym.',
    'please_select_an_invoice_or_credit' => 'Proszę wybrać fakturę lub kredyt',
    'mobile_version' => 'Wersja mobilna',
    'venmo' => 'Venmo',
    'my_bank' => 'Mój Bank',
    'pay_later' => 'Zapłać później',
    'local_domain' => 'Domena lokalna',
    'verify_peer' => 'Zweryfikuj Peera',
    'nordigen_help' => 'Uwaga: połączenie konta wymaga klucza API GoCardless/Nordigen',
    'ar_detailed' => 'Szczegółowe informacje o należnościach',
    'ar_summary' => 'Podsumowanie należności',
    'client_sales' => 'Sprzedaż dla klientów',
    'user_sales' => 'Sprzedaż użytkowników',
    'iframe_url' => 'Adres URL iFrame',
    'user_unsubscribed' => 'Użytkownik zrezygnował z subskrypcji wiadomości e-mail :link',
    'out_of_stock' => 'Brak w magazynie',
    'step_dependency_fail' => 'Komponent „:step” wymaga, aby co najmniej jedna z jego zależności („:dependencies”) znajdowała się na liście.',
    'step_dependency_order_fail' => 'Komponent „:step” zależy od „:dependency”. Upewnij się, że kolejność komponentów jest prawidłowa.',
    'step_authentication_fail' => 'Należy uwzględnić co najmniej jedną z metod uwierzytelniania.',
    'auth.login' => 'Login',
    'auth.login-or-register' => 'Zaloguj się lub zarejestruj',
    'auth.register' => 'Rejestr',
    'cart' => 'Wózek',
    'methods' => 'Metody',
    ...
    'gateway_type' => 'Typ bramy',
    'save_template_body' => 'Czy chcesz zapisać to mapowanie importu jako szablon do wykorzystania w przyszłości?',
    'save_as_template' => 'Zapisz mapowanie szablonu',
    'checkout_only_for_existing_customers' => 'Płatność jest dostępna tylko dla obecnych klientów. Zaloguj się na istniejące konto, aby dokonać płatności.',
    'checkout_only_for_new_customers' => 'Płatność jest dostępna tylko dla nowych klientów. Aby dokonać płatności, zarejestruj nowe konto.',
    'auto_bill_standard_invoices_help' => 'Automatyczne wystawianie standardowych faktur w terminie płatności',
    'auto_bill_on_help' => 'Automatyczne fakturowanie w dniu wysłania LUB terminie płatności (faktury cykliczne)',
    'use_available_credits_help' => 'Przed obciążeniem metody płatności należy zastosować wszelkie salda kredytowe do płatności',
    'use_unapplied_payments' => 'Użyj niezastosowanych płatności',
    'use_unapplied_payments_help' => 'Przed obciążeniem metody płatności należy zastosować saldo płatności',
    'payment_terms_help' => 'Liczba dni od daty wystawienia faktury, w której płatność jest wymagana',
    'payment_type_help' => 'Domyślny typ płatności używany w przypadku płatności',
    'quote_valid_until_help' => 'Liczba dni ważności oferty',
    'expense_payment_type_help' => 'Domyślny typ płatności wydatków, który ma być używany',
    'paylater' => 'Zapłać w 4',
    'payment_provider' => 'Dostawca płatności',
    'select_email_provider' => 'Ustaw swój adres e-mail jako użytkownika wysyłającego',
    'purchase_order_items' => 'Pozycje zamówienia zakupu',
    'csv_rows_length' => 'W tym pliku CSV nie znaleziono danych',
    'accept_payments_online' => 'Akceptuj płatności online',
    'all_payment_gateways' => 'Wyświetl wszystkie bramki płatnicze',
    'product_cost' => 'Koszt produktu',
    'duration_words' => 'Czas trwania w słowach',
    'upcoming_recurring_invoices' => 'Nadchodzące faktury cykliczne',
    'shipping_country_id' => 'Kraj wysyłki',
    'show_table_footer' => 'Pokaż stopkę tabeli',
    'show_table_footer_help' => 'Wyświetla sumy w stopce tabeli',
    'total_invoices' => 'Łączna liczba faktur',
    'add_to_group' => 'Dodaj do grupy',
    'check_credentials' => 'Sprawdź uprawnienia',
    'valid_credentials' => 'Poświadczenia są ważne',
    'e_quote' => 'E-wycena',
    'e_credit' => 'E-kredyt',
    'e_purchase_order' => 'Zamówienie elektroniczne',
    'e_quote_type' => 'Typ oferty elektronicznej',
    'unlock_unlimited_clients' => 'Zaktualizuj swój plan, aby odblokować nieograniczoną liczbę klientów!',
    'download_e_purchase_order' => 'Pobierz zamówienie elektroniczne',
    'flutter_web_warning' => 'Aby uzyskać najlepszą wydajność, zalecamy korzystanie z nowej aplikacji internetowej lub aplikacji na komputery stacjonarne',
    'rappen_rounding' => 'Zaokrąglanie Rappen',
    'rappen_rounding_help' => 'Zaokrąglić kwotę do 5 centów',
    'assign_group' => 'Przypisz grupę',
    'paypal_advanced_cards' => 'Zaawansowane płatności kartą',
    'local_domain_help' => 'Domena EHLO (opcjonalnie)',
    'port_help' => 'tj. 25 587 465',
    'host_help' => 'tj. smtp.gmail.com',
    'always_show_required_fields' => 'Zawsze pokazuj wymagane pola formularza',
    'always_show_required_fields_help' => 'Wyświetla wymagane pola formularza zawsze podczas realizacji transakcji',
    'advanced_cards' => 'Karty zaawansowane',
    'activity_140' => 'Oświadczenie wysłane do :client',
    'invoice_net_amount' => 'Kwota netto faktury',
    'round_to_minutes' => 'Zaokrąglij do minut',
    '1_second' => '1 sekunda',
    '1_minute' => '1 minuta',
    '5_minutes' => '5 minut',
    '15_minutes' => '15 minut',
    ...
    '1_hour' => '1 godzina',
    '1_day' => '1 dzień',
    'round_tasks' => 'Kierunek zaokrąglania zadań',
    'round_tasks_help' => 'Zaokrąglaj czas wykonywania zadań w górę lub w dół.',
    'direction' => 'Kierunek',
    'round_up' => 'Spędzać bydlę',
    'round_down' => 'Zaokrąglić w dół',
    'task_round_to_nearest' => 'Zaokrąglij do najbliższego',
    'task_round_to_nearest_help' => 'Interwał, do którego należy zaokrąglić zadanie.',
    'bulk_updated' => 'Pomyślnie zaktualizowano dane',
    'bulk_update' => 'Aktualizacja zbiorcza',
    'calculate' => 'Obliczać',
    'sum' => 'Suma',
    'money' => 'Pieniądze',
    'web_app' => 'Aplikacja internetowa',
    'desktop_app' => 'Aplikacja na komputer',
    'disconnected' => 'Bezładny',
    'reconnect' => 'Na nowo połączyć',
    'e_invoice_settings' => 'Ustawienia e-faktury',
    'btcpay_refund_subject' => 'Zwrot faktury za pośrednictwem BTCPay',
    'btcpay_refund_body' => 'Zwrot pieniędzy został dla Ciebie zrealizowany. Aby go otrzymać za pośrednictwem BTCPay, kliknij ten link:',
    'currency_mauritanian_ouguiya' => 'Mauretańska Ouguiya',
    'currency_bhutan_ngultrum' => 'Bhutan Ngultrum',
    'end_of_month' => 'Koniec miesiąca',
    'merge_e_invoice_to_pdf' => 'Połącz e-fakturę i plik PDF',
    'task_assigned_subject' => 'Nowe przypisanie zadania [Zadanie :task ] [ :date ]',
    'task_assigned_body' => 'Zostało Ci przypisane zadanie :task<br><br> Opis: :description<br><br> Klient: :client',
    'activity_141' => 'Użytkownik :user wprowadził notatkę: :notes',
    'quote_reminder_subject' => 'Przypomnienie: Podaj kod :quote z :company',
    'quote_reminder_message' => 'Przypomnienie o ofercie :number dla :amount',
    'quote_reminder1' => 'Przypomnienie o pierwszym cytacie',
    'before_valid_until_date' => 'Przed datą ważności',
    'after_valid_until_date' => 'Po upływie terminu ważności',
    'after_quote_date' => 'Po dacie wyceny',
    'remind_quote' => 'Przypomnij cytat',
    'end_of_month' => 'Koniec miesiąca',
    'tax_currency_mismatch' => 'Waluta podatku różni się od waluty faktury',
    'edocument_import_already_exists' => 'Faktura została już zaimportowana na :date',
    'before_valid_until' => 'Przed datą ważności do',
    'after_valid_until' => 'Po upływie terminu ważności do',
    'task_assigned_notification' => 'Powiadomienie o przydzielonym zadaniu',
    'task_assigned_notification_help' => 'Wyślij wiadomość e-mail po przypisaniu zadania',
    'invoices_locked_end_of_month' => 'Faktury są blokowane na koniec miesiąca',
    'referral_url' => 'Adres URL polecający',
    'add_comment' => 'Dodaj komentarz',
    'added_comment' => 'Komentarz został pomyślnie zapisany',
    'tickets' => 'Bilety',
    'assigned_group' => 'Grupa została pomyślnie przypisana',
    'merge_to_pdf' => 'Scal do PDF',
    'latest_requires_php_version' => 'Uwaga: najnowsza wersja wymaga PHP :version',
    'auto_expand_product_table_notes' => 'Automatyczne rozszerzanie notatek w tabeli produktów',
    'auto_expand_product_table_notes_help' => 'Automatycznie rozszerza sekcję notatek w tabeli produktów, aby wyświetlić więcej wierszy.',
    'institution_number' => 'Numer instytucji',
    'transit_number' => 'Numer tranzytowy',
    'personal' => 'Osobisty',
    'address_information' => 'Informacje adresowe',
    'enter_the_information_for_the_bank_account' => 'Wprowadź dane konta bankowego',
    'account_holder_information' => 'Informacje o posiadaczu konta',
    'enter_information_for_the_account_holder' => 'Wprowadź informacje dotyczące posiadacza konta',
    'customer_type' => 'Typ klienta',
    'process_date' => 'Data procesu',
    'forever_free' => 'Na zawsze wolny',
    'comments_only' => 'Tylko komentarze',
    'payment_balance_on_file' => 'Saldo płatności w pliku',
    'ubl_email_attachment_help' => 'Więcej ustawień faktury elektronicznej znajdziesz tutaj',
    'stop_task_to_add_task_entry' => 'Przed dodaniem nowego elementu należy zatrzymać zadanie.',
    'xml_file' => 'Plik XML',
    'one_page_checkout' => 'Płatność jednostronicowa',
    'one_page_checkout_help' => 'Włącz nowy, jednostronicowy przepływ płatności',
    'applies_to' => 'Dotyczy',
    'accept_purchase_order' => 'Akceptuj zamówienie zakupu',
    'round_to_seconds' => 'Zaokrąglij do sekund',
    'activity_142' => 'Cytat :quote przypomnienie 1 wysłane',
    'activity_143' => 'Auto Bill pomyślnie zrealizowany dla faktury :invoice',
    'activity_144' => 'Nie udało się wystawić faktury automatycznej dla :invoice . :notes',
    'activity_145' => 'Została wysłana faktura elektroniczna :invoice dla :client . :notes',
    'payment_failed' => 'Płatność nie powiodła się',
    'ssl_host_override' => 'Nadpisanie hosta SSL',
    'upload_logo_short' => 'Prześlij logo',
    'country_Melilla' => 'Melilla',
    'country_Ceuta' => 'Ceuta',
    'country_Canary Islands' => 'Wyspy Kanaryjskie',
    'lang_Vietnamese' => 'wietnamski',
    'invoice_status_changed' => 'Informujemy, że status Twojej faktury został zaktualizowany. Zalecamy odświeżenie strony, aby wyświetlić jej najnowszą wersję.',
    'no_unread_notifications' => 'Jesteście na bieżąco! Brak nowych powiadomień.',
    'how_to_import_data' => 'Jak importować dane',
    'download_example_file' => 'Pobierz przykładowy plik',
    'expense_mailbox' => 'Adres e-mail przychodzący',
    'expense_mailbox_help' => 'Adres e-mail, na który przyjmowane są dokumenty dotyczące wydatków, np. cost@invoice.theredsun.org',
    'expense_mailbox_active' => 'Skrzynka pocztowa na wydatki',
    'expense_mailbox_active_help' => 'Umożliwia przetwarzanie dokumentów, takich jak paragony, w celu raportowania wydatków',
    'inbound_mailbox_allow_company_users' => 'Zezwalaj na nadawców firmowych',
    'inbound_mailbox_allow_company_users_help' => 'Umożliwia użytkownikom w firmie wysyłanie dokumentów wydatków.',
    'inbound_mailbox_allow_vendors' => 'Zezwalaj na nadawców dostawców',
    'inbound_mailbox_allow_vendors_help' => 'Umożliwia dostawcom firmy wysyłanie dokumentów wydatków',
    'inbound_mailbox_allow_clients' => 'Zezwalaj na nadawców klienckich',
    'inbound_mailbox_allow_clients_help' => 'Umożliwia klientom wysyłanie dokumentów wydatków',
    'inbound_mailbox_whitelist' => 'Lista dozwolonych nadawców przychodzących',
    'inbound_mailbox_whitelist_help' => 'Lista adresów e-mail rozdzielonych przecinkami, którym powinno być dozwolone wysyłanie wiadomości e-mail w celu przetworzenia',
    'inbound_mailbox_blacklist' => 'Lista zablokowanych nadawców przychodzących',
    'inbound_mailbox_blacklist_help' => 'Lista adresów e-mail, dla których nie wolno wysyłać wiadomości e-mail do przetworzenia, oddzielona przecinkami',
    'inbound_mailbox_allow_unknown' => 'Zezwól wszystkim nadawcom',
    'inbound_mailbox_allow_unknown_help' => 'Zezwól każdemu na wysłanie e-maila z informacją o wydatkach do przetworzenia',
    'quick_actions' => 'Szybkie akcje',
    'end_all_sessions_help' => 'Wylogowuje wszystkich użytkowników i wymaga ponownego uwierzytelnienia wszystkich aktywnych użytkowników.',
    'updated_records' => 'Zaktualizowane rekordy',
    'vat_not_registered' => 'Sprzedawca nie jest zarejestrowany jako podatnik VAT',
    'small_company_info' => 'Brak ujawnienia podatku od sprzedaży zgodnie z § 19 UStG',
    'peppol_onboarding' => 'Wygląda na to, że używasz PEPPOL-u po raz pierwszy.',
    'get_started' => 'Rozpocznij',
    'configure_peppol' => 'Skonfiguruj PEPPOL',
    'step' => 'Krok',
    'peppol_whitelabel_warning' => 'Aby korzystać z fakturowania elektronicznego w sieci PEPPOL wymagana jest licencja white-label.',
    'peppol_plan_warning' => 'Aby korzystać z fakturowania elektronicznego w sieci PEPPOL, wymagany jest plan Enterprise.',
    'peppol_credits_info' => 'Do wysyłania i odbierania faktur elektronicznych wymagane są e-kredyty. Opłata jest naliczana za każdy dokument.',
    'buy_credits' => 'Kup kredyty E',
    'peppol_successfully_configured' => 'PEPPOL został pomyślnie skonfigurowany.',
    'peppol_not_paid_message' => 'PEPPOL wymaga planu Enterprise. Proszę o uaktualnienie planu.',
    'peppol_country_not_supported' => 'Sieć PEPPOL nie jest jeszcze dostępna dla tego kraju.',
    'peppol_disconnect' => 'Rozłącz się z siecią PEPPOL',
    'peppol_disconnect_short' => 'Odłącz się od PEPPOL.',
    'peppol_disconnect_long' => 'Twój numer VAT zostanie usunięty z sieci PEPPOL po odłączeniu. Nie będziesz mógł wysyłać ani odbierać dokumentów elektronicznych.',
    'log_duration_words' => 'Czas trwania dziennika czasu w słowach',
    'log_duration' => 'Czas trwania dziennika czasu',
    'merged_vendors' => 'Pomyślnie połączono dostawców',
    'hidden_taxes_warning' => 'Niektóre podatki są ukryte ze względu na obecne ustawienia podatkowe. :link',
    'tax3' => 'Trzeci podatek',
    'negative_payment_warning' => 'Czy na pewno chcesz utworzyć płatność ujemną? Nie można jej użyć jako karty kredytowej ani płatności.',
    'currency_bermudian_dollar' => 'Dolar bermudzki',
    'currency_central_african_cfa_franc' => 'Frank CFA Afryki Środkowej',
    'currency_congolese_franc' => 'Frank kongijski',
    'currency_djiboutian_franc' => 'Frank dżibutyjski',
    'currency_eritrean_nakfa' => 'Erytrejska Nakfa',
    'currency_falkland_islands_pound' => 'Funt Falklandzki',
    'currency_guinean_franc' => 'Frank gwinejski',
    'currency_iraqi_dinar' => 'Dinar iracki',
    'currency_lesotho_loti' => 'Lesotho Loti',
    'currency_mongolian_tugrik' => 'Tugrik mongolski',
    'currency_seychellois_rupee' => 'rupia seszelska',
    'currency_solomon_islands_dollar' => 'Dolar Wysp Salomona',
    'currency_somali_shilling' => 'Szyling somalijski',
    'currency_south_sudanese_pound' => 'Funt południowosudański',
    'currency_sudanese_pound' => 'Funt sudański',
    'currency_tajikistani_somoni' => 'Somoni tadżycki',
    'currency_turkmenistani_manat' => 'Manat turkmeński',
    'currency_uzbekistani_som' => 'Som uzbecki',
    'payment_status_changed' => 'Informujemy, że status Twojej płatności został zaktualizowany. Zalecamy odświeżenie strony, aby wyświetlić aktualną wersję.',
    'credit_status_changed' => 'Informujemy, że status Twojego kredytu został zaktualizowany. Zalecamy odświeżenie strony, aby wyświetlić najnowszą wersję.',
    ...
    'peppol_token_description' => 'Token jest kolejnym krokiem w zapewnieniu bezpiecznego wysyłania faktur. W przeciwieństwie do licencji white-label, token można wymieniać w dowolnym momencie, bez konieczności oczekiwania na wsparcie Red Invoice.',
    'peppol_token_warning' => 'Aby kontynuować, musisz wygenerować token.',
    'generate_token' => 'Wygeneruj token',
    'total_credits_amount' => 'Ilość kredytów',
    'sales_above_threshold' => 'Sprzedaż powyżej progu',
    'changing_vat_and_id_number_note' => 'Po skonfigurowaniu konta PEPPOL nie można zmienić numeru VAT ani numeru identyfikacyjnego.',
    'iban_help' => 'Pełny numer IBAN',
    'bic_swift' => 'Kod BIC/Swift',
    'bic_swift_help' => 'Identyfikator banku',
    'payer_bank_account' => 'Numer konta bankowego płatnika',
    'payer_bank_account_help' => 'Numer rachunku bankowego płatnika',
    'bsb_sort' => 'BSB / Kod sortowania',
    'bsb_sort_help' => 'Kod oddziału banku',
    'card_type' => 'Typ karty',
    'card_type_help' => 'np. VISA, AMEX',
    'card_number_help' => 'tylko 4 ostatnie cyfry',
    'card_holder' => 'Imię i nazwisko posiadacza karty',
    'tokenize' => 'Tokenizować',
    'tokenize_help' => 'Tokenizacja metody płatności do wykorzystania w przyszłości.',
    'credit_card_stripe_help' => 'Akceptuj płatności kartą kredytową za pomocą Stripe.',
    'bank_transfer_stripe_help' => 'Polecenie zapłaty ACH. Płatności w USD, dostępna natychmiastowa weryfikacja.',
    'alipay_stripe_help' => 'Alipay umożliwia użytkownikom w Chinach bezpieczne płacenie przy użyciu portfeli mobilnych.',
    'sofort_stripe_help' => 'Sofort to popularna europejska metoda płatności umożliwiająca dokonywanie przelewów bankowych w czasie rzeczywistym, wykorzystywana głównie w Niemczech i Austrii.',
    'apple_pay_stripe_help' => 'Apple/Google Pay dla użytkowników urządzeń Apple/Android umożliwia łatwe dokonywanie płatności przy użyciu zapisanych danych karty.',
    'sepa_stripe_help' => 'Polecenie zapłaty SEPA (Jednolity Obszar Płatności w Euro).',
    'bancontact_stripe_help' => 'Bancontact jest powszechnie używaną metodą płatności w Belgii.',
    'ideal_stripe_help' => 'iDEAL jest najpopularniejszą metodą płatności w Holandii.',
    'giropay_stripe_help' => 'Giropay to niemiecka metoda płatności umożliwiająca bezpieczne i natychmiastowe przelewy bankowe online.',
    'przelewy24_stripe_help' => 'Przelewy24 to popularna metoda płatności w Polsce.',
    'direct_debit_stripe_help' => 'Przelewy bankowe Stripe za pośrednictwem wirtualnych kont bankowych Stripe, dostępne w Japonii, Wielkiej Brytanii, USA, Europie i Meksyku. Upewnij się, że ta opcja jest włączona w Stripe!',
    'eps_stripe_help' => 'EPS to austriacki system płatności online.',
    'acss_stripe_help' => 'ACSS (Automated Clearing Settlement System) Polecenie zapłaty dla kanadyjskich kont bankowych.',
    'becs_stripe_help' => 'Polecenie zapłaty BECS dla australijskich kont bankowych.',
    'klarna_stripe_help' => 'Klarna – kup teraz i zapłać później w ratach lub według ustalonego harmonogramu.',
    'bacs_stripe_help' => 'Polecenie zapłaty BACS dla kont bankowych w Wielkiej Brytanii, powszechnie stosowane w przypadku rozliczeń abonamentowych.',
    'fpx_stripe_help' => 'FPX to popularna metoda płatności online w Malezji.',
    'payment_means' => 'Środki płatności',
    'act_as_sender' => 'Wyślij e-fakturę',
    'act_as_receiver' => 'Otrzymaj e-fakturę',
    'saved_einvoice_details' => 'Zapisane ustawienia e-faktury',
    'add_license_to_env' => 'Twój klucz licencyjny będzie nam potrzebny do przyszłej komunikacji z naszymi usługami. Upewnij się, że zmienna środowiskowa to LICENSE_KEY.',
    'white_label_license_not_present' => 'Nie znaleziono licencji. Upewnij się, że zmienna środowiskowa LICENSE_KEY jest ustawiona.',
    'white_label_license_not_found' => 'Nie znaleziono licencji White Label.',
    'details_update_info' => 'Zaktualizujemy dane Twojej firmy o dostarczone informacje.',
    'sales_above_threshold' => 'Sprzedaż powyżej progu',
    'client_address_required' => 'Do fakturowania elektronicznego wymagany jest pełny adres klienta',
    'connected' => 'Połączony',
    'email_count_quotes' => 'Wyślij oferty e-mailem na :count',
    'activity_146' => 'E-faktura :invoice dla :client została pomyślnie dostarczona! :notes',
    'activity_147' => 'E-faktura :invoice dla :client nie została dostarczona. :notes',
    'peppol_routing_problem' => 'Problem z trasowaniem. Nie znaleziono odbiorcy/miejsca docelowego.',
    'peppol_sending_failed' => 'Problem techniczny z dostawą. Ponowna próba niemożliwa.',
    'peppol_cleared_for_sending' => 'Zatwierdzone przez organ podatkowy, wysłane do odbiorcy',
    'account_holder' => 'Nazwa konta',
    'account_holder_help' => 'Nazwa konta',
    'activity_148' => 'E-wydatek :expense otrzymany z :vendor',
    'additional_tax_identifiers' => 'Dodatkowe identyfikatory podatkowe',
    'additional_tax_identifiers_help' => 'Jeśli jesteś zarejestrowanym podatnikiem VAT w innych regionach, możesz tutaj dodać numery VAT dla tych regionów.',
    'configure' => 'Konfiguruj',
    'new_identifier' => 'Nowy numer VAT',
    'notification_credits_low' => 'Uwaga! Twoje saldo kredytowe jest niskie.',
    'notification_credits_low_text' => 'Dodaj środki do swojego konta, aby uniknąć przerw w świadczeniu usług.',
    'notification_no_credits' => 'Uwaga! Twoje saldo kredytowe jest puste.',
    'notification_no_credits_text' => 'Dodaj środki do swojego konta, aby uniknąć przerw w świadczeniu usług.',
    'saved_comment' => 'Komentarz zapisany',
    'acts_as_must_be_true' => 'Należy wybrać opcję „Wyślij fakturę elektroniczną” lub „Odbierz fakturę elektroniczną” (lub obie).',
    'delete_identifier' => 'Usuń identyfikator',
    'delete_identifier_description' => 'Usunięcie tego identyfikatora spowoduje usunięcie go z systemu. Przed kontynuowaniem upewnij się, że jest to właściwa czynność.',
    'einvoice_something_went_wrong' => 'Ups! Coś poszło nie tak. Skontaktuj się z nami pod adresem contact@invoice.theredsun.org, aby uzyskać więcej informacji.',
    'download_ready' => 'Twoje pobieranie jest już gotowe! [ :message ]',
    'notification_quote_reminder1_sent_subject' => 'Przypomnienie 1 dotyczące oferty :invoice zostało wysłane na :client',
    'custom_reminder_sent' => 'Niestandardowe przypomnienie zostało wysłane do :client',
    'use_system_fonts' => 'Użyj czcionek systemowych',
    'use_system_fonts_help' => 'Zastąp standardowe czcionki czcionkami z przeglądarki internetowej',
    'active_tasks' => 'Aktywne zadania',
    'enable_notifications' => 'Włącz powiadomienia',
    'enable_public_notifications' => 'Włącz powiadomienia publiczne',
    'enable_public_notifications_help' => 'Włącz powiadomienia w czasie rzeczywistym z Red Invoice.',
    'navigate' => 'Nawigować',
    'calculate_taxes_warning' => 'Ta akcja włączy podatki od pozycji i wyłączy podatki całkowite. Wszystkie otwarte faktury mogą zostać przeliczone z nowymi ustawieniami!',
    'activity_149' => ':user przesłał e-mailem informację o kredycie :credit za :client na adres :contact',
    'email_history_empty' => 'Nie znaleziono historii wiadomości e-mail. Funkcja ta jest dostępna tylko podczas wysyłania wiadomości za pomocą Postmark/Mailgun.',
    'e_invoicing' => 'E-fakturowanie',
    'einvoice_token_not_found' => 'Nie znaleziono tokena e-fakturowania. Przejdź do Ustawień &gt; E-faktura i wygeneruj ponownie token.',
    'regenerate' => 'Zregenerować',
    'subscription_unavailable' => 'Ten przedmiot nie jest już dostępny',
    'currency_samoan_tala' => 'Samoańska Tala',
    'confirm_duplicate_gateway' => 'Czy na pewno chcesz utworzyć inne połączenie?',
    'clients_limit' => 'Osiągnąłeś limit klientów. Zmień plan na wyższy.',
    'remaining_hours' => 'Pozostałe godziny',
    'just_now' => 'Właśnie',
    'yesterday' => 'Wczoraj',
    'enable_client_profile_update' => 'Zezwól klientom na aktualizację swojego profilu',
    'enable_client_profile_update_help' => 'Zezwól klientom na aktualizację informacji profilowych z poziomu portalu klienta',
    'preference_product_notes_for_html_view' => 'Użyj notatek dotyczących elementu w widoku HTML',
    'preference_product_notes_for_html_view_help' => 'Jeśli faktura jest wyświetlana w formacie HTML, wybierz opis przedmiotu zamiast tytułu przedmiotu.',
    'project_report' => 'Raport projektu',
    'unlock_invoice_documents_after_payment' => 'Odblokuj dokumenty po dokonaniu płatności',
    'unlock_invoice_documents_after_payment_help' => 'Umożliwia klientowi dostęp do dokumentów fakturowych po opłaceniu faktury',
    'quickbooks' => 'Quickbooks',
    'disable_emails' => 'Wyłącz wiadomości e-mail',
    'disable_emails_error' => 'Nie masz uprawnień do wysyłania wiadomości e-mail',
    'disable_emails_help' => 'Zapobiega użytkownikowi wysyłania wiadomości e-mail z systemu',
    'add_location' => 'Dodaj lokalizację',
    'updated_location' => 'Zaktualizowana lokalizacja',
    'created_location' => 'Utworzono lokalizację',
    'sync_send_time' => 'Synchronizuj czas wysyłania',
    'sync_send_time_help' => 'Zaktualizuj wszystkie przypomnienia/faktury cykliczne, aby użyć nowego czasu wysyłki',
    'edit_location' => 'Edytuj lokalizację',
    'downgrade' => 'Nachylenie',
    'downgrade_to_free' => 'Zmiana na plan bezpłatny',
    'downgrade_to_free_description' => 'Zmień plan na bezpłatny. Pamiętaj, że spowoduje to usunięcie wszystkich płatnych funkcji z Twojego konta.',
    'delete_location' => 'Usuń lokalizację',
    'delete_location_confirmation' => 'Spowoduje to usunięcie lokalizacji z rekordu klienta.',
    'add_card_reminder' => 'Możesz ponownie dodać kartę w dowolnym momencie.',
    'free_trial_then' => 'Bezpłatny okres próbny, a następnie',
    'days_left' => ':day pozostało 1 dzień',
    'days_trial' => ':day s day trial',
    'pro_plan_label' => 'Ninja Pro',
    'enterprise_plan_label' => 'Przedsiębiorstwo',
    'premium_business_plus_label' => 'Premium Biznes+',
    'pro_plan_feature_1' => 'Nieograniczona liczba klientów i faktur',
    'pro_plan_feature_2' => 'Usuń „Utworzone przez Red Invoice”',
    'pro_plan_feature_3' => 'Faktury e-mail za pośrednictwem Gmaila i Microsoft',
    'pro_plan_feature_4' => 'Wysyłaj faktury e-mailem za pomocą swojego niestandardowego SMTP',
    'pro_plan_feature_5' => 'Markowy adres URL: „YourSite”.Invoicing.co',
    'pro_plan_feature_6' => '11 profesjonalnych szablonów faktur',
    'pro_plan_feature_7' => 'Dostosuj projekty faktur',
    'pro_plan_feature_8' => 'Integracja API z aplikacjami innych firm',
    'pro_plan_feature_9' => 'Portal po stronie klienta chroniony hasłem',
    ...
    'pro_plan_feature_17' => 'Utwórz unikalne ustawienia „Grupy klientów”',
    'pro_plan_feature_18' => 'Obliczanie podatku od sprzedaży samochodów (stany USA)',
    'enterprise_plan_feature_1' => 'Dodatkowi użytkownicy konta i uprawnienia',
    'enterprise_plan_feature_2' => 'Prześlij i załącz pliki',
    'enterprise_plan_feature_3' => 'Niestandardowa domena portalu',
    'enterprise_plan_feature_4' => 'Synchronizacja konta bankowego',
    'premium_business_plus_feature_1' => 'Konsjerż programisty',
    'premium_business_plus_feature_2' => 'Bezpośrednie wsparcie priorytetowe',
    'premium_business_plus_feature_3' => 'Usługa projektowania faktur',
    'premium_business_plus_feature_4' => 'Priorytet żądania funkcji',
    'premium_business_plus_feature_5' => 'Pomoc w migracji danych',
    'premium_business_plus_feature_6' => 'Twórz niestandardowe raporty',
    'upgrade_popup_headline' => 'Więcej niż fakturowanie',
    'upgrade_popup_description' => 'Proste ceny. Zaawansowane funkcje.',
    'upgrade_popup_pro_headline' => 'Zapłać za rok za 10 miesięcy + 2 miesiące gratis!',
    ...
    'all_free_features_plus' => 'Wszystkie bezpłatne funkcje +',
    'all_pro_features_plus' => 'Wszystkie funkcje pro +',
    'all_features_plus' => 'Wszystkie funkcje +',
    'upgrade_plan' => 'Plan aktualizacji',
    'upgrade_popup_premium_business_plus_pricing' => 'Ceny? Porozmawiajmy!',
    'plan_selected' => 'Wybrany plan',
    'invalid_date_create_syntax' => 'Nieprawidłowa składnia daty',
    'start_and_end_date_required' => 'Data rozpoczęcia i zakończenia jest wymagana',
    'project_value' => 'Wartość projektu',
    'invalid_csv_data' => 'Nieprawidłowe dane CSV, import został anulowany.',
    'selected_products' => 'Wybrane produkty',
    'create_company_error_unauthorized' => 'Nie masz uprawnień do założenia firmy. Tylko właściciel konta może założyć firmę.',
    'deleted_location' => 'Lokalizacja usunięta',
    'currency_caribbean_guilder' => 'Karaibski gulden',
    'is_shipping' => 'Czy wysyłka',
    'added_location' => 'Pomyślnie dodano lokalizację',
    'send_emails' => 'Wysyłaj e-maile',
    'send_emails_permission' => 'Zezwól użytkownikowi na wysyłanie wiadomości e-mail',
    'cancel_trial' => 'Anuluj wersję próbną',
    'cancel_trial_description' => 'Spowoduje to anulowanie okresu próbnego i usunięcie wszystkich płatnych funkcji z Twojego konta.',
    'existing_gateway' => 'Brama już istnieje',
    'activity_150' => 'Konto usunięte :notes',
    'docuninja' => 'DocuNinja',
    'pro_rata' => 'Proporcjonalnie',
    'change_docuninja_plan' => 'Zmień plan DocuNinja',
    'downgrade_end_of_cycle' => 'Twój plan zostanie automatycznie obniżony pod koniec bieżącego cyklu rozliczeniowego.',
    'docuninja_change_users' => 'Nowy limit użytkowników DocuNinja',
    'docuninja_disable_warning' => 'Spowoduje to utratę wszelkiego dostępu do Twojego konta DocuNinja.',
    'docuninja_downgrade_info' => 'Limit użytkowników zostanie automatycznie zmniejszony pod koniec bieżącego cyklu rozliczeniowego.',
    'recurring_invoice_item' => 'Pozycja faktury cyklicznej',
    'disable_recurring_payment_notification' => 'Wyłącz powiadomienia o płatnościach cyklicznych',
    'disable_recurring_payment_notification_help' => 'Powiadomienia o pomyślnej płatności faktury cyklicznej nie będą wysyłane.',
    'invoice_outstanding_tasks' => 'Zadania z niezapłaconą fakturą',
    'payment_schedule' => 'Harmonogram płatności',
    'time_zone' => 'Strefa czasowa',
    'tax_names' => 'Nazwy podatkowe',
    'auto_bill_help' => 'Jeśli opcja jest włączona, po uruchomieniu harmonogramu zostanie podjęta próba automatycznego wystawienia faktury na zaplanowaną kwotę',
    'choose_schedule_type' => 'Wybierz typ harmonogramu',
    'split_payments' => 'Podzielone płatności',
    'split_payments_help' => 'Dzieli kwotę faktury na wiele płatności w określonym czasie, np. 4 płatności w ciągu 4 miesięcy',
    'custom_schedule' => 'Ręczne tworzenie niestandardowego harmonogramu płatności',
    'custom_schedule_help' => 'Utwórz niestandardowy harmonogram płatności, umożliwiający ustalenie dokładnych dat i kwot dla każdego harmonogramu',
    'schedule_frequency_help' => 'Odstęp czasu pomiędzy każdą płatnością',
    'first_payment_date' => 'Data pierwszej płatności',
    'first_payment_date_help' => 'Data pierwszej płatności',
    'payment_schedule_interval' => 'Płatność: indeks :total dla :amount',
    'payment_schedule_table' => 'Płatność: klucz na :date dla :amount',
    'auto_send' => 'Automatyczne wysyłanie',
    'auto_send_help' => 'Automatycznie wysyła fakturę e-mailem do klienta',
    'include_project_tasks' => 'Uwzględnij zadania projektu',
    'include_project_tasks_help' => 'Również fakturowanie zadań, które są częścią projektu',
    'tax_nexus' => 'Nexus podatkowy',
    'tax_period_report' => 'Raport okresu podatkowego',
