...
<li>"Вознаграждение за  :QUARTER+1 квартал" => "Вознаграждение за 2 квартал"</li>
    ...
    'agree_to_terms' => 'Я согласен с условиями Red Invoice :terms ',
    ...
    'pro_plan_feature3' => 'Настраиваемый URL - "ВашБренд.Red Invoice.com"',
    'pro_plan_feature4' => 'Удалить "Created by Red Invoice"',
...
Успешно созданы  :count_vendors Поставщик(и) и  :count_expenses и расход(ы)',
 ...
 Получив необходимые суммы, вернитесь к страницу «Способы Платеж и нажмите «Завершить проверку» рядом к нужным счетом.',
    ...
    'export_help' => 'Используйте JSON если вы планируете импортировать данные в Red Invoice.<br/>Файл вклчает клиентов, товары/услуги, счета, прайс-листы и платежи.',
    ...
    'white_label_license_error' => 'Не удалось к лицензию, истек срок действия или слишком много активаций. E-mail <span class=\'notranslate\'>к онта к т</span> @invoice.theredsun.org для получения дополнительной информации.',
    ...
    'local_part_help' => 'Настройте локальную часть входящего E-mail поддержки, например, YOUR_NAME@support.invoice.theredsun.org',
    ...
    'expense_mailbox_help' => 'Входящий адрес E-mail , на который принимаются документы расходы . то есть. расходы @invoice.theredsun.org',
    ...
    'einvoice_something_went_wrong' => 'Упс! Что-то пошло не так. контакт с нами по адресу контакт @invoice.theredsun.org для получения дополнительной информации.',
    ...
    'pro_plan_feature_2' => 'Удалить надпись "Created by Red Invoice"',
