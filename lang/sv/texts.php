...
$lang = array(
    ...
    'limit_clients' => 'Du har nått :count klientgränsen för gratiskonton. Grattis till din framgång!',
    ...
    'confirmation_subject' => 'Bekräfta ditt Red Invoice konto',
    ...
    'pro_plan_feature3' => 'Egna URLer - "dindoman.Red Invoice.com"',
    'pro_plan_feature4' => 'Radera "Skapad av Red Invoice"',
    ...
    'pro_plan_feature8' => 'Möjlighet att bifoga PDF-filer till klientens e-postmeddelanden',
    'resume' => 'Återuppta',
...
<p> Fakturor på en månadsvis eller årlig cykel, på eller före den dag de skapas kommer att bero på nästa månad. Fakturor som förfaller på den 29: e eller 30: e månader som inte har den dagen kommer att betalas den sista dagen i månaden. </ P> 
 ...
 <li> Är idagg en fredag, är förfallodagen den 1: a fredag efter. Förfallodagen kommer att vara nästa fredag, inte idag. 
    ...
    'overdue' => 'Försenat',
    'white_label_text' => 'Köp ETT ÅR white label licens för $:price för att ta bort bort Red Invoice referens från faktura och kundportal.',
    ...
    'pro_plan_remove_logo' => ':link för att ta bort Red Invoice-logotypen genom att uppgradera till Pro nivå',
    ...
    'invoice_embed_documents' => 'Bädda in bilder/dokument',
    'invoice_embed_documents_help' => 'Inkludera bifogade bilder/pdf-filer i fakturan.',
    ...
    'pro_plan_year_description' => 'Ett års registering på Red Invoice Pro nivå.',
    'pro_plan_month_description' => 'En månads registering på Red Invoice Pro nivå.',
    'enterprise_plan_product' => 'Enterprise nivå',
    'enterprise_plan_year_description' => 'Ett års registering på Red Invoice Enterprise nivån.',
    'enterprise_plan_month_description' => 'En månads registering på Red Invoice Enterprise nivån.',
...
När ni har pengarna, kom tillbaka till denna betalningsmetods sida och klicka på "Slutför verifikation" vid sidan om konto.',
    ...
    'export_help' => 'Använda JSON om du planerar att importera datan till Red Invoice.<br/>Filen innehåller kunder, produkter, fakturor, offerter och betalningar.',
...
Den här funktionen kräver att en produkt skapas och en betalningsgateway är konfigurerad.',
    ...
    'wepay_account_description' => 'Betalningsgateway för Red Invoice',
    ...
    'update_invoiceninja_title' => 'Uppdatera Red Invoice',
    'update_invoiceninja_warning' => 'Innan ni uppgraderar Red Invoice, skapa en backup av er databaser och filer!',
    'update_invoiceninja_available' => 'En ny version av Red Invoice finns tillgänglig.',
    'update_invoiceninja_unavailable' => 'Ingen ny version av Red Invoice finns tillgänglig.',
    ...
    'enterprise_upgrade_feature2' => 'Bifoga filer från tredje part till fakturor och utlägg',
...
<br />Aktivera detta om din webbläsare automatiskt laddar hem PDF:erna.',
    ...
    'white_label_license_error' => 'Det gick inte att validera licensen, antingen utgången eller överdriven aktivering. Maila contact@invoice.theredsun.org för mer information.',
    ...
    'invoices_are_attached' => 'Dina faktura-PDF-filer bifogas.',
    ...
    'expense_mailbox_taken' => 'Den inkommande brevlådan används redan',
    'expense_mailbox_invalid' => 'Den inkommande postlådan matchar inte det obligatoriska schemat',
    ...
    'scheduled_report_attached' => 'Din schemalagda :type rapport bifogas.',
    ...
    'upgrade_to_upload_images' => 'Uppgradera till Enterprise Plan för att ladda upp filer och bilder',
    ...
    'local_part_help' => 'Anpassa den lokala delen av din support e-postadress, t.ex. DITT_NAMN@support.invoice.theredsun.org',
    ...
    'enable_client_upload_help' => 'Tillåt klienter att ladda upp dokument/bilagor',
    ...
    'ticket_number_start_help' => 'Biljettnumret måste vara större än det aktuella biljettnumret',
    'new_ticket_template_id' => 'Ny biljett',
    'new_ticket_autoresponder_help' => 'Om du väljer en mall skickas ett autosvar till en kund/kontakt när en ny ärende skapas',
    'update_ticket_template_id' => 'Uppdaterad biljett',
    'update_ticket_autoresponder_help' => 'Om du väljer en mall skickas ett autosvar till en kund/kontakt när en ärende uppdateras',
    'close_ticket_template_id' => 'Stängd biljett',
    'close_ticket_autoresponder_help' => 'Om du väljer en mall skickas ett automatiskt svar till en kund/kontakt när en biljett stängs',
    ...
    'upload_logo' => 'Ladda upp din företagslogotyp',
    ...
    'migrate_to_next_version' => 'Migrera till nästa version av Red Invoice',
    'migrate_intro_text' => 'Vi har arbetat med nästa version av Red Invoice. Klicka på knappen nedan för att starta migreringen.',
    'start_the_migration' => 'Starta migreringen',
    'migration' => 'Migrering',
    'welcome_to_the_new_version' => 'Välkommen till den nya versionen av Red Invoice',
    ...
    'migration_went_wrong' => 'Hoppsan! Något gick fel! Se till att du har konfigurerat en Red Invoice v5 instansen innan du påbörjar migreringen.',
    ...
    'welcome_to_invoice_ninja' => 'Välkommen till Red Invoice',
    'optin' => 'Opt-In',
    'optout' => 'Opt-Out',
    ...
    'send_fail_logs_to_our_server' => 'Rapportera fel för att förbättra appen',
    'setup' => 'Installation',
    ...
    'application_settings_label' => 'Låt oss samla in grundläggande information om din Red Invoice!',
    ...
    'pay_with' => 'Betala med',
    'n/a' => 'N/A',
    'by_clicking_next_you_accept_terms' => 'Genom att klicka på &quot;Nästa&quot; accepterar du villkoren.',
    ...
    'notification_invoice_custom_sent_subject' => 'Anpassad påminnelse skickades till :client',
    ...
    'new_card' => 'Nytt kort',
    'new_bank_account' => 'Lägg till bankkonto',
    ...
    'user_not_associated_with_this_account' => 'Den här användaren kan inte kopplas till det här företaget. Kanske har de redan registrerat en användare på ett annat konto?',
    ...
    'online_payments_minimum_note' => 'Obs! Onlinebetalningar stöds endast om beloppet är större än $1 eller motsvarande i valuta.',
    ...
    'migration_api_secret_notice' => 'Du kan hitta API_SECRET i .env filen eller i Red Invoice v5. Om värdet saknas, lämna fältet tomt.',
    ...
    'migration_already_completed_desc' => 'Det ser ut som du redan migrerat <b> :company_name </b>till V5 version av Red Invoice. Om du vill börja om kan du tvinga migreringen att radera befintlig data.',
    ...
    'new_login_description' => 'Du har nyligen loggat in på din Red Invoice konto från en ny plats eller enhet:<br><br><b>IP:</b> :ip<br><b>Tid:</b> :time<br><b>E-post:</b> :email',
    ...
    'quotes_with_status_sent_can_be_approved' => 'Endast offerter med statusen &quot;Skickat&quot; kan godkännas. Utgångna offerter kan inte godkännas.',
    ...
    'stripe_connect_migration_desc' => 'Red Invoice v5 använder Stripe Connect för att länka ditt Stripe konto till Red Invoice. Detta ger ytterligare ett säkerhetslager för ditt konto. Nu när din data har migrerat måste du Auktorisera Stripe för att acceptera betalningar i v5.<br><br>Navigera till Inställningar > Onlinebetalningar > Konfigurera gateways. Klicka på Stripe Connect och sedan under Inställningar klicka på Setup Gateway. Detta tar dig till Stripe för att godkänna Red Invoice och vid din retur kommer ditt konto att länkas! ',
    ...
    'start_free_trial_message' => 'Starta din GRATIS 14 dagars provperiod på Pro Plan',
    ...
    'nordigen_handler_error_contents_not_available' => 'Funktionen är inte tillgänglig, endast Enterprise Plan.',
    ...
    'nordigen_handler_error_heading_eua_failure' => 'EUA misslyckande',
    'nordigen_handler_error_contents_eua_failure' => 'Ett fel uppstod när slutanvändaravtalet skapades:',
    ...
    'nordigen_requisition_body' => 'Åtkomsten till bankkontoflöden har upphört att gälla enligt slutanvändaravtalet.<br><br> Logga in på Red Invoice och autentisera på nytt med dina banker för att fortsätta ta emot transaktioner.',
    ...
    'step_dependency_fail' => 'Komponent &quot;:step&quot; kräver minst ett av dess beroenden (&quot;:beroenden&quot;) i listan.',
    'step_dependency_order_fail' => 'Komponent &quot;:steg&quot; beror på &quot;:beroende&quot;. Se till att ordningen på komponenterna är korrekt.',
    'step_authentication_fail' => 'Du måste inkludera minst en av autentiseringsmetoderna.',
    'auth.login' => 'Inloggning',
    'auth.login-or-register' => 'Logga in eller registrera dig',
    ...
    'checkout_only_for_existing_customers' => 'Checkout är endast aktiverat för befintliga kunder. Vänligen logga in med befintligt konto för att betala.',
    'checkout_only_for_new_customers' => 'Checkout är endast aktiverat för nya kunder. Vänligen registrera ett nytt konto för att betala.',
    ...
    'payment_terms_help' => 'Antalet dagar efter fakturadatum som betalning förfaller',
    'payment_type_help' => 'Standardbetalningstypen som ska användas för betalningar',
    ...
    'shipping_country_id' => 'Fraktland',
    'show_table_footer' => 'Visa tabellsidfot',
    'show_table_footer_help' => 'Visar summorna i tabellens sidfot',
    ...
    'e_quote' => 'E-citat',
    'e_credit' => 'E-kredit',
    'e_purchase_order' => 'E-inköpsorder',
    'e_quote_type' => 'Typ av e-citat',
    'unlock_unlimited_clients' => 'Vänligen uppgradera för att låsa upp obegränsat antal kunder!',
    'download_e_purchase_order' => 'Ladda ner e-inköpsorder',
    'flutter_web_warning' => 'Vi rekommenderar att du använder den nya webbappen eller skrivbordsappen för bästa prestanda',
    'rappen_rounding' => 'Rappen avrundning',
    'rappen_rounding_help' => 'Runt belopp till 5 cent',
    'assign_group' => 'Tilldela grupp',
    'paypal_advanced_cards' => 'Avancerade kortbetalningar',
    'local_domain_help' => 'EHLO-domän (valfritt)',
    'port_help' => 'dvs. 25,587,465',
    'host_help' => 'dvs. smtp.gmail.com',
    'always_show_required_fields' => 'Visa alltid obligatoriska fältformulär',
    'always_show_required_fields_help' => 'Visar formuläret för obligatoriska fält alltid i kassan',
    'advanced_cards' => 'Avancerade kort',
    'activity_140' => 'Utlåtande skickat till :client',
    'invoice_net_amount' => 'Faktura nettobelopp',
    'round_to_minutes' => 'Runda till minuter',
    '1_second' => '1 sekund',
    '1_minute' => '1 minut',
    '5_minutes' => '5 minuter',
    ...
    'task_round_to_nearest_help' => 'Intervallet att avrunda uppgiften till.',
    ...
    'btcpay_refund_subject' => 'Återbetalning av din faktura via BTCPay',
    'btcpay_refund_body' => 'En återbetalning avsedd för dig har utfärdats. För att göra anspråk på det via BTCPay, klicka på denna länk:',
    'currency_mauritanian_ouguiya' => 'Mauretansk ouguiya',
    'currency_bhutan_ngultrum' => 'Bhutan Ngultrum',
    'end_of_month' => 'Slutet av månaden',
    'merge_e_invoice_to_pdf' => 'Slå ihop e-faktura och PDF',
    'task_assigned_subject' => 'Ny uppgiftstilldelning [Task :task ] [ :date ]',
    'task_assigned_body' => 'Du har tilldelats uppgiften :task<br><br> Beskrivning: :beskrivning<br><br> Klient: :client',
    'activity_141' => 'Användaren :user skrev in note: :notes',
    'quote_reminder_subject' => 'Påminnelse: Citera :quote från :company',
    'quote_reminder_message' => 'Påminnelse för offert :number för :amount',
    'quote_reminder1' => 'Påminnelse om första citat',
    'before_valid_until_date' => 'Innan giltig till datum',
    'after_valid_until_date' => 'Efter giltig fram till datum',
    'after_quote_date' => 'Efter offertdatum',
    'remind_quote' => 'Påminn citat',
    'end_of_month' => 'Slutet av månaden',
    'tax_currency_mismatch' => 'Skattevalutan skiljer sig från fakturavalutan',
    'edocument_import_already_exists' => 'Fakturan har redan importerats på :date',
    'before_valid_until' => 'Innan giltig till',
    'after_valid_until' => 'Efter giltig till',
    'task_assigned_notification' => 'Uppgiftstilldelad meddelande',
    'task_assigned_notification_help' => 'Skicka ett e-postmeddelande när en uppgift tilldelas',
    ...
    'tickets' => 'Biljetter',
    'assigned_group' => 'Tilldelad grupp framgångsrikt',
    'merge_to_pdf' => 'Slå samman till PDF',
    'latest_requires_php_version' => 'Obs: den senaste versionen kräver PHP :version',
    'auto_expand_product_table_notes' => 'Utöka automatiskt produkttabellanteckningar',
    'auto_expand_product_table_notes_help' => 'Expanderar automatiskt anteckningssektionen i produkttabellen för att visa fler rader.',
    'institution_number' => 'Institutionsnummer',
    'transit_number' => 'Transitnummer',
    'personal' => 'Personlig',
    'address_information' => 'Adressinformation',
    'enter_the_information_for_the_bank_account' => 'Ange informationen för bankkontot',
    'account_holder_information' => 'Kontoinnehavarens information',
    'enter_information_for_the_account_holder' => 'Ange information för kontoinnehavaren',
    'customer_type' => 'Kundtyp',
    'process_date' => 'Bearbetningsdatum',
    ...
    'one_page_checkout_help' => 'Aktivera det nya ensidiga betalningsflödet',
    'applies_to' => 'Gäller för',
    'accept_purchase_order' => 'Acceptera inköpsorder',
    'round_to_seconds' => 'Runda till sekunder',
    'activity_142' => 'Citat :quote påminnelse 1 skickad',
    ...
    'activity_145' => 'E-faktura :invoice för :client skickades. :notes',
    ...
    'country_Ceuta' => 'Ceuta',
    'country_Canary Islands' => 'kanarieöarna',
    ...
    'expense_mailbox' => 'Inkommande e-postadress',
    'expense_mailbox_help' => 'Den inkommande e-postadressen som accepterar utgiftsdokument. dvs. kostnad@invoice.theredsun.org',
    'expense_mailbox_active' => 'Utgiftsbrevlåda',
    'expense_mailbox_active_help' => 'Möjliggör hantering av dokument såsom kvitton för utgiftsrapportering',
    'inbound_mailbox_allow_company_users' => 'Tillåt företagsavsändare',
    'inbound_mailbox_allow_company_users_help' => 'Tillåter användare inom företaget att skicka utgiftsdokument.',
    'inbound_mailbox_allow_vendors' => 'Tillåt leverantörsavsändare',
    'inbound_mailbox_allow_vendors_help' => 'Tillåter företagsleverantörer att skicka utgiftsdokument',
    'inbound_mailbox_allow_clients' => 'Tillåt klientavsändare',
    'inbound_mailbox_allow_clients_help' => 'Tillåter kunder att skicka utgiftsdokument',
    'inbound_mailbox_whitelist' => 'Lista över inkommande avsändare',
    'inbound_mailbox_whitelist_help' => 'Kommaseparerad lista över e-postmeddelanden som ska tillåtas skicka e-postmeddelanden för bearbetning',
    'inbound_mailbox_blacklist' => 'Lista över förbjudna inkommande avsändare',
    'inbound_mailbox_blacklist_help' => 'Kommaseparerad lista över e-postmeddelanden som inte är tillåtna att skicka e-post för bearbetning',
    'inbound_mailbox_allow_unknown' => 'Tillåt alla avsändare',
    'inbound_mailbox_allow_unknown_help' => 'Tillåt vem som helst att skicka ett utgiftsmeddelande för bearbetning',
    'quick_actions' => 'Snabba åtgärder',
    'end_all_sessions_help' => 'Loggar ut alla användare och kräver att alla aktiva användare autentiseras på nytt.',
    'updated_records' => 'Uppdaterade register',
    'vat_not_registered' => 'Säljaren är inte momsregistrerad',
    'small_company_info' => 'Ingen upplysning om försäljningsskatt i enlighet med § 19 UStG',
    'peppol_onboarding' => 'Det verkar som att det är första gången du använder PEPPOL.',
    'get_started' => 'Kom igång',
    'configure_peppol' => 'Konfigurera PEPPOL',
    'step' => 'Steg',
    ...
    'peppol_disconnect_short' => 'Koppla från PEPPOL.',
    'peppol_disconnect_long' => 'Ditt momsnummer kommer att dras från PEPPOL-nätverket efter att du kopplat bort. Du kommer inte att kunna skicka eller ta emot e-dokument.',
    'log_duration_words' => 'Tidsloggs varaktighet i ord',
    'log_duration' => 'Tidsloggs varaktighet',
    'merged_vendors' => 'Sammanslagna leverantörer',
    ...
    'peppol_token_description' => 'Token används som ytterligare ett steg för att se till att fakturor skickas säkert. Till skillnad från white-label-licenser kan token roteras när som helst utan att behöva vänta på Red Invoice-support.',
    'peppol_token_warning' => 'Du måste generera en token för att fortsätta.',
    'generate_token' => 'Generera token',
    'total_credits_amount' => 'Antal krediter',
    'sales_above_threshold' => 'Försäljning över tröskelvärdet',
    'changing_vat_and_id_number_note' => 'Du kan inte ändra ditt VAT-nummer eller ID-nummer när PEPPOL väl har konfigurerats.',
    'iban_help' => 'Hela IBAN-numret',
    'bic_swift' => 'BIC/Swift-kod',
    'bic_swift_help' => 'Bankidentifieraren',
    'payer_bank_account' => 'Betalarens bankkontonummer',
    'payer_bank_account_help' => 'Betalarens bankkontonummer',
    'bsb_sort' => 'BSB / Sorteringskod',
    'bsb_sort_help' => 'Bankfilialkod',
    'card_type' => 'Korttyp',
    'card_type_help' => 'dvs. VISA, AMEX',
    'card_number_help' => 'endast de fyra sista siffrorna',
    'card_holder' => 'Kortinnehavarens namn',
    'tokenize' => 'Tokenisera',
    'tokenize_help' => 'Tokenize betalningsmetod för framtida användning.',
    'credit_card_stripe_help' => 'Acceptera kreditkortsbetalningar med Stripe.',
    'bank_transfer_stripe_help' => 'ACH autogiro. USD-betalningar, omedelbar verifiering tillgänglig.',
    'alipay_stripe_help' => 'Alipay tillåter användare i Kina att betala säkert med sina mobila plånböcker.',
    'sofort_stripe_help' => 'Sofort är en populär europeisk betalningsmetod som möjliggör banköverföringar i realtid, främst i Tyskland och Österrike.',
    'apple_pay_stripe_help' => 'Apple/Google Pay för användare med Apple/Android-enheter, med hjälp av sparad kortinformation för enkel utcheckning.',
    'sepa_stripe_help' => 'SEPA direktdebitering (Single Euro Payments Area).',
    'bancontact_stripe_help' => 'Bancontact är en mycket använd betalningsmetod i Belgien.',
    'ideal_stripe_help' => 'iDEAL är den mest populära betalningsmetoden i Nederländerna.',
    'giropay_stripe_help' => 'Giropay är en tysk betalningsmetod som underlättar säkra och omedelbara banköverföringar online.',
    'przelewy24_stripe_help' => 'Przelewy24 är en vanlig betalningsmetod i Polen.',
    'direct_debit_stripe_help' => 'Stripe-banköverföringar med Stripes virtuella bankkonton, tillgängliga i Japan, Storbritannien, USA, Europa och Mexiko. Se till att detta är aktiverat i Stripe!',
    'eps_stripe_help' => 'EPS är ett österrikiskt betalningssystem online.',
    'acss_stripe_help' => 'ACSS (Automated Clearing Settlement System) Autogiro för kanadensiska bankkonton.',
    'becs_stripe_help' => 'BECS autogiro för australiska bankkonton.',
    'klarna_stripe_help' => 'Klarna köp nu och betala senare i delbetalning eller enligt ett fastställt schema.',
    'bacs_stripe_help' => 'BACS direktdebitering för brittiska bankkonton, som vanligtvis används för prenumerationsfakturering.',
    'fpx_stripe_help' => 'FPX är en populär onlinebetalningsmetod i Malaysia.',
    'payment_means' => 'Betalningsmedel',
    'act_as_sender' => 'Skicka e-faktura',
    'act_as_receiver' => 'Ta emot e-faktura',
    'saved_einvoice_details' => 'Sparade e-fakturainställningar',
    'add_license_to_env' => 'Vi behöver din licensnyckel för framtida kommunikation med våra tjänster. Se till att använda LICENSE_KEY som miljövariabel.',
    'white_label_license_not_present' => 'Licens hittades inte. Se till att ställa in LICENSE_KEY som miljövariabel.',
    'white_label_license_not_found' => 'White label-licens hittades inte.',
    'details_update_info' => 'Vi uppdaterar dina företagsuppgifter med den angivna informationen.',
    'sales_above_threshold' => 'Försäljning över tröskelvärdet',
    'client_address_required' => 'Fullständig kundadress krävs för e-fakturering',
    'connected' => 'Ansluten',
    'email_count_quotes' => 'E-posta :count offerter',
    'activity_146' => 'E-faktura :invoice för :client har levererats framgångsrikt! :notes',
    'activity_147' => 'E-faktura :invoice för :client misslyckad leverans. :notes',
    'peppol_routing_problem' => 'Routing problem. Ingen mottagare/destination hittades.',
    'peppol_sending_failed' => 'Tekniskt leveransproblem. Det går inte att försöka igen',
    'peppol_cleared_for_sending' => 'Godkänd av skattemyndigheten, skickas till mottagaren',
    'account_holder' => 'Kontonamn',
    'account_holder_help' => 'Namnet på kontot',
    'activity_148' => 'E-kostnad :expense mottagen från :vendor',
    'additional_tax_identifiers' => 'Ytterligare skatteidentifierare',
    'additional_tax_identifiers_help' => 'Om du är momsregistrerad i andra regioner kan du lägga till dina momsnummer för dessa regioner här.',
    'configure' => 'Konfigurera',
    'new_identifier' => 'Nytt momsnummer',
    'notification_credits_low' => 'Varning! Ditt kreditsaldo är lågt.',
    'notification_credits_low_text' => 'Lägg till krediter på ditt konto för att undvika avbrott i tjänsterna.',
    'notification_no_credits' => 'Varning! Ditt saldo är tomt.',
    'notification_no_credits_text' => 'Lägg till krediter på ditt konto för att undvika avbrott i tjänsterna.',
    'saved_comment' => 'Kommentar sparad',
    'acts_as_must_be_true' => 'Antingen &quot;Skicka E-faktura&quot; eller &quot;Ta emot E-faktura&quot; (eller båda) måste väljas.',
    'delete_identifier' => 'Ta bort identifierare',
    'delete_identifier_description' => 'Om du tar bort denna identifierare tas den bort från systemet. Se till att detta är önskad åtgärd innan du fortsätter.',
    'einvoice_something_went_wrong' => 'hoppsan! Något gick fel. Kontakta oss på contact@invoice.theredsun.org för mer information.',
    'download_ready' => 'Din nedladdning är nu klar! [ :message ]',
    'notification_quote_reminder1_sent_subject' => 'Påminnelse 1 för offert :invoice skickades till :client',
    'custom_reminder_sent' => 'Anpassad påminnelse skickades till :client',
    'use_system_fonts' => 'Använd systemteckensnitt',
    'use_system_fonts_help' => 'Åsidosätt standardteckensnitten med de från webbläsaren',
    'active_tasks' => 'Aktiva uppgifter',
    'enable_notifications' => 'Aktivera aviseringar',
    'enable_public_notifications' => 'Aktivera offentliga meddelanden',
    'enable_public_notifications_help' => 'Aktivera aviseringar i realtid från Red Invoice.',
    'navigate' => 'Navigera',
    'calculate_taxes_warning' => 'Denna åtgärd kommer att aktivera radskatter och inaktivera totala skatter. Eventuella öppna fakturor kan räknas om med de nya inställningarna!',
    'activity_149' => ':user e-postade kredit :credit för :client till :contact',
    'email_history_empty' => 'Ingen e-posthistorik hittades, den här funktionen är endast tillgänglig när du skickar med Poststämpel/Mailgun.',
    'e_invoicing' => 'E-faktura',
    'einvoice_token_not_found' => 'E-invoicing token not found. Please go to Settings > E-invoice and regenerate token.',
    'regenerate' => 'Regenerera',
    'subscription_unavailable' => 'Denna artikel är inte längre tillgänglig',
    'currency_samoan_tala' => 'Samoanska Tala',
    'confirm_duplicate_gateway' => 'Är du säker på att du vill skapa en annan anslutning?',
    'clients_limit' => 'Du har nått din kundgräns. Uppgradera din plan.',
