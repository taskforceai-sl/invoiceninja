...
$lang = array(
    ...
    'pro_plan_feature3' => 'URLs personalizadas - "TuMarca.Red Invoice.com"',
    'pro_plan_feature4' => 'Eliminar "Creado por Red Invoice"',
...
<li>Hoy es el viernes, la fecha límite es el primer viernes después. La fecha de vencimiento será el próximo viernes, no hoy.</li></ul>',
    ...
    'overdue' => 'Atraso',
    'white_label_text' => 'Compra UN AÑO de Licencia de Marca Blanca por $:price y elimina la marca Red Invoice de la Factura y del Portal de Cliente.',
    ...
    'pro_plan_year_description' => 'Un año de inscripción en el Plan Red Invoice Pro.',
    'pro_plan_month_description' => 'Un mes de inscripción en el Plan Red Invoice Pro.',
    'enterprise_plan_product' => 'Plan Enterprise ',
    'enterprise_plan_year_description' => 'Un año de inscripción en el Plan Red Invoice Enterprise .',
    'enterprise_plan_month_description' => 'Un mes de inscripción en el Plan Red Invoice Enterprise .',
...
Una vez que tenga los montos, vuelva a esta página de métodos de pago y haga clic en "Verificación completa" junto a la cuenta.',
    ...
    'export_help' => 'Utilice JSON si planea importar los datos en  Red Invoice.<br/>El fichero incluye clientes, productos, facturas, presupuestos y pagos.',
    ...
    'wepay_account_description' => 'Pasarela de Pago para Red Invoice',
    ...
    'update_invoiceninja_title' => 'Actualizar Red Invoice',
    'update_invoiceninja_warning' => '¡Antes de comenzar a actualizar Red Invoice cree una copia de seguridad de su base de datos y archivos!',
    'update_invoiceninja_available' => 'Está disponible una nueva versión de Red Invoice.',
    'update_invoiceninja_unavailable' => 'No hay ninguna versión nueva de Red Invoice.',
    ...
    'local_part_help' => 'Personaliza la parte local de tu email de soporte de entrada, p.ej, TU_NOMBRE@support.invoice.theredsun.org',
    ...
    'migrate_to_next_version' => 'Migrar a la siguiente versión de Red Invoice',
    'migrate_intro_text' => 'Hemos estado trabajando en la siguiente versión de Red Invoice. Pulsa en el botón de abajo para comenzar la migración.',
    'start_the_migration' => 'Empezar la migración',
    'migration' => 'Migración',
    'welcome_to_the_new_version' => 'Bienvenido a la nueva versión de Red Invoice',
    ...
    'migration_went_wrong' => 'Uppps, ¡algo fue mal! Por favor, asegúrate de que has configurado una instancia Red Invoice v5 antes de empezar la migración.',
    ...
    'welcome_to_invoice_ninja' => 'Bienvenid@ a Red Invoice',
    'optin' => 'Optar en',
    'optout' => 'Optar por no',
    ...
    'application_settings_label' => 'Vamos a guardar información básica acerca de tu Red Invoice',
    ...
    'migration_api_secret_notice' => 'Puedes encontrar API_SECRET en el archivo .env o en Red Invoice v5. Si no está presente, deja el campo vacío.',
    ...
    'migration_already_completed_desc' => 'Parece que ya ha migrado <b> :company_name </b>a la versión V5 de Red Invoice. En caso de que desee comenzar de nuevo, puede forzar la migración para borrar los datos existentes.',
    ...
    'new_login_description' => 'Recientemente, inició sesión en su cuenta de Red Invoice desde una nueva ubicación o dispositivo:<br><br><b>IP:</b> :ip<br><b>Time:</b> :time<br><b>Email:</b> :email',
    ...
    'stripe_connect_migration_desc' => 'Red Invoice v5 utiliza Stripe Connect para vincular tu cuenta de Stripe con Red Invoice. Esto ofrece una capa adicional de seguridad para tu cuenta. Ahora que tus datos se han migrado, necesitarás autorizar Stripe para aceptar pagos en v5.<br><br>Para ello accede a Ajustes > Pagos online > Configurar pasarela. Esto te llevará a la autorización de Red Invoice en Stripe y al finalizar, tu cuenta estará correctamente vinculada.',
...
De lo contrario, este campo deberá dejarse en blanco.',
    ...
    'e_quote' => 'Presupuesto Electrónico',
    'e_credit' => 'Crédito Electrónico',
    'e_purchase_order' => 'Orden de compra electrónica',
    'e_quote_type' => 'Tipo de presupuesto electrónico',
    ...
    'expense_mailbox_help' => 'La dirección de correo electrónico entrante que acepta documentos de gastos, Ej. expense@invoice.theredsun.org',
    ...
    'vat_not_registered' => 'Vendedor no registrado para el IVA',
    'small_company_info' => 'No divulgación del impuesto sobre ventas de acuerdo con el § 19 UStG',
    'peppol_onboarding' => 'Parece que es tu primera vez usando PEPPOL.',
    'get_started' => 'Comenzar',
    'configure_peppol' => 'Configurar PEPPOL',
    'step' => 'Paso',
    'peppol_whitelabel_warning' => 'Se requiere licencia de marca blanca para poder usar la facturación electrónica a través de la red PEPPOL.',
    ...
    'peppol_disconnect_short' => 'Desconectar de PEPPOL.',
    'peppol_disconnect_long' => 'Tu número de IVA será retirado de la red PEPPOL después de desconectar. No podrás enviar ni recibir documentos electrónicos.',
    'log_duration_words' => 'Duración del registro de tiempo en palabras',
    'log_duration' => 'Duración del registro de tiempo',
    'merged_vendors' => 'Vendedores fusionados con éxito',
    ...
    'peppol_token_description' => 'El token se utiliza como otro paso para garantizar que las facturas se envíen de forma segura. A diferencia de las licencias de marca blanca, el token se puede rotar en cualquier momento sin necesidad de esperar al soporte de Red Invoice.',
    ...
    'activity_146' => '¡Factura electrónica :invoice para :client entregada con éxito! :notas',
    'activity_147' => 'Factura electrónica :invoice para :client no entregada. :notes',
    ...
    'einvoice_something_went_wrong' => '¡Vaya! Algo salió mal. Contáctanos en contact@invoice.theredsun.org para más información.',
    ...
    'enable_public_notifications_help' => 'Habilitar notificaciones en tiempo real de Red Invoice.',
    'navigate' => 'Navegar',
    ...
    'preference_product_notes_for_html_view' => 'Utiliza Notas de Elementos para la Vista HTML.',
    'preference_product_notes_for_html_view_help' => 'Prefiere la descripción del artículo sobre el título del artículo al mostrar la factura en HTML.',
    'project_report' => 'Informe del Proyecto.',
    'unlock_invoice_documents_after_payment' => 'Desbloquear Documentos Después del Pago.',
    'unlock_invoice_documents_after_payment_help' => 'Permite al cliente acceder a los documentos de la factura cuando se ha pagado la factura.',
